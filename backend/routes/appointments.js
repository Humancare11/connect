...
const {
  ...
  confirmAppointment, completeAppointment, cancelAppointment, reassignAppointmentDoctor,
...
router.put("/:id/change-doctor", verifyAdminToken, adminOnly, reassignAppointmentDoctor);
