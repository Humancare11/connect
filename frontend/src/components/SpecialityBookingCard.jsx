...
function SpecialityBookingCard({ price, priceLoading, categoryId, name }) {
    ...
    return (
        <div className="hcc-booking-card">
            ...
            <Link to={`/category-consultant?category=${categoryId}&specialty=${encodeURIComponent(name)}`}>
                <button className="hcc-booking-cta">Start Consultation →</button>
            </Link>
            <p className="hcc-booking-terms">
                By continuing, you agree to our{" "}
                <a href="#" className="hcc-booking-link">Terms of Service</a> and{" "}
                <a href="#" className="hcc-booking-link">Privacy Policy</a>
            </p>
        </div>
    );
}
