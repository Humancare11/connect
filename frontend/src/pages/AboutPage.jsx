    ...
    <>
      ...
      <div className="about-page">
              ...
              <Rv delay={100}>
                <div>
                  ...
                  <p className="why__closing">
                    ...
                    lasting trust, and ensuring every patient receives the
        ...
        <section className="section section--navy">
          ...
          <div className="container">
            <Rv>{/* <Eyebrow light>The system we're fixing</Eyebrow> */}</Rv>
            <Rv delay={80}>
              ...
              <p className="heading heading--lg problem__desc">
                ...
                patient. Yet too many people still face challenges like long
                wait times, limited access to trusted medical professionals,
                unclear costs, and disconnected care experiences
              </p>
            </Rv>
              ...
              {steps.map((s, i) => (
                <Rv key={s.n} delay={i * 90}>
                  <div className="step-card">
                    <div
                      className={`step-card__num step-card__num--${s.color}`}
                    >
                      {s.n}
                    </div>
            ...
            <div className="network__top">
              <div className="network__copy">
                ...
                <p className="section-head__lead">
                  ...
                  experienced doctors, receive personalized medical guidance,
                  and experience seamless healthcare whenever you need it.
                </p>
              </div>
          ...
          <div className="container">
            <Rv>
              <div className="section-head">
                ...
                <h2 className="heading heading--lg section-head__title">
                  Comprehensive Healthcare, Designed Around Your Needs
                </h2>
                <p className="section-head__lead">
                  Humancare Connect offers a complete range of virtual
                  healthcare services from everyday medical concerns to
                  specialized expert care. Our patient-centered approach makes
                  it easy to find the right healthcare professional based on
                ...
                <div className="trust-panel">
                  ...
                  <div className="trust-panel__text">
                    ...
                    <p className="trust-panel__body">
                      ...
                      every patient knows who they are connecting with and what
                      to expect before their care begins.
                    </p>
                  </div>
                </div>
              </Rv>
                ...
                <div className="trust-panel">
                  <div className="trust-panel__text trust-panel__text--first">
                    ...
                    <p className="trust-panel__body">
                      ...
                      healthcare professionals can deliver personalized medical
                ...
                <div className="trust-privacy">
                  ...
                  <div className="trust-privacy__text">
                    ...
                    <p>
                      ...
                      built with secure technology, strict privacy practices,
                      and a commitment to protecting patient confidentiality.
                    </p>
                    <p style={{ marginTop: 10 }}>
                      From secure online doctor consultations to protected
                      medical records, we are dedicated to providing a safe and
                      trusted digital healthcare experience where your privacy
                      always comes first.
                    </p>
                  </div>
            ...
            <div className="contact-grid">
              <Rv>
                ...
                <p className="contact__lead">
                  ...
                  healthcare professional interested in joining our network, or
                  an organization exploring virtual healthcare solutions, our
