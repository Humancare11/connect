...
import ConditionBannerImage from "../../assets/ConditionImages/ChronicCare/Thyroid-Disorders.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Are Thyroid Disorders?</h3>
            <p className="sp-block-body">
              Thyroid disorders can cause fatigue, weight changes, mood swings,
              hair thinning, sensitivity to temperature, irregular heartbeat,
              and energy level changes caused by an overactive or underactive
              thyroid gland.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Manage thyroid disorder symptoms with confidence through Humancare
              ...
              receive symptom evaluation, hormone management support, treatment
              guidance, and prescriptions when appropriate without the hassle of
          ...
          <div>
            <h3 className="sp-block-title">
              Manage thyroid health in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Thyroid Disorder care",
  ...
  return (
    <div className="sp-sbc">
      ...
      <button
        ...
        onClick={() =>
          navigate(
            "/category-consultant?category=chronic&condition=Thyroid%20Disorders",
          )
        }
      >
        Start Consultation →
