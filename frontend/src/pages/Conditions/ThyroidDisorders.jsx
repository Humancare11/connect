...
// ─────────────────────────────────────────────────────────────────
export default function ThyroidDisorders({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Thyroid disorders can cause fatigue, weight changes,
                        mood swings, hair thinning, sensitivity to temperature,
                        irregular heartbeat, and energy level changes caused by
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Manage thyroid disorder symptoms with confidence through
                        ...
                        symptom evaluation, hormone management support,
                        treatment guidance, and prescriptions when appropriate
                        without the hassle of frequent clinic visits.
                      </p>
                    </div>
