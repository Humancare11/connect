    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          ...
          <div>
            <h3 className="sp-block-title">Benefits of Regular Primary Care</h3>
            <div className="sp-benefits-grid">
              {/* CHANGE */}
              {[
                "Earlier disease detection", "Lower healthcare costs",
                "Coordinated specialist care", "Better long-term outcomes",
                "Personalised health plans", "Medication management",
              ].map(b => (
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Comprehensive%20Care%20For%20Every%20Stage%20Of%20Life")}>Start Consultation →</button>
        ...
        <div className="sp-faq-layout">
          ...
          <div className="sp-faq-content">
            ...
            <div className="sp-faq-bottom-cta">
              ...
              <button>Book a Free Call <ArrowRight size={18} /></button>
            </div>
          </div>
...
// ─────────────────────────────────────────────────────────────────
// CHANGE FILE NAME ACCORING TO CONDITION NAME
