    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Primary Care?</h3>
            <p className="sp-block-body">
              Non emergency chest pain can include mild discomfort, pressure, tightness, or pain in the chest that is not severe or life threatening. Symptoms may be related to muscle strain, acid reflux, stress, anxiety, or other underlying health concerns and should be evaluated by a healthcare professional.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get support for non emergency chest pain with Humancare Connect. Our telemedicine services make it easy to schedule an online doctor appointment and connect with a licensed provider from home. Through our secure telemedicine platform, you can access virtual healthcare services for symptom evaluation, treatment guidance, and personalized care recommendations. Telehealth services provide convenient access to an experienced online provider who can assess your symptoms, discuss possible causes, and recommend appropriate next steps to support your health and well being.

            </p>
          </div>

          <div>
            <h3 className="sp-block-title">Get Chest Pain (Non-Emergency) care in 4 simple steps.</h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Chest Pain (Non-Emergency) care", "Share your symptoms and concerns",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=chronic&condition=Chest%20Pain%20%28Non-Emergency%29")}>Start Consultation →</button>
