...
const pageData = {
  ...
  description: "Evaluation for ongoing chest discomfort",
...
//
// NOTE: The "About" block heading below reads "What Is Primary Care?"
// rather than a Chest Pain-specific heading; this mismatch already
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Non emergency chest pain can include mild discomfort,
                        pressure, tightness, or pain in the chest that is not
                        severe or life threatening. Symptoms may be related to
                        muscle strain, acid reflux, stress, anxiety, or other
                        underlying health concerns and should be evaluated by a
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get support for non emergency chest pain with Humancare
                        ...
                        services for symptom evaluation, treatment guidance, and
                        personalized care recommendations. Telehealth services
                        provide convenient access to an experienced online
                        provider who can assess your symptoms, discuss possible
                        causes, and recommend appropriate next steps to support
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get Chest Pain (Non-Emergency) care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Chest Pain (Non-Emergency) care",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=chronic&condition=Chest%20Pain%20%28Non-Emergency%29",
                    )
                  }
                >
                  Start Consultation →
