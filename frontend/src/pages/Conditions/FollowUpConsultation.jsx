        ...
        <div className="sp-about-right">
          <div>
            ...
            <p className="sp-block-body">
              Follow-up consultations help monitor symptoms, review treatment
              progress, adjust medications, discuss lab results, and provide
              ongoing support after a recent medical visit or treatment plan.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Stay connected with your care team through Humancare Connect. Our
              ...
              continued treatment guidance, symptom monitoring, prescription
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Follow-Up%20Consultation")}>Start Consultation →</button>
