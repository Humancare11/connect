...
//
// NOTE: The banner image import path points to
// ".../ChronicCare/Palpitations.webp" (not a Post-COVID image). This
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What Is Post-COVID Concerns?
                      </h3>
                      <p className="condition-block-body">
                        Post COVID concerns can include ongoing fatigue,
                        shortness of breath, brain fog, headaches, sleep
                        disturbances, muscle aches, loss of smell or taste, and
                        other symptoms that persist after recovering from a
                        COVID infection.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get personalized support for post COVID concerns with
                        ...
                        healthcare services for symptom evaluation, recovery
                        monitoring, treatment guidance, and personalized care
                        recommendations. Telehealth services provide convenient
                        access to an experienced online provider who can help
                        assess lingering symptoms, recommend appropriate
                        management strategies, and support your recovery and
                        overall well being.
                      </p>
                    </div>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=chronic&condition=Post-COVID%20Concerns",
                    )
                  }
                >
                  Start Consultation →
