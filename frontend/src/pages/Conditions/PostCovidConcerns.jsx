    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Post-COVID Concerns?</h3>
            <p className="sp-block-body">
              Post COVID concerns can include ongoing fatigue, shortness of
              breath, brain fog, headaches, sleep disturbances, muscle aches,
              loss of smell or taste, and other symptoms that persist after
              recovering from a COVID infection.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get personalized support for post COVID concerns with Humancare
              ...
              access virtual healthcare services for symptom evaluation,
              recovery monitoring, treatment guidance, and personalized care
              recommendations. Telehealth services provide convenient access to
              an experienced online provider who can help assess lingering
              symptoms, recommend appropriate management strategies, and support
          ...
          <div>
            <h3 className="sp-block-title">
              Get Post-COVID Concerns care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Post-COVID Concerns care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=chronic&condition=Post-COVID%20Concerns")}>Start Consultation →</button>
