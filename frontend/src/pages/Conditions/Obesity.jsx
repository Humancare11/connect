...
//
// NOTE: The About section below reads "What Is Memory Concerns?" — this
// mismatched heading already existed in the pre-migration file (a
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Obesity can increase the risk of fatigue, joint pain,
                        high blood pressure, diabetes, heart disease, sleep
                        problems, and other long-term health conditions that may
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Take control of your weight and health with Humancare
                        ...
                        healthcare services, you can receive personalized weight
                        management support, treatment guidance, lifestyle
                        recommendations, and prescriptions when appropriate
                        without the stress of frequent clinic visits.
                      </p>
                    </div>

                    <div>
                      <h3 className="condition-block-title">
                        Start your weight management journey in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          ...
                          "Receive personalized treatment and ongoing care support",
                        ].map((b) => (
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=chronic&condition=Obesity",
                    )
                  }
                >
                  Start Consultation →
