        ...
        <div className="sp-about-right">
          <div>
            ...
            <p className="sp-block-body">
              Obesity can increase the risk of fatigue, joint pain, high blood
              pressure, diabetes, heart disease, sleep problems, and other
              long-term health conditions that may impact daily life and overall
              wellness.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Take control of your weight and health with Humancare Connect. Our
              ...
              personalized weight management support, treatment guidance,
              lifestyle recommendations, and prescriptions when appropriate
  ...
  return (
    <div className="sp-sbc">
      ...
      <button
        ...
        onClick={() =>
          navigate("/category-consultant?category=chronic&condition=Obesity")
        }
      >
        Start Consultation →
      </button>
