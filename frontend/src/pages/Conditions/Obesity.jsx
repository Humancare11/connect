                ...
                <div className="sp-about-right">
                    <div>
                        ...
                        <p className="sp-block-body">
                            Obesity can increase the risk of fatigue, joint pain, high blood pressure, diabetes, heart disease, sleep problems, and other long-term health conditions that may impact daily life and overall wellness.
                    ...
                    <div>
                        <h3 className="sp-block-title">Start your weight management journey in 4 simple steps.</h3>
                        <div className="sp-benefits-grid">
                            {[
                                "Choose Obesity care", "Share your health history and goals ",
                                "Connect with an online provider", "Receive personalized treatment and ongoing care support",
  ...
  const navigate = useNavigate();
    ...
    return (
        <div className="sp-sbc">
            ...
            <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=chronic&condition=Obesity")}>Start Consultation →</button>
