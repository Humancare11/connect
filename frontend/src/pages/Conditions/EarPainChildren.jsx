...
export default function EarPainChildren({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        irritability, trouble sleeping, fever, tugging at the
                        ears, and hearing discomfort often linked to ear
                        infections, colds, flu, or allergies.
                      </p>
                    </div>
                    <div>
                      <h3 className="condition-block-title">How?</h3>
                      <p className="condition-block-body">
                        Get trusted pediatric ear care from home with Humancare
            ...
            <aside>
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=family&condition=Ear%20Pain%20in%20Children",
                    )
                  }
                >
                  Book Appointment →
