    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Ear Pain in Children?</h3>
            <p className="sp-block-body">
              Ear pain in children can cause ear discomfort, pressure,
              irritability, trouble sleeping, fever, tugging at the ears, and
              hearing discomfort often linked to ear infections, colds, flu, or
              allergies.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get trusted pediatric ear care from home with Humancare Connect.
              ...
              without the stress of an urgent care visit.
            </p>
          </div>

          <div>
            <h3 className="sp-block-title">
              Get ear pain care for your child in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Ear Pain in Children care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=family&condition=Ear%20Pain%20in%20Children")}>Start Consultation →</button>
