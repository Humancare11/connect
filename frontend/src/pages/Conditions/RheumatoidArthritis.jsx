...
import ConditionBannerImage from "../../assets/ConditionImages/ChronicCare/Rheumatoid-Arthritis.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Rheumatoid Arthritis?</h3>
            <p className="sp-block-body">
              Rheumatoid arthritis can cause joint pain, swelling, stiffness,
              fatigue, reduced mobility, and inflammation that commonly affects
              the hands, wrists, knees, and other joints on both sides of the
              body.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Manage rheumatoid arthritis symptoms with ongoing support through
              ...
              can receive symptom evaluation, pain management guidance,
              treatment recommendations, and prescriptions when appropriate
          ...
          <div>
            <h3 className="sp-block-title">
              Manage rheumatoid arthritis in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Rheumatoid Arthritis care",
                "Share your symptoms and joint concerns",
  ...
  return (
    <div className="sp-sbc">
      ...
      <button
        ...
        onClick={() =>
          navigate(
            "/category-consultant?category=chronic&condition=Rheumatoid%20Arthritis",
          )
        }
      >
        Start Consultation →
