...
export default function RheumatoidArthritis({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Rheumatoid arthritis can cause joint pain, swelling,
                        stiffness, fatigue, reduced mobility, and inflammation
                        that commonly affects the hands, wrists, knees, and
                        other joints on both sides of the body.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Manage rheumatoid arthritis symptoms with ongoing
                        support through Humancare Connect. Our telemedicine
                        ...
                        receive symptom evaluation, pain management guidance,
                        treatment recommendations, and prescriptions when
                        appropriate without frequent in-person visits.
                      </p>
                    </div>
