...
import ConditionBannerImage from "../../assets/ConditionImages/EyeEarAndMusculoskeletal/Ear-Infection.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Ear Infection?</h3>
            <p className="sp-block-body">
              Ear infections can cause ear pain, pressure, muffled hearing,
              drainage, irritation, fever, and discomfort often linked to
              bacterial infections, viral infections, or fluid buildup in the
              ear.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get fast relief for ear infection symptoms with Humancare Connect.
              ...
              evaluation, treatment guidance, pain relief support, and
              prescriptions when appropriate without the hassle of an in-person
              clinic visit.
            </p>
          </div>
          ...
          <div>
            <h3 className="sp-block-title">
              Get ear infection care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Ear Infection care",
                "Share your symptoms and ear concerns",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=eeb&condition=Ear%20Infection")}>Start Consultation →</button>
