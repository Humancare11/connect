...
// ─────────────────────────────────────────────────────────────────
export default function GrowthDevelopment({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Growth and development concerns may involve questions
                        about a child's physical growth, motor skills, speech
                        and language development, learning abilities, social
                        interactions, or overall progress through important
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get expert guidance for growth and development concerns
                        ...
                        healthcare services for developmental assessments,
                        milestone guidance, symptom evaluation, and personalized
                        care recommendations. Telehealth services provide
                        convenient access to an experienced online provider who
                        can help monitor your child's progress, address
                        concerns, and support healthy growth and development at
                        every stage.
                      </p>
                    </div>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=family&condition=Growth%20%26%20Development",
                    )
                  }
                >
                  Book Appointment →
