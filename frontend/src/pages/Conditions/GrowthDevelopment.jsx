        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">
              What is Growth & Development care for children?
            </h3>
            <p className="sp-block-body">
              Growth and development concerns may involve questions about a
              child's physical growth, motor skills, speech and language
              development, learning abilities, social interactions, or overall
              progress through important developmental milestones.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get expert guidance for growth and development concerns with
              Humancare Connect. Our telemedicine services make it easy to
              schedule an online doctor appointment and connect with a licensed
              provider from home. Through our secure telemedicine platform, you
              can access virtual healthcare services for developmental
              assessments, milestone guidance, symptom evaluation, and
              personalized care recommendations. Telehealth services provide
              convenient access to an experienced online provider who can help
              monitor your child's progress, address concerns, and support
              healthy growth and development at every stage.
            </p>
          </div>

          <div>
            <h3 className="sp-block-title">
              Get Growth & Development care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Growth & Development care",
                "Share your symptoms, concerns, and developmental questions",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=family&condition=Growth%20%26%20Development")}>Start Consultation →</button>
