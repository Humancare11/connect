...
// ─────────────────────────────────────────────────────────────────
export default function NasalCongestion({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Nasal congestion occurs when the tissues inside the nose
                        become swollen or inflamed, leading to a stuffy or
                        blocked nose. It may be accompanied by sinus pressure,
                        difficulty breathing through the nose, runny nose,
                        headaches, or discomfort caused by allergies,
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get relief from nasal congestion with Humancare Connect.
                        ...
                        symptom evaluation, treatment recommendations, recovery
                        guidance, and personalized care planning. Telehealth
                        services provide convenient access to an experienced
                        online provider who can help identify the cause of your
                        congestion and recommend effective solutions to improve
