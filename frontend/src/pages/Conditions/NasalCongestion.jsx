    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Nasal Congestion?</h3>
            <p className="sp-block-body">
              Nasal congestion occurs when the tissues inside the nose become
              swollen or inflamed, leading to a stuffy or blocked nose. It may
              be accompanied by sinus pressure, difficulty breathing through the
              nose, runny nose, headaches, or discomfort caused by allergies,
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get relief from nasal congestion with Humancare Connect. Our
              ...
              recommendations, recovery guidance, and personalized care
              planning. Telehealth services provide convenient access to an
              experienced online provider who can help identify the cause of
              your congestion and recommend effective solutions to improve
          ...
          <div>
            <h3 className="sp-block-title">
              Get Nasal Congestion care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Nasal Congestion care",
