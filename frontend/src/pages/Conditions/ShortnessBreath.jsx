...
export default function ShortnessOfBreath({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Shortness of breath can cause chest tightness, rapid
                        breathing, wheezing, fatigue, dizziness, and difficulty
                        getting enough air during daily activities or physical
                        movement.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get timely care for shortness of breath symptoms with
            ...
            <aside>
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=Shortness%20of%20Breath",
                    )
                  }
                >
                  Book Appointment →
