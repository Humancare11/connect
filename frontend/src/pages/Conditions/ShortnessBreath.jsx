...
import ConditionBannerImage from "../../assets/ConditionImages/RespiratoryHealth/Shortness-of-Breath.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What is Shortness of Breath?</h3>
            <p className="sp-block-body">
              Shortness of breath can cause chest tightness, rapid breathing,
              wheezing, fatigue, dizziness, and difficulty getting enough air
              during daily activities or physical movement.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get timely care for shortness of breath symptoms with Humancare
              ...
              from home. Through our secure virtual healthcare services, you can
              receive symptom evaluation, breathing care guidance, treatment
              recommendations, and prescriptions when appropriate without the
              stress of an urgent care visit.
            </p>
          </div>

          <div>
            <h3 className="sp-block-title">
              Get breathing support in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Shortness of Breath care",
                "Share your symptoms and breathing concerns",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Shortness%20of%20Breath")}>Start Consultation →</button>
