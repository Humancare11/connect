    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Dry Eyes?</h3>
            <p className="sp-block-body">
              Dry eyes occur when the eyes do not produce enough tears or when
              tears evaporate too quickly, leading to symptoms such as burning,
              stinging, redness, irritation, blurry vision, or a gritty
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get support for dry eye symptoms with Humancare Connect. Our
              ...
              online provider who can help identify potential causes of dry eyes
              and recommend appropriate strategies to improve comfort and
          ...
          <div>
            <h3 className="sp-block-title">
              Get Dry Eyes care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Dry Eyes care",
