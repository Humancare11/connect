...
export default function DryEyes({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Dry eyes occur when the eyes do not produce enough tears
                        or when tears evaporate too quickly, leading to symptoms
                        such as burning, stinging, redness, irritation, blurry
                        vision, or a gritty sensation in the eyes.
                      </p>
                    </div>
                    <div>
                      <h3 className="condition-block-title">How?</h3>
                      <p className="condition-block-body">
                        Get support for dry eye symptoms with Humancare Connect.
                        ...
                        potential causes of dry eyes and recommend appropriate
                        strategies to improve comfort and support long term eye
                        health.
                      </p>
                    </div>
                    <div>
            ...
            <aside>
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=eeb&condition=Dry%20Eyes",
                    )
                  }
                >
                  Book Appointment →
