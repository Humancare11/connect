...
import ConditionBannerImage from "../../assets/ConditionImages/RespiratoryHealth/COPD.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What is COPD?</h3>
            <p className="sp-block-body">
              COPD can cause shortness of breath, wheezing, chronic coughing,
              chest tightness, mucus buildup, and breathing difficulties that
              may worsen over time and affect daily activities.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get ongoing support for COPD symptoms with Humancare Connect. Our
              ...
              symptom evaluation, breathing care guidance, treatment
              recommendations, and prescriptions when appropriate without the
              stress of frequent clinic visits.
            </p>
          </div>

          <div>
            <h3 className="sp-block-title">
              Manage COPD symptoms in 4 simple steps.
            </h3>
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=COPD")}>Start Consultation →</button>
