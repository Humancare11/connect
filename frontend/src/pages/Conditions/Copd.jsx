...
export default function Copd({ categoryId } = {}) {
              ...
              <div className="condition-glass-card">
                ...
                <div className="condition-about-grid">
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">What is COPD?</h3>
                      <p className="condition-block-body">
                        COPD can cause shortness of breath, wheezing, chronic
                        coughing, chest tightness, mucus buildup, and breathing
                        difficulties that may worsen over time and affect daily
                        activities.
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get ongoing support for COPD symptoms with Humancare
            ...
            <aside>
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=COPD",
                    )
                  }
                >
                  Book Appointment →
