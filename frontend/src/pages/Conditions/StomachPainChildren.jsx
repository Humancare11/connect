...
import ConditionBannerImage from "../../assets/ConditionImages/PediatricCare/Stomach-Pain-in-Children.webp";
        ...
        <div className="sp-about-right">
          <div>
            ...
            <p className="sp-block-body">
              Stomach pain in children can cause cramping, bloating, nausea,
              constipation, diarrhea, loss of appetite, and abdominal discomfort
              often linked to infections, digestive issues, food sensitivities,
              or stomach bugs.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              ...
              digestive care guidance, treatment recommendations, and
          ...
          <div>
            <h3 className="sp-block-title">
              Get stomach pain care for your child in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Stomach Pain in Children care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=family&condition=Stomach%20Pain%20in%20Children")}>Start Consultation →</button>
