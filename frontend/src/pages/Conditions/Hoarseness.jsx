...
// ─────────────────────────────────────────────────────────────────
export default function Hoarseness({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Hoarseness is a change in the quality, pitch, or
                        strength of the voice that may cause it to sound raspy,
                        weak, strained, or breathy. It can be associated with
                        vocal strain, infections, allergies, acid reflux, or
                        other conditions affecting the throat and vocal cords.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        evaluation, treatment recommendations, throat health
                        guidance, and personalized care planning. Telehealth
                        services provide convenient access to an experienced
                        online provider who can assess your symptoms, discuss
                        possible causes, and recommend appropriate next steps to
                        help restore your voice and improve comfort.
                      </p>
                    </div>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=eeb&condition=Hoarseness",
                    )
                  }
                >
                  Book Appointment →
