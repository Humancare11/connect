    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Hoarseness?</h3>
            <p className="sp-block-body">
              Hoarseness is a change in the quality, pitch, or strength of the
              voice that may cause it to sound raspy, weak, strained, or
              breathy. It can be associated with vocal strain, infections,
              allergies, acid reflux, or other conditions affecting the throat
              and vocal cords.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get support for hoarseness with Humancare Connect. Our
              ...
              recommendations, throat health guidance, and personalized care
              planning. Telehealth services provide convenient access to an
              experienced online provider who can assess your symptoms, discuss
              possible causes, and recommend appropriate next steps to help
              restore your voice and improve comfort.
            </p>
          </div>

          <div>
            <h3 className="sp-block-title">
              Get Hoarseness care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Hoarseness care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=eeb&condition=Hoarseness")}>Start Consultation →</button>
