...
import ConditionBannerImage from "../../assets/ConditionImages/ChronicCare/Seizures -Epilepsy-Follow-Ups.webp";
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">
              What Is Seizures / Epilepsy Follow-Up?
            </h3>
            <p className="sp-block-body">
              Seizures and epilepsy require regular follow up care to monitor
              symptoms, evaluate treatment effectiveness, manage medications,
              and support long term neurological health and quality of life.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Stay connected to your epilepsy care with Humancare Connect. Our
              ...
              healthcare services for symptom monitoring, medication reviews,
              treatment guidance, and personalized care recommendations.
              Telehealth services provide convenient access to an experienced
              online provider who can help assess your progress, address
              concerns, and support effective seizure management.
            </p>
          </div>

          <div>
            <h3 className="sp-block-title">
              Get Seizures / Epilepsy Follow-Up care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Seizures / Epilepsy Follow-Up care",
  ...
  return (
    <div className="sp-sbc">
      ...
      <button
        ...
        onClick={() =>
          navigate(
            "/category-consultant?category=chronic&condition=Seizures%20%2F%20Epilepsy%20Follow-Up",
          )
        }
      >
        Start Consultation →
