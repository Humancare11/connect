...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=chronic&condition=Seizures%20%2F%20Epilepsy%20Follow-Up")}>Start Consultation →</button>
