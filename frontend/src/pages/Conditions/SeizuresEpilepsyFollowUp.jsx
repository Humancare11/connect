...
export default function SeizuresEpilepsyFollowUp({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Seizures and epilepsy require regular follow up care to
                        monitor symptoms, evaluate treatment effectiveness,
                        manage medications, and support long term neurological
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Stay connected to your epilepsy care with Humancare
                        ...
                        services for symptom monitoring, medication reviews,
                        ...
                        assess your progress, address concerns, and support
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get Seizures / Epilepsy Follow-Up care in 4 simple
                        steps.
                      </h3>
