...
// ─────────────────────────────────────────────────────────────────
export default function SportsNutrition({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Sports nutrition focuses on providing the right balance
                        of nutrients to support athletic performance, endurance,
                        recovery, muscle health, and overall wellness. Proper
                        nutrition can help individuals meet fitness goals and
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get personalized sports nutrition guidance with
                        ...
                        healthcare services for nutrition assessments,
                        performance focused dietary guidance, fitness support,
                        and personalized care recommendations. Telehealth
                        services provide convenient access to an experienced
                        online provider who can help you optimize your
                        nutrition, improve recovery, and support your athletic
                        and wellness goals.
                      </p>
                    </div>
