    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Sports Nutrition?</h3>
            <p className="sp-block-body">
              Sports nutrition focuses on providing the right balance of
              nutrients to support athletic performance, endurance, recovery,
              muscle health, and overall wellness. Proper nutrition can help
              individuals meet fitness goals and maintain an active lifestyle.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get personalized sports nutrition guidance with Humancare Connect.
              ...
              healthcare services for nutrition assessments, performance focused
              dietary guidance, fitness support, and personalized care
              recommendations. Telehealth services provide convenient access to
              an experienced online provider who can help you optimize your
              nutrition, improve recovery, and support your athletic and
              wellness goals.
            </p>
          </div>
          ...
          <div>
            <h3 className="sp-block-title">
              Get Sports Nutrition care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Sports Nutrition care",
                "Share your fitness goals, dietary habits, and concerns",
