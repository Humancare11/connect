...
import ConditionBannerImage from "../../assets/ConditionImages/RespiratoryHealth/Asthma.webp";
...
//
// NOTE: The About section below reads "What is Allergic Rhinitis?" and
// describes allergic rhinitis symptoms/copy, not asthma. This mismatch
// already existed in the pre-migration file (content for Asthma and
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Allergic rhinitis can cause sneezing, runny nose,
                        congestion, itchy eyes, sinus pressure, and nasal
                        irritation triggered by pollen, dust, pet dander, mold,
                        and other allergens.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get relief from allergic rhinitis symptoms with
                        ...
                        evaluation, allergy treatment guidance, and
