...
//
// NOTE: The SEO block, "About" copy, and the sticky-booking condition
// query param below all reference "Asthma" rather than "Allergic
// Rhinitis". This mismatch already existed in the pre-migration file
// (content was evidently copy-pasted from the Asthma page and never
// updated) and has been carried over unchanged — see migration report.
// ─────────────────────────────────────────────────────────────────
export default function AllergicRhinitis({ categoryId } = {}) {
              ...
              <div className="condition-glass-card">
                ...
                <div className="condition-about-grid">
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">What is Asthma?</h3>
                      <p className="condition-block-body">
                        Asthma can cause wheezing, shortness of breath, chest
                        tightness, coughing, and breathing difficulties
                        triggered by allergies, exercise, infections, smoke, or
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Manage asthma symptoms more easily with Humancare
                        Connect. Our telemedicine services make it simple to
                        ...
                        evaluation, breathing care guidance, treatment
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get asthma care in 4 simple steps.
                      </h3>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=Asthma",
                    )
                  }
                >
                  Book Appointment →
