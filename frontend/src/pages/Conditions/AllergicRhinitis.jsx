    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What is Asthma?</h3>
            <p className="sp-block-body">
              Asthma can cause wheezing, shortness of breath, chest tightness,
              coughing, and breathing difficulties triggered by allergies,
              exercise, infections, smoke, or environmental irritants.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Manage asthma symptoms more easily with Humancare Connect. Our
              telemedicine services make it simple to schedule an online doctor
