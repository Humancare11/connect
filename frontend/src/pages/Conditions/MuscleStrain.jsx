    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Muscle Strain?</h3>
            <p className="sp-block-body">
              Muscle strains can cause soreness, stiffness, swelling, weakness,
              cramping, and pain caused by overstretching or tearing of muscles
              during physical activity, exercise, lifting, or sudden movements.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get fast relief for muscle strain symptoms with Humancare Connect.
          ...
          <div>
            <h3 className="sp-block-title">
              Recover from muscle strain in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Muscle Strain care",
                "Share your symptoms and injury details",
                "Connect with an online provider",
                "Receive treatment guidance and personalized recovery support",
              ].map((b) => (
