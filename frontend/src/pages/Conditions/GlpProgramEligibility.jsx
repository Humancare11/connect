...
// ─────────────────────────────────────────────────────────────────
export default function GlpProgramEligibility({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What Is the GLP-1 Program?
                      </h3>
                      <p className="condition-block-body">
                        GLP-1 program eligibility helps determine whether
                        medications commonly used for weight management may be
                        appropriate based on factors such as body weight,
                        medical history, existing health conditions, and overall
                        health goals.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Explore your weight management options with Humancare
                        ...
                        services for weight management evaluations, health
                        assessments, treatment discussions, and personalized
                        care recommendations. Telehealth services provide
                        convenient access to an experienced online provider who
                        can review your health history, discuss your goals, and
                        help determine whether a GLP-1 program may be a suitable
