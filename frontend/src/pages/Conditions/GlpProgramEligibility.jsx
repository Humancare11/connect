    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is the GLP-1 Program?</h3>
            <p className="sp-block-body">
              GLP-1 program eligibility helps determine whether medications
              commonly used for weight management may be appropriate based on
              factors such as body weight, medical history, existing health
              conditions, and overall health goals.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Explore your weight management options with Humancare Connect. Our
              ...
              healthcare services for weight management evaluations, health
              assessments, treatment discussions, and personalized care
              ...
              discuss your goals, and help determine whether a GLP-1 program may
              be a suitable option for your needs.
            </p>
          </div>

          <div>
            <h3 className="sp-block-title">
              Get GLP-1 Program Eligibility care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose GLP-1 Program Eligibility care",
                "Share your health history and weight management goals",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=GLP-1%20Program%20Eligibility")}>Start Consultation →</button>
