    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Osteoarthritis?</h3>
            <p className="sp-block-body">
              Osteoarthritis can cause joint pain, stiffness, swelling, reduced
              flexibility, and discomfort that commonly affects the knees, hips,
              hands, and other weight-bearing joints.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Manage osteoarthritis symptoms from the comfort of home with
              ...
              provider. Through our secure telemedicine platform, you can
              receive symptom evaluation, pain management guidance, treatment
          ...
          <div>
            <h3 className="sp-block-title">
              Manage joint pain in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Osteoarthritis care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=chronic&condition=Osteoarthritis")}>Start Consultation →</button>
