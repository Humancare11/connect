...
//
// NOTE: The pre-migration file imported a local ConditionBannerImage
// asset but never used it — pageData.bgImage was hardcoded to an
// external Unsplash stock photo URL instead. Preserved that exact
// (buggy) behavior here rather than switching to the local asset, to
// keep rendered UI identical to before migration; the unused import
// was simply dropped. See migration report — worth fixing separately
// if the local asset is the intended image.
// ─────────────────────────────────────────────────────────────────
const pageData = {
...
// ─────────────────────────────────────────────────────────────────
export default function Indigestion({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Indigestion can cause bloating, stomach pain, heartburn,
                        nausea, gas, fullness, and discomfort after eating often
                        linked to diet, stress, acid reflux, or digestive
                        issues.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get fast relief for indigestion symptoms with Humancare
                        ...
                        healthcare services, you can receive digestive health
                        guidance, treatment recommendations, symptom management
                        support, and prescriptions when appropriate without
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get indigestion relief in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Indigestion care",
                          "Share your digestive symptoms and concerns",
                          "Connect with an online provider",
                          "Receive treatment guidance and personalized digestive care recommendations",
                        ].map((b) => (
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=Indigestion",
                    )
                  }
                >
                  Book Appointment →
