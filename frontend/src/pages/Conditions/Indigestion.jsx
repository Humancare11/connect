    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Indigestion?</h3>
            <p className="sp-block-body">
              Indigestion can cause bloating, stomach pain, heartburn, nausea,
              gas, fullness, and discomfort after eating often linked to diet,
              stress, acid reflux, or digestive issues.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get fast relief for indigestion symptoms with Humancare Connect.
              ...
              digestive health guidance, treatment recommendations, symptom
              management support, and prescriptions when appropriate without
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Indigestion")}>Start Consultation →</button>
