...
// ─────────────────────────────────────────────────────────────────
export default function MemoryConcerns({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What Is Memory Concerns?
                      </h3>
                      <p className="condition-block-body">
                        Memory concerns can include forgetfulness, difficulty
                        concentrating, trouble recalling information, confusion,
                        or other cognitive changes that may affect daily
                        activities, work performance, and overall quality of
                        life.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get support for memory concerns with Humancare Connect.
                        ...
                        symptom evaluation, cognitive health assessments,
                        ...
                        your symptoms, discuss possible contributing factors,
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get Memory Concerns care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Memory Concerns care",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=chronic&condition=Memory%20Concerns",
                    )
                  }
                >
                  Book Appointment →
