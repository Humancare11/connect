        ...
        <div className="sp-glass-card">
            ...
            <div className="sp-about-grid">
                ...
                <div className="sp-about-right">
                    <div>
                        <h3 className="sp-block-title">What Is Memory Concerns?</h3>
                        <p className="sp-block-body">
                            Memory concerns can include forgetfulness, difficulty concentrating, trouble recalling information, confusion, or other cognitive changes that may affect daily activities, work performance, and overall quality of life.
                    ...
                    <div>
                        ...
                        <p className="sp-block-body">
                           Get support for memory concerns with Humancare Connect. Our telemedicine services make it easy to schedule an online doctor appointment and connect with a licensed provider from home. Through our secure telemedicine platform, you can access virtual healthcare services for symptom evaluation, cognitive health assessments, treatment guidance, and personalized care recommendations. Telehealth services provide convenient access to an experienced online provider who can review your symptoms, discuss possible contributing factors, and recommend appropriate next steps to support your cognitive health and well being.
          
                         </p>
                    </div>

                    <div>
                        <h3 className="sp-block-title">Get Memory Concerns care in 4 simple steps.</h3>
                        <div className="sp-benefits-grid">
                            {[
                                "Choose Memory Concerns care", "Share your symptoms and concerns ",
  ...
  const navigate = useNavigate();
    ...
    return (
        <div className="sp-sbc">
            ...
            <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=chronic&condition=Memory%20Concerns")}>Start Consultation →</button>
