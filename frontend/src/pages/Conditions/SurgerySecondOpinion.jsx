...
import ConditionBannerImage from "../../assets/ConditionImages/ChronicCare/Surgery-Second-Opinion.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Surgery Second Opinion?</h3>
            <p className="sp-block-body">
              A surgery second opinion can help patients better understand a
              recommended procedure, explore alternative treatment options,
              review potential risks and benefits, and make informed decisions
              about their care.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get expert guidance before surgery with Humancare Connect. Our
              ...
              healthcare services for treatment reviews, surgical
              recommendations, care planning, and personalized guidance.
              Telehealth services provide convenient access to an experienced
              online provider who can evaluate your diagnosis, discuss available
              options, and help you make confident decisions about your surgical
              care.
            </p>
          </div>
          ...
          <div>
            <h3 className="sp-block-title">
              Get Surgery Second Opinion care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Surgery Second Opinion care",
                "Share your diagnosis, treatment recommendations, and concerns",
  ...
  return (
    <div className="sp-sbc">
      ...
      <button
        ...
        onClick={() =>
          navigate(
            "/category-consultant?category=chronic&condition=Surgery%20Second%20Opinion",
          )
        }
      >
        Start Consultation →
