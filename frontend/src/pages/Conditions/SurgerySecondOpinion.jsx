...
// ─────────────────────────────────────────────────────────────────
export default function SurgerySecondOpinion({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What Is Surgery Second Opinion?
                      </h3>
                      <p className="condition-block-body">
                        A surgery second opinion can help patients better
                        understand a recommended procedure, explore alternative
                        treatment options, review potential risks and benefits,
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get expert guidance before surgery with Humancare
                        ...
                        services for treatment reviews, surgical
                        recommendations, care planning, and personalized
                        guidance. Telehealth services provide convenient access
                        to an experienced online provider who can evaluate your
                        diagnosis, discuss available options, and help you make
                        confident decisions about your surgical care.
                      </p>
                    </div>
