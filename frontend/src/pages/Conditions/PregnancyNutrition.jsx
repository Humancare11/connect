...
export default function PregnancyNutrition({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Pregnancy nutrition plays an important role in
                        supporting both maternal health and fetal development.
                        Proper nutrition can help meet increased nutrient needs,
                        support healthy growth, and promote overall well being
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get personalized pregnancy nutrition guidance with
                        ...
                        healthcare services for nutritional assessments, healthy
                        eating guidance, prenatal wellness support, and
                        personalized care recommendations. Telehealth services
                        provide convenient access to an experienced online
                        provider who can help you make informed dietary choices,
                        address nutritional concerns, and support a healthy
                        pregnancy journey.
                      </p>
                    </div>
