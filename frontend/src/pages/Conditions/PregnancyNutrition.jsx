...
import ConditionBannerImage from "../../assets/ConditionImages/DigestiveCare/Pregnancy-Nutrition.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Pregnancy Nutrition?</h3>
            <p className="sp-block-body">
              Pregnancy nutrition plays an important role in supporting both
              maternal health and fetal development. Proper nutrition can help
              meet increased nutrient needs, support healthy growth, and promote
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get personalized pregnancy nutrition guidance with Humancare
              ...
              access virtual healthcare services for nutritional assessments,
              healthy eating guidance, prenatal wellness support, and
              ...
              you make informed dietary choices, address nutritional concerns,
          ...
          <div>
            <h3 className="sp-block-title">
              Get Pregnancy Nutrition care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Pregnancy Nutrition care",
  ...
  return (
    <div className="sp-sbc">
      ...
      <button
        ...
        onClick={() =>
          navigate(
            "/category-consultant?category=general&condition=Pregnancy%20Nutrition",
          )
        }
      >
        Start Consultation →
