        ...
        <div className="sp-about-right">
          <div>
            ...
            <p className="sp-block-body">
              Irritable Bowel Syndrome (IBS) can cause stomach cramps, bloating,
              gas, diarrhea, constipation, and abdominal discomfort that may
              flare up due to stress, certain foods, or digestive sensitivities.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Manage IBS symptoms more comfortably with Humancare Connect. Our
              telemedicine services let you schedule an online doctor
              appointment and connect with a licensed provider from home.
              Through our secure telemedicine platform, you can receive
              digestive health guidance, symptom management support, treatment
          ...
          <div>
            <h3 className="sp-block-title">
              Manage IBS symptoms in 4 simple steps.
            </h3>
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Irritable%20Bowel%20Syndrome%20%28IBS%29")}>Start Consultation →</button>
