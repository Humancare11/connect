...
// ─────────────────────────────────────────────────────────────────
export default function FeedingConcerns({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Feeding concerns can include difficulties with
                        breastfeeding, bottle feeding, feeding schedules, poor
                        weight gain, feeding intolerance, picky eating
                        behaviors, or questions about meeting a child's
                        nutritional needs.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get trusted support for feeding concerns with Humancare
                        ...
                        services for feeding assessments, nutrition guidance,
                        ...
                        address feeding challenges, answer your questions, and
                        support your child's healthy growth and development.
                      </p>
                    </div>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=family&condition=Feeding%20Concerns",
                    )
                  }
                >
                  Book Appointment →
