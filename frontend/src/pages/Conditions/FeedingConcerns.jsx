...
import ConditionBannerImage from "../../assets/ConditionImages/PediatricCare/Feeding-Concerns.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Are Feeding Concerns?</h3>
            <p className="sp-block-body">
              Feeding concerns can include difficulties with breastfeeding,
              bottle feeding, feeding schedules, poor weight gain, feeding
              intolerance, picky eating behaviors, or questions about meeting a
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get trusted support for feeding concerns with Humancare Connect.
              ...
              healthcare services for feeding assessments, nutrition guidance,
              symptom evaluation, and personalized care recommendations.
              Telehealth services provide convenient access to an experienced
              online provider who can help address feeding challenges, answer
              your questions, and support your child's healthy growth and
              development.
            </p>
          </div>
          ...
          <div>
            <h3 className="sp-block-title">
              Get Feeding Concerns care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Feeding Concerns care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=family&condition=Feeding%20Concerns")}>Start Consultation →</button>
