...
export default function DietExercisePlanning({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Diet and exercise planning helps individuals create
                        balanced nutrition and physical activity routines that
                        support weight management, improve overall health,
                        increase energy levels, and promote long term wellness
                        goals.
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="condition-block-body">
                        Achieve your health goals with personalized support from
                        ...
                        healthcare services for lifestyle assessments, nutrition
                        guidance, fitness planning, and personalized care
                        recommendations. Telehealth services provide convenient
                        access to an experienced online provider who can help
                        you develop realistic diet and exercise strategies
                        tailored to your health needs, preferences, and wellness
                        objectives.
                      </p>
                    </div>
                    <div>
