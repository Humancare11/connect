...
import ConditionBannerImage from "../../assets/ConditionImages/DigestiveCare/Diet-&-Exercise-Planning.webp";
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">
              What Is Diet & Exercise Planning?
            </h3>
            <p className="sp-block-body">
              Diet and exercise planning helps individuals create balanced
              nutrition and physical activity routines that support weight
              management, improve overall health, increase energy levels, and
              promote long term wellness goals.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Achieve your health goals with personalized support from Humancare
              ...
              access virtual healthcare services for lifestyle assessments,
              nutrition guidance, fitness planning, and personalized care
              recommendations. Telehealth services provide convenient access to
              an experienced online provider who can help you develop realistic
              diet and exercise strategies tailored to your health needs,
              preferences, and wellness objectives.
            </p>
          </div>

          <div>
            <h3 className="sp-block-title">
              Get Diet & Exercise Planning care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Diet & Exercise Planning care",
  ...
  return (
    <div className="sp-sbc">
      ...
      <button
        ...
        onClick={() =>
          navigate(
            "/category-consultant?category=general&condition=Diet%20%26%20Exercise%20Planning",
          )
        }
      >
        Start Consultation →
