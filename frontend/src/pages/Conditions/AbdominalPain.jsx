    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Abdominal Pain?</h3>
            <p className="sp-block-body">
              Abdominal pain can cause cramping, bloating, stomach pressure,
              nausea, tenderness, and discomfort that may be linked to
              infections, digestive issues, food intolerance, constipation, or
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get fast care for abdominal pain symptoms with Humancare Connect.
              ...
              symptom evaluation, treatment guidance, digestive care support,
          ...
          <div>
            <h3 className="sp-block-title">
              Get abdominal pain care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Abdominal Pain care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Abdominal%20Pain")}>Start Consultation →</button>
