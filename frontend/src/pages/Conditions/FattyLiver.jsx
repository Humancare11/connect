    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Chronic Kidney Disease?</h3>
            <p className="sp-block-body">
              Fatty liver disease occurs when excess fat builds up in the liver and may be associated with obesity, diabetes, high cholesterol, or other metabolic conditions. Regular follow up care can help monitor liver health and support long term wellness.
          ...
          <div>
            ...
            <p className="sp-block-body">
              Stay on track with your liver health through Humancare Connect. Our telemedicine services make it easy to schedule an online doctor appointment and connect with a licensed provider from home. Through our secure telemedicine platform, you can access virtual healthcare services for symptom evaluation, health monitoring, lifestyle guidance, and personalized care recommendations. Telehealth services provide convenient access to an experienced online provider who can review your progress, discuss treatment options, and help you manage fatty liver disease more effectively.
            </p>
          </div>

          <div>
            <h3 className="sp-block-title">Get Fatty Liver Follow-Up care in 4 simple steps.</h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Fatty Liver Follow-Up care", "Share your symptoms, concerns, and medical history",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=chronic&condition=Fatty%20Liver%20Follow-Up")}>Start Consultation →</button>
