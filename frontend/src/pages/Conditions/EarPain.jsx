                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Ear pain can cause pressure, sharp pain, muffled
                        hearing, irritation, tenderness, ringing, and discomfort
                        that may be linked to ear infections, sinus congestion,
                        allergies, fluid buildup, or jaw-related issues.
                      </p>
                    </div>
                    <div>
                      <h3 className="condition-block-title">How?</h3>
                      <p className="condition-block-body">
                        Get fast relief for ear pain symptoms with Humancare
            ...
            <aside>
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=eeb&condition=Ear%20Pain",
                    )
                  }
                >
                  Start Consultation →
