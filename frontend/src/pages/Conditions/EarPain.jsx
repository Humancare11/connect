    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Ear Pain?</h3>
            <p className="sp-block-body">
              Ear pain can cause pressure, sharp pain, muffled hearing,
              irritation, tenderness, ringing, and discomfort that may be linked
              to ear infections, sinus congestion, allergies, fluid buildup, or
              jaw-related issues.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get fast relief for ear pain symptoms with Humancare Connect. Our
          ...
          <div>
            <h3 className="sp-block-title">
              Get ear pain relief in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Ear Pain care",
