...
// ─────────────────────────────────────────────────────────────────
export default function PreOpCardiacClearance({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What Is Pre-Op Cardiac Clearance?
                      </h3>
                      <p className="condition-block-body">
                        Pre op cardiac clearance helps assess heart health
                        before a planned surgical procedure. This evaluation may
                        identify potential cardiovascular risks, review medical
                        history, and help determine whether additional testing
                        or precautions are needed before surgery.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Prepare for surgery with confidence through Humancare
                        ...
                        services for preoperative assessments, health history
                        reviews, treatment guidance, and personalized care
                        recommendations. Telehealth services provide convenient
                        access to an experienced online provider who can help
                        evaluate your cardiovascular health, discuss surgical
                        readiness, and recommend appropriate next steps before
                        your procedure.
                      </p>
                    </div>
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get Pre-Op Cardiac Clearance care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Pre-Op Cardiac Clearance care",
                          "Share your medical history and surgical details",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=chronic&condition=Pre-Op%20Cardiac%20Clearance",
                    )
                  }
                >
                  Book Appointment →
