        ...
        <div className="sp-about-right">
          <div>
            ...
            <p className="sp-block-body">
              Pre op cardiac clearance helps assess heart health before a
              planned surgical procedure. This evaluation may identify potential
              cardiovascular risks, review medical history, and help determine
              whether additional testing or precautions are needed before
              surgery.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Prepare for surgery with confidence through Humancare Connect. Our
              ...
              healthcare services for preoperative assessments, health history
              reviews, treatment guidance, and personalized care
              recommendations. Telehealth services provide convenient access to
              an experienced online provider who can help evaluate your
              cardiovascular health, discuss surgical readiness, and recommend
              appropriate next steps before your procedure.
            </p>
          </div>
