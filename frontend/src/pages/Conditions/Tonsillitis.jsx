    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Tonsillitis?</h3>
            <p className="sp-block-body">
              Tonsillitis is an inflammation of the tonsils that can cause a
              sore throat, painful swallowing, swollen tonsils, fever, bad
              breath, and swollen lymph nodes in the neck. It may be caused by
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get care for tonsillitis symptoms with Humancare Connect. Our
              ...
              appropriate. Telehealth services provide convenient access to an
              experienced online provider who can assess your symptoms, discuss
              possible causes, and help you find relief without the need for an
              in person visit.
            </p>
          </div>
