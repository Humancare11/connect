...
// ─────────────────────────────────────────────────────────────────
export default function Gastritis({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Gastritis can cause burning stomach pain, nausea,
                        bloating, indigestion, vomiting, loss of appetite, and
                        abdominal discomfort often triggered by infections,
                        medications, stress, or irritation of the stomach lining
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get fast relief for gastritis symptoms with Humancare
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=Gastritis",
                    )
                  }
                >
                  Book Appointment →
