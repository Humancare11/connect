    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Gastritis?</h3>
            <p className="sp-block-body">
              Gastritis can cause burning stomach pain, nausea, bloating,
              indigestion, vomiting, loss of appetite, and abdominal discomfort
              often triggered by infections, medications, stress, or irritation
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get fast relief for gastritis symptoms with Humancare Connect. Our
          ...
          <div>
            <h3 className="sp-block-title">
              Get gastritis care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Gastritis care",
                "Share your symptoms and digestive concerns",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Gastritis")}>Start Consultation →</button>
