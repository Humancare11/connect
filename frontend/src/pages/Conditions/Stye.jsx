...
// ─────────────────────────────────────────────────────────────────
export default function Stye({ categoryId } = {}) {
              ...
              <div className="condition-glass-card">
                ...
                <div className="condition-about-grid">
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">What Is Stye?</h3>
                      <p className="condition-block-body">
                        A stye is a small, painful lump that develops along the
                        edge of the eyelid due to a blocked or infected oil
                        gland. Symptoms may include redness, swelling,
                        tenderness, irritation, tearing, or a feeling that
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        evaluation, treatment recommendations, eye health
                        ...
                        appropriate treatment options, and help support a
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get Stye care in 4 simple steps.
                      </h3>
