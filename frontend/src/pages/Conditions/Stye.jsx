    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Stye?</h3>
            <p className="sp-block-body">
              A stye is a small, painful lump that develops along the edge of
              the eyelid due to a blocked or infected oil gland. Symptoms may
              include redness, swelling, tenderness, irritation, tearing, or a
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get care for stye symptoms with Humancare Connect. Our
              ...
              recommendations, eye health guidance, and personalized care
              ...
              appropriate treatment options, and help support a comfortable
              recovery.
            </p>
          </div>

          <div>
            <h3 className="sp-block-title">Get Stye care in 4 simple steps.</h3>
