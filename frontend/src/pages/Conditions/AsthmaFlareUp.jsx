...
export default function AsthmaFlareUp({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        An asthma flare-up can cause wheezing, chest tightness,
                        shortness of breath, coughing, and difficulty breathing
                        triggered by allergens, infections, exercise, smoke, or
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get quick support for asthma flare-up symptoms with
            ...
            <aside>
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=Asthma%20Flare-Up",
                    )
                  }
                >
                  Book Appointment →
