    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What is an Asthma Flare-Up?</h3>
            <p className="sp-block-body">
              An asthma flare-up can cause wheezing, chest tightness, shortness
              of breath, coughing, and difficulty breathing triggered by
              allergens, infections, exercise, smoke, or environmental
              irritants.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get quick support for asthma flare-up symptoms with Humancare
              Connect. Our telemedicine services make it easy to book an online
          ...
          <div>
            <h3 className="sp-block-title">
              Manage asthma flare-ups in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Asthma Flare-Up care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Asthma%20Flare-Up")}>Start Consultation →</button>
