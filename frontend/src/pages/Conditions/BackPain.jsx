...
// ─────────────────────────────────────────────────────────────────
export default function BackPain({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Back pain can cause stiffness, muscle tension, soreness,
                        reduced mobility, sharp pain, and discomfort in the
                        upper, middle, or lower back that may affect daily
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get convenient back pain care with Humancare Connect.
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=eeb&condition=Back%20Pain",
                    )
                  }
                >
                  Book Appointment →
