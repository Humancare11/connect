    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Back Pain?</h3>
            <p className="sp-block-body">
              Back pain can cause stiffness, muscle tension, soreness, reduced
              mobility, sharp pain, and discomfort in the upper, middle, or
              lower back that may affect daily movement and activities.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get convenient back pain care with Humancare Connect. Our
              ...
              evaluation, pain management guidance, treatment recommendations,
          ...
          <div>
            <h3 className="sp-block-title">
              Manage back pain in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Back Pain care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=eeb&condition=Back%20Pain")}>Start Consultation →</button>
