...
import ConditionBannerImage from "../../assets/ConditionImages/DigestiveCare/Sleep-Hygiene.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Sleep Hygiene?</h3>
            <p className="sp-block-body">
              Sleep hygiene refers to healthy habits and routines that support
              consistent, restful sleep. Poor sleep habits can contribute to
              difficulty falling asleep, frequent awakenings, daytime fatigue,
              reduced concentration, and overall decreased well being.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Improve your sleep quality with support from Humancare Connect.
              ...
              healthcare services for sleep assessments, lifestyle guidance,
              symptom evaluation, and personalized care recommendations.
              Telehealth services provide convenient access to an experienced
              online provider who can help identify factors affecting your sleep
              and develop practical strategies to promote healthier sleep habits
          ...
          <div>
            <h3 className="sp-block-title">
              Get Sleep Hygiene care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Sleep Hygiene care",
  ...
  return (
    <div className="sp-sbc">
      ...
      <button
        ...
        onClick={() =>
          navigate(
            "/category-consultant?category=general&condition=Sleep%20Hygiene",
          )
        }
      >
        Start Consultation →
