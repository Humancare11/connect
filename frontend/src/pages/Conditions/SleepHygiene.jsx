...
export default function SleepHygiene({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Sleep hygiene refers to healthy habits and routines that
                        support consistent, restful sleep. Poor sleep habits can
                        contribute to difficulty falling asleep, frequent
                        awakenings, daytime fatigue, reduced concentration, and
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Improve your sleep quality with support from Humancare
                        ...
                        services for sleep assessments, lifestyle guidance,
                        symptom evaluation, and personalized care
                        recommendations. Telehealth services provide convenient
                        access to an experienced online provider who can help
                        identify factors affecting your sleep and develop
                        practical strategies to promote healthier sleep habits
