...
import ConditionBannerImage from "../../assets/ConditionImages/DigestiveCare/Diabetic-Diet.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Diabetic Diet?</h3>
            <p className="sp-block-body">
              A diabetic diet focuses on balanced nutrition to help manage blood
              sugar levels, support overall health, and reduce the risk of
              diabetes related complications. Healthy eating habits can play an
              important role in maintaining long term wellness.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get personalized diabetic diet support with Humancare Connect. Our
              ...
              healthcare services for nutrition counseling, diabetes management
              guidance, meal planning support, and personalized care
              recommendations. Telehealth services provide convenient access to
              an experienced online provider who can help you make informed
              dietary choices, improve blood sugar control, and support your
          ...
          <div>
            <h3 className="sp-block-title">
              Get Diabetic Diet care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Diabetic Diet care",
  ...
  return (
    <div className="sp-sbc">
      ...
      <button
        ...
        onClick={() =>
          navigate(
            "/category-consultant?category=general&condition=Diabetic%20Diet",
          )
        }
      >
        Start Consultation →
