...
export default function DiabeticDiet({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        A diabetic diet focuses on balanced nutrition to help
                        manage blood sugar levels, support overall health, and
                        reduce the risk of diabetes related complications.
                        Healthy eating habits can play an important role in
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get personalized diabetic diet support with Humancare
                        ...
                        services for nutrition counseling, diabetes management
                        ...
                        you make informed dietary choices, improve blood sugar
                        control, and support your overall health goals.
                      </p>
                    </div>
                    <div>
                      <h3 className="condition-block-title">
