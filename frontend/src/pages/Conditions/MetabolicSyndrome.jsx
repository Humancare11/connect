    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Metabolic Syndrome?</h3>
            <p className="sp-block-body">
              Metabolic syndrome is a group of health conditions that can occur
              together, including high blood pressure, elevated blood sugar,
              excess abdominal weight, and abnormal cholesterol levels,
          ...
          <div>
            ...
            <p className="sp-block-body">
              Take control of your health with support for metabolic syndrome
              through Humancare Connect. Our telemedicine services make it easy
              to schedule an online doctor appointment and connect with a
              licensed provider from home. Through our secure telemedicine
              platform, you can access virtual healthcare services for health
              assessments, risk evaluation, lifestyle guidance, treatment
              planning, and personalized care recommendations. Telehealth
              services provide convenient access to an experienced online
              provider who can help you manage metabolic health risks and
          ...
          <div>
            <h3 className="sp-block-title">
              Get Metabolic Syndrome care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Metabolic Syndrome care",
                "Share your symptoms, concerns, and health history",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Metabolic%20Syndrome")}>Start Consultation →</button>
