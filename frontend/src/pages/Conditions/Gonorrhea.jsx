...
// ─────────────────────────────────────────────────────────────────
export default function Gonorrhea({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Gonorrhea can cause burning during urination, unusual
                        discharge, pelvic pain, swelling, discomfort, and mild
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get fast and confidential gonorrhea care with Humancare
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=sexual&condition=Gonorrhea",
                    )
                  }
                >
                  Book Appointment →
