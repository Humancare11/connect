...
export default function ChildhoodAllergies({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Childhood allergies can cause sneezing, itchy eyes,
                        rashes, congestion, coughing, skin irritation, and
                        breathing discomfort triggered by pollen, dust, pet
                        dander, foods, or environmental allergens.
                      </p>
                    </div>
                    <div>
                      <h3 className="condition-block-title">How?</h3>
                      <p className="condition-block-body">
                        Get trusted allergy care for your child with Humancare
                        ...
                        allergy management guidance, treatment recommendations,
            ...
            <aside>
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=family&condition=Childhood%20Allergies",
                    )
                  }
                >
                  Book Appointment →
