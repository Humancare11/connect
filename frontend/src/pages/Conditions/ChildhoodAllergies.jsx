    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Are Childhood Allergies?</h3>
            <p className="sp-block-body">
              Childhood allergies can cause sneezing, itchy eyes, rashes,
              congestion, coughing, skin irritation, and breathing discomfort
              triggered by pollen, dust, pet dander, foods, or environmental
              allergens.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get trusted allergy care for your child with Humancare Connect.
              ...
              symptom evaluation, allergy management guidance, treatment
          ...
          <div>
            <h3 className="sp-block-title">
              Get childhood allergy care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Childhood Allergies care",
                "Share your child’s symptoms and allergy concerns",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=family&condition=Childhood%20Allergies")}>Start Consultation →</button>
