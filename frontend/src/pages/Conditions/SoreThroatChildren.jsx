...
export default function SoreThroatChildren({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What is Sore Throat in Children?
                      </h3>
                      <p className="condition-block-body">
                        Sore throat in children can cause throat pain,
                        difficulty swallowing, fever, cough, irritability,
                        swollen glands, and discomfort often linked to viral
                        infections, colds, flu, or strep throat.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        guidance, fever care support, and prescriptions when
                        appropriate without the hassle of an urgent care visit.
                      </p>
                    </div>
            ...
            <aside>
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=family&condition=Sore%20Throat%20in%20Children",
                    )
                  }
                >
                  Book Appointment →
