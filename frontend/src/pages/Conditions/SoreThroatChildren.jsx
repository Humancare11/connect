...
import ConditionBannerImage from "../../assets/ConditionImages/PediatricCare/Sore-Throat-in-Children.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What is Sore Throat in Children?</h3>
            <p className="sp-block-body">
              Sore throat in children can cause throat pain, difficulty
              swallowing, fever, cough, irritability, swollen glands, and
              discomfort often linked to viral infections, colds, flu, or strep
              throat.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              ...
              evaluation, treatment guidance, fever care support, and
              prescriptions when appropriate without the hassle of an urgent
              care visit.
            </p>
          </div>
          ...
          <div>
            <h3 className="sp-block-title">
              Get pediatric throat care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Sore Throat in Children care",
                "Share your child’s symptoms and concerns",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=family&condition=Sore%20Throat%20in%20Children")}>Start Consultation →</button>
