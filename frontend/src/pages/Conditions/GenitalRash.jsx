    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What is Genital Rash?</h3>
            <p className="sp-block-body">
              A genital rash can cause redness, itching, burning, bumps,
              irritation, discomfort, or skin changes in the genital area caused
              by infections, allergies, irritation, heat, or other skin
              conditions.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get discreet and confidential care for genital rash symptoms with
              ...
              can receive symptom evaluation, treatment guidance, skincare
              recommendations, and prescriptions when appropriate without the
              discomfort of an in-person clinic visit.
            </p>
          </div>

          <div>
            <h3 className="sp-block-title">
              Get genital rash care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Genital Rash care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=sexual&condition=Genital%20Rash")}>Start Consultation →</button>
