...
// ─────────────────────────────────────────────────────────────────
export default function GenitalRash({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        A genital rash can cause redness, itching, burning,
                        bumps, irritation, discomfort, or skin changes in the
                        genital area caused by infections, allergies,
                        irritation, heat, or other skin conditions.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get discreet and confidential care for genital rash
                        ...
                        receive symptom evaluation, treatment guidance, skincare
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=sexual&condition=Genital%20Rash",
                    )
                  }
                >
                  Book Appointment →
