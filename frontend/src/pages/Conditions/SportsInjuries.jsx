...
import ConditionBannerImage from "../../assets/ConditionImages/PediatricCare/Sports-Injuries-in-children.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What are Sports Injuries?</h3>
            <p className="sp-block-body">
              Sports injuries can occur during exercise, training, or
              recreational activities and may cause pain, swelling, bruising,
              strains, sprains, joint discomfort, or limited movement that
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get support for sports injuries with Humancare Connect. Our
              ...
              healthcare services for symptom evaluation, injury assessments,
              treatment guidance, and personalized care recommendations.
              Telehealth services provide convenient access to an experienced
              online provider who can help determine the severity of your
              injury, recommend recovery strategies, and guide you toward a safe
          ...
          <div>
            <h3 className="sp-block-title">
              Get Sports Injuries care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Sports Injuries care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=family&condition=Sports%20Injuries")}>Start Consultation →</button>
