...
export default function SportsInjuries({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        recreational activities and may cause pain, swelling,
                        bruising, strains, sprains, joint discomfort, or limited
                        movement that affects daily activities and athletic
                        performance.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get support for sports injuries with Humancare Connect.
                        ...
                        symptom evaluation, injury assessments, treatment
                        guidance, and personalized care recommendations.
                        Telehealth services provide convenient access to an
                        experienced online provider who can help determine the
                        severity of your injury, recommend recovery strategies,
                        and guide you toward a safe return to physical activity.
                      </p>
                    </div>
            ...
            <aside>
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=family&condition=Sports%20Injuries",
                    )
                  }
                >
                  Book Appointment →
