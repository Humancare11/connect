...
import ConditionBannerImage from "../../assets/ConditionImages/PrescriptionsAndContinuityCare/Doctors-Note.webp";
...
//
// NOTE: the SEO title/description/keywords below reproduce the
// pre-migration file byte-for-byte, including a U+FFFD replacement
// character in place of the apostrophe in "Doctor's" (a pre-existing
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What are doctor notes for?
                      </h3>
                      <p className="condition-block-body">
                        Doctor’s notes may be needed for illness verification,
                        recovery periods, missed work or school, medical leave,
                        activity restrictions, or other health-related
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get convenient documentation support with Humancare
                        ...
                        evaluations, treatment guidance, and doctor’s note
                        documentation when appropriate without the hassle of an
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get a doctor’s note in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Doctor’s Note care",
                          "Share your symptoms and documentation needs",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=Doctor%E2%80%99s%20Note",
                    )
                  }
                >
                  Book Appointment →
