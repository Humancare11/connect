    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What are doctor notes for?</h3>
            <p className="sp-block-body">
              Doctor’s notes may be needed for illness verification, recovery
              periods, missed work or school, medical leave, activity
              restrictions, or other health-related documentation requirements.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get convenient documentation support with Humancare Connect. Our
              ...
              Through our secure telemedicine platform, you can receive medical
              evaluations, treatment guidance, and doctor’s note documentation
              when appropriate without the hassle of an in-person clinic visit.
            </p>
          </div>
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Doctor%E2%80%99s%20Note")}>Start Consultation →</button>
