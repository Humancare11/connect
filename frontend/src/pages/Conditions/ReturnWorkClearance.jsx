...
import ConditionBannerImage from "../../assets/ConditionImages/PrescriptionsAndContinuityCare/Return-to-Work-Clearance.webp";
        ...
        <div className="sp-about-right">
          <div>
            ...
            <p className="sp-block-body">
              Return-to-work clearances may be needed after illness, injury,
              surgery, infections, or recovery periods to confirm you’re
              medically ready to safely resume work responsibilities.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get convenient return-to-work support with Humancare Connect. Our
              ...
              evaluations, recovery guidance, treatment recommendations, and
              work clearance documentation when appropriate without the hassle
          ...
          <div>
            <h3 className="sp-block-title">
              Get return-to-work clearance in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Return-to-Work Clearance care",
                "Share your medical history and recovery details",
                "Connect with an online provider",
                "Receive medical guidance and clearance support",
              ].map((b) => (
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Return-to-Work%20Clearance")}>Start Consultation →</button>
