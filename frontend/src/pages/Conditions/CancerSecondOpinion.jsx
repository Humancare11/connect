...
export default function CancerSecondOpinion({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        A cancer second opinion can help patients better
                        understand a diagnosis, review treatment options,
                        confirm recommendations, and make informed decisions
                        about their cancer care with greater confidence and
                        clarity.
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get additional support for your cancer care journey with
                        ...
                        healthcare services for diagnosis reviews, treatment
                        discussions, care planning, and personalized
                        recommendations. Telehealth services provide convenient
                        access to an experienced online provider who can help
                        evaluate your current treatment approach, answer
                        questions, and provide valuable insights to support
