        ...
        <div className="sp-about-right">
          <div>
            ...
            <p className="sp-block-body">
              Chronic kidney disease can cause fatigue, swelling, changes in urination, high blood pressure, weakness, and fluid retention as kidney function gradually declines over time.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Manage chronic kidney disease with ongoing support through Humancare Connect. Our telemedicine services make it easy to schedule an online doctor appointment and connect with a licensed provider from home. Through our secure virtual healthcare services, you can receive symptom monitoring, treatment guidance, lifestyle recommendations, and prescriptions when appropriate without the stress of frequent clinic visits.

            </p>
          </div>

          <div>
            <h3 className="sp-block-title">Manage kidney health in 4 simple steps.</h3>
