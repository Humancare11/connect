...
// ─────────────────────────────────────────────────────────────────
export default function ChronicKidneyDisease({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Chronic kidney disease can cause fatigue, swelling,
                        changes in urination, high blood pressure, weakness, and
                        fluid retention as kidney function gradually declines
                        over time.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Manage chronic kidney disease with ongoing support
                        ...
                        symptom monitoring, treatment guidance, lifestyle
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Manage kidney health in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Chronic Kidney Disease care",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=chronic&condition=Chronic%20Kidney%20Disease",
                    )
                  }
                >
                  Book Appointment →
