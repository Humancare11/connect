...
import ConditionBannerImage from "../../assets/HomeImageConditions/eye-problems-vision-care-services.webp";
...
// ─────────────────────────────────────────────────────────────────
export default function EyeStrain({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Eye strain can occur after prolonged screen use,
                        reading, driving, or other visually demanding
                        activities. Common symptoms include tired eyes,
                        headaches, blurred vision, dryness, sensitivity to
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        evaluation, eye health guidance, treatment
                        recommendations, and personalized care planning.
                        Telehealth services provide convenient access to an
                        experienced online provider who can assess your
                        symptoms, identify potential contributing factors, and
                        recommend strategies to improve comfort and support long
                        term eye health.
                      </p>
                    </div>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=eeb&condition=Eye%20Strain",
                    )
                  }
                >
                  Book Appointment →
