    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Eye Strain?</h3>
            <p className="sp-block-body">
              Eye strain can occur after prolonged screen use, reading, driving,
              or other visually demanding activities. Common symptoms include
              tired eyes, headaches, blurred vision, dryness, sensitivity to
              light, and difficulty focusing.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get support for eye strain with Humancare Connect. Our
              ...
              healthcare services for symptom evaluation, eye health guidance,
              treatment recommendations, and personalized care planning.
              Telehealth services provide convenient access to an experienced
              online provider who can assess your symptoms, identify potential
              contributing factors, and recommend strategies to improve comfort
          ...
          <div>
            <h3 className="sp-block-title">
              Get Eye Strain care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Eye Strain care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=eeb&condition=Eye%20Strain")}>Start Consultation →</button>
