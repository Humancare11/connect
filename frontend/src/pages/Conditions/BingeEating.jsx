...
export default function BingeEating({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Binge eating involves consuming large amounts of food in
                        a short period of time, often accompanied by feelings of
                        loss of control, emotional distress, guilt, or
                        difficulty managing eating behaviors that can affect
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get compassionate support for binge eating with
                        ...
                        healthcare services for eating behavior assessments,
                        emotional wellness support, treatment guidance, and
                        personalized care recommendations. Telehealth services
                        provide convenient access to an experienced online
                        provider who can help identify contributing factors,
                        develop healthier coping strategies, and support your
