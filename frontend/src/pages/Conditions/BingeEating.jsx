    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Binge Eating?</h3>
            <p className="sp-block-body">
              Binge eating involves consuming large amounts of food in a short
              period of time, often accompanied by feelings of loss of control,
              emotional distress, guilt, or difficulty managing eating behaviors
              that can affect physical and emotional well being.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get compassionate support for binge eating with Humancare Connect.
              ...
              healthcare services for eating behavior assessments, emotional
              wellness support, treatment guidance, and personalized care
              recommendations. Telehealth services provide convenient access to
              an experienced online provider who can help identify contributing
              factors, develop healthier coping strategies, and support your
          ...
          <div>
            <h3 className="sp-block-title">
              Get Binge Eating care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Binge Eating care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Binge%20Eating")}>Start Consultation →</button>
