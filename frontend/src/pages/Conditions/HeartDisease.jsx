...
const pageData = {
  ...
  description: "Ongoing care after heart treatment",
...
// ─────────────────────────────────────────────────────────────────
export default function HeartDisease({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Heart disease follow-up care helps monitor symptoms like
                        chest discomfort, fatigue, shortness of breath,
                        irregular heartbeat, and blood pressure changes after a
                        heart-related condition or treatment.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Stay on top of your heart health with Humancare Connect.
                        ...
                        healthcare services, you can receive follow-up
                        evaluations, heart health guidance, treatment
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Continue your heart care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Heart Disease Follow-Up care",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=chronic&condition=Heart%20Disease%20Follow-Up",
                    )
                  }
                >
                  Book Appointment →
