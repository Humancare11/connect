        ...
        <div className="sp-glass-card">
            ...
            <div className="sp-about-grid">
                ...
                <div className="sp-about-right">
                    <div>
                        <h3 className="sp-block-title">What Is Heart Disease ?</h3>
                        <p className="sp-block-body">
                            Heart disease follow-up care helps monitor symptoms like chest discomfort, fatigue, shortness of breath, irregular heartbeat, and blood pressure changes after a heart-related condition or treatment.
                    ...
                    <div>
                        <h3 className="sp-block-title">Continue your heart care in 4 simple steps.</h3>
                        <div className="sp-benefits-grid">
                            {[
                                "Choose Heart Disease Follow-Up care", "Share your symptoms and medical history",
