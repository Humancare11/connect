    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What is a Medication Review?</h3>
            <p className="sp-block-body">
              Medication reviews can help with side effects, dosage questions,
              drug interactions, refill concerns, treatment effectiveness, and
              understanding how your medications may affect your overall health.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get personalized medication support with Humancare Connect. Our
              ...
              medication guidance, treatment recommendations, prescription
              support, and ongoing care without the need for an in-person clinic
              visit.
            </p>
          </div>
          ...
          <div>
            <h3 className="sp-block-title">
              Review medications in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Medication Review care",
                "Share your medications and health concerns",
                "Connect with an online provider",
                "Receive medication guidance and personalized care support",
              ].map((b) => (
