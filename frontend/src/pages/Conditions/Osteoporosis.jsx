...
// ─────────────────────────────────────────────────────────────────
export default function Osteoporosis({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Osteoporosis is a condition that causes bones to become
                        weaker and more fragile, increasing the risk of
                        fractures and injuries. It often develops gradually and
                        may not cause noticeable symptoms until a bone fracture
                        occurs.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get support for osteoporosis management with Humancare
                        ...
                        services for bone health assessments, symptom
                        ...
                        assess risk factors, discuss prevention and treatment
                        options, and support long term bone health and mobility.
                      </p>
                    </div>
