    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Osteoporosis?</h3>
            <p className="sp-block-body">
              Osteoporosis is a condition that causes bones to become weaker and
              more fragile, increasing the risk of fractures and injuries. It
              often develops gradually and may not cause noticeable symptoms
              until a bone fracture occurs.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get support for osteoporosis management with Humancare Connect.
              ...
              healthcare services for bone health assessments, symptom
              evaluation, treatment guidance, and personalized care
              recommendations. Telehealth services provide convenient access to
              an experienced online provider who can help assess risk factors,
              discuss prevention and treatment options, and support long term
          ...
          <div>
            <h3 className="sp-block-title">
              Get Osteoporosis care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Osteoporosis care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=chronic&condition=Osteoporosis")}>Start Consultation →</button>
