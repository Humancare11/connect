...
import ConditionBannerImage from "../../assets/ConditionImages/DigestiveCare/Travelers-Diarrhea.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Traveler’s Diarrhea?</h3>
            <p className="sp-block-body">
              Traveler’s diarrhea can cause loose stools, stomach cramps,
              nausea, bloating, dehydration, and digestive discomfort often
              triggered by contaminated food, water, or changes in diet while
              traveling.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get quick relief for traveler’s diarrhea symptoms with Humancare
              ...
              from anywhere. Through our secure virtual healthcare services, you
              can receive symptom evaluation, hydration guidance, treatment
              recommendations, and prescriptions when appropriate without
          ...
          <div>
            <h3 className="sp-block-title">
              Get travel digestive care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Traveler’s Diarrhea care",
  ...
  return (
    <div className="sp-sbc">
      ...
      <button
        ...
        onClick={() =>
          navigate(
            "/category-consultant?category=general&condition=Traveler%E2%80%99s%20Diarrhea",
          )
        }
      >
        Start Consultation →
