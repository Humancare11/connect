    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Hemorrhoids?</h3>
            <p className="sp-block-body">
              Hemorrhoids can cause itching, pain, swelling, irritation,
              bleeding, and discomfort around the rectal area often triggered by
              constipation, straining, pregnancy, or prolonged sitting.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get discreet care for hemorrhoid symptoms with Humancare Connect.
              Our telemedicine services make it easy to schedule an online
              doctor appointment and connect with a licensed provider from the
              privacy of home. Through our secure telemedicine platform, you can
              receive symptom evaluation, treatment guidance, lifestyle
              recommendations, and prescriptions when appropriate without the
              discomfort of an in-person visit.
            </p>
          </div>

          <div>
            <h3 className="sp-block-title">
              Get hemorrhoid relief in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Hemorrhoids care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Hemorrhoids")}>Start Consultation →</button>
