...
// ─────────────────────────────────────────────────────────────────
export default function JointPain({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Joint pain can cause stiffness, swelling, aching,
                        reduced mobility, tenderness, and discomfort that may
                        affect the knees, shoulders, hips, hands, back, or other
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get convenient joint pain care with Humancare Connect.
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=eeb&condition=Joint%20Pain",
                    )
                  }
                >
                  Book Appointment →
