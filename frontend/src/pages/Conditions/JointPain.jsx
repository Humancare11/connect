    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Joint Pain?</h3>
            <p className="sp-block-body">
              Joint pain can cause stiffness, swelling, aching, reduced
              mobility, tenderness, and discomfort that may affect the knees,
              shoulders, hips, hands, back, or other joints during daily
              activities.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get convenient joint pain care with Humancare Connect. Our
              ...
              hassle of an in-person clinic visit.
            </p>
          </div>
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=eeb&condition=Joint%20Pain")}>Start Consultation →</button>
