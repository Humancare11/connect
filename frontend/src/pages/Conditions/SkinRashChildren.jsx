...
import ConditionBannerImage from "../../assets/ConditionImages/PediatricCare/Skin-Rash-in-Children.webp";
...
export default function SkinRashChildren({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Skin rashes in children can cause redness, itching,
                        bumps, dryness, irritation, swelling, and discomfort
                        often linked to allergies, eczema, heat, infections, or
                        skin sensitivities.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get trusted pediatric skin care from home with Humancare
                        ...
                        services, you can receive symptom evaluation, skincare
                        guidance, treatment recommendations, and prescriptions
                        when appropriate without the hassle of an in-person
                        clinic visit.
                      </p>
                    </div>
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get skin rash care for your child in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Skin Rash in Children care",
                          "Upload photos and share your child’s symptoms",
            ...
            <aside>
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=family&condition=Skin%20Rash%20in%20Children",
                    )
                  }
                >
                  Book Appointment →
