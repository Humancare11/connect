    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What is Skin Rash in Children?</h3>
            <p className="sp-block-body">
              Skin rashes in children can cause redness, itching, bumps,
              dryness, irritation, swelling, and discomfort often linked to
              allergies, eczema, heat, infections, or skin sensitivities.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get trusted pediatric skin care from home with Humancare Connect.
