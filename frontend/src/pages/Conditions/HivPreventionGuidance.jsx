...
// ─────────────────────────────────────────────────────────────────
export default function HivPreventionGuidance({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        HIV prevention and PrEP guidance can help with questions
                        about HIV risk, preventive medications, sexual health
                        safety, exposure concerns, and ongoing protection
                        through pre-exposure prophylaxis (PrEP).
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get confidential HIV prevention support with Humancare
                        ...
                        telemedicine platform, you can receive sexual health
                        guidance, PrEP information, treatment recommendations,
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=sexual&condition=HIV%20Prevention%20%2F%20PrEP%20Guidance",
                    )
                  }
                >
                  Book Appointment →
