...
// ─────────────────────────────────────────────────────────────────
export default function VisionChanges({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        difficulty focusing, reduced visual clarity, sensitivity
                        to light, floaters, or other changes in eyesight that
                        may affect daily activities and overall quality of life.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get support for vision changes with Humancare Connect.
                        ...
                        symptom evaluation, eye health guidance, treatment
                        ...
                        symptoms, discuss possible causes, and recommend
                        appropriate next steps to support your vision and
                        overall eye health.
                      </p>
                    </div>
