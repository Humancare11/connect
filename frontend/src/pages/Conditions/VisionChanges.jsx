    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Are Vision Changes?</h3>
            <p className="sp-block-body">
              Vision changes can include blurry vision, double vision,
              difficulty focusing, reduced visual clarity, sensitivity to light,
              floaters, or other changes in eyesight that may affect daily
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get support for vision changes with Humancare Connect. Our
              ...
              online provider who can assess your symptoms, discuss possible
              causes, and recommend appropriate next steps to support your
          ...
          <div>
            <h3 className="sp-block-title">
              Get Vision Changes care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Vision Changes care",
