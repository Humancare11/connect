        ...
        <div className="sp-about-right">
          <div>
            ...
            <p className="sp-block-body">
              Partner exposure concerns can include questions about STI
              exposure, possible symptoms, sexual health risks, testing
              recommendations, prevention options, and next steps after intimate
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get confidential sexual health support with Humancare Connect. Our
              ...
              evaluation, exposure guidance, treatment recommendations, and
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=sexual&condition=Partner%20Exposure%20Concerns")}>Start Consultation →</button>
