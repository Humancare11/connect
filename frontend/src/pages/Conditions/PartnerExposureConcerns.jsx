...
import ConditionBannerImage from "../../assets/ConditionImages/SexualHealth/Partner-Exposure-Concerns.webp";
...
// ─────────────────────────────────────────────────────────────────
export default function PartnerExposureConcerns({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What are partner exposure concerns?
                      </h3>
                      <p className="condition-block-body">
                        Partner exposure concerns can include questions about
                        STI exposure, possible symptoms, sexual health risks,
                        testing recommendations, prevention options, and next
                        steps after intimate contact with a partner.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get confidential sexual health support with Humancare
                        ...
                        evaluation, exposure guidance, treatment
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get exposure guidance in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Partner Exposure Concerns care",
                          "Share your symptoms or exposure concerns",
                          "Connect with an online provider",
                          "Receive confidential guidance and personalized care support",
                        ].map((b) => (
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=sexual&condition=Partner%20Exposure%20Concerns",
                    )
                  }
                >
                  Book Appointment →
