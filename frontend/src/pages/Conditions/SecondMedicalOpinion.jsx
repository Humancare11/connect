        ...
        <div className="sp-about-right">
          <div>
            ...
            <p className="sp-block-body">
              ...
              diagnosis, treatment plan, medications, surgery recommendations,
              lab results, or ongoing health concerns before making important
              medical decisions.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get additional medical guidance with confidence through Humancare
              ...
              receive expert medical reviews, treatment guidance, personalized
              care recommendations, and follow-up support without the need for
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Second%20Medical%20Opinion")}>Start Consultation →</button>
