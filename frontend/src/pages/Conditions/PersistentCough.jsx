...
// ─────────────────────────────────────────────────────────────────
export default function PersistentCough({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        A persistent cough can cause throat irritation, chest
                        discomfort, mucus buildup, wheezing, interrupted sleep,
                        and breathing discomfort that may be linked to
                        allergies, asthma, bronchitis, infections, or other
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get ongoing care for persistent cough symptoms with
                        Humancare Connect. Our telemedicine services allow you
                        to schedule an online doctor appointment and connect
                        with a licensed provider from home. Through our secure
                        telemedicine platform, you can receive symptom
                        evaluation, treatment guidance, breathing care support,
                        and prescriptions when appropriate without the hassle of
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=Persistent%20Cough",
                    )
                  }
                >
                  Book Appointment →
