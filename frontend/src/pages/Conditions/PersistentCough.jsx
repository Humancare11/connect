...
import ConditionBannerImage from "../../assets/ConditionImages/RespiratoryHealth/Persistent-Cough.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What is Persistent Cough?</h3>
            <p className="sp-block-body">
              A persistent cough can cause throat irritation, chest discomfort,
              mucus buildup, wheezing, interrupted sleep, and breathing
              discomfort that may be linked to allergies, asthma, bronchitis,
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get ongoing care for persistent cough symptoms with Humancare
              Connect. Our telemedicine services allow you to schedule an online
              ...
              evaluation, treatment guidance, breathing care support, and
          ...
          <div>
            <h3 className="sp-block-title">
              Find relief from persistent cough in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Persistent Cough care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Persistent%20Cough")}>Start Consultation →</button>
