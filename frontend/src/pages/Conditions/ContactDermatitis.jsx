...
import ConditionBannerImage from "../../assets/ConditionImages/SkinCondition/Contact-Dermatitis.webp";
...
export default function ContactDermatitis({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Contact dermatitis can cause redness, itching, burning,
                        swelling, dryness, and skin irritation triggered by
                        soaps, fragrances, chemicals, plants, jewelry, or other
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get relief from contact dermatitis symptoms with
                        Humancare Connect. Our telemedicine services let you
                        book an online doctor appointment and connect with a
                        licensed provider from home. Through our secure
                        telemedicine platform, you can receive symptom
                        evaluation, skincare guidance, treatment
                        recommendations, and prescriptions when appropriate
                        without waiting for an in-person dermatology visit.
                      </p>
                    </div>
                    <div>
                      <h3 className="condition-block-title">
            ...
            <aside>
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=skin&condition=Contact%20Dermatitis",
                    )
                  }
                >
                  Book Appointment →
