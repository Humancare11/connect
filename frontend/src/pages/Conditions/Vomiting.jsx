    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Vomiting?</h3>
            <p className="sp-block-body">
              Vomiting can cause dehydration, stomach discomfort, weakness,
              nausea, dizziness, and digestive issues often linked to
              infections, food poisoning, migraines, medications, or stomach
              illnesses.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get fast care for vomiting symptoms with Humancare Connect. Our
              telemedicine services allow you to schedule an online doctor
  ...
  return (
    <div className="sp-sbc">
      ...
      <button
        ...
        onClick={() =>
          navigate("/category-consultant?category=general&condition=Vomiting")
        }
      >
        Start Consultation →
      </button>
