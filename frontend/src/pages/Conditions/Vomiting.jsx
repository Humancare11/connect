...
import ConditionBannerImage from "../../assets/ConditionImages/DigestiveCare/Vomiting.webp";
...
// ─────────────────────────────────────────────────────────────────
export default function Vomiting({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Vomiting can cause dehydration, stomach discomfort,
                        weakness, nausea, dizziness, and digestive issues often
                        linked to infections, food poisoning, migraines,
                        medications, or stomach illnesses.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get fast care for vomiting symptoms with Humancare
                        Connect. Our telemedicine services allow you to schedule
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get vomiting relief in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Vomiting care",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=Vomiting",
                    )
                  }
                >
                  Book Appointment →
