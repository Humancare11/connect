    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Numbness and Tingling?</h3>
            <p className="sp-block-body">
              Numbness and tingling can cause burning sensations, weakness,
              reduced feeling, “pins and needles,” or discomfort in the hands,
              feet, arms, legs, or other areas of the body that may be linked to
              nerve irritation, circulation issues, injuries, or underlying
              health conditions.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get convenient care for numbness and tingling symptoms with
              ...
              can receive symptom evaluation, treatment guidance, nerve health
          ...
          <div>
            <h3 className="sp-block-title">
              Get nerve symptom support in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Numbness and Tingling care",
