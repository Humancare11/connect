...
// ─────────────────────────────────────────────────────────────────
export default function EyeRedness({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Eye redness can cause irritation, burning, itching,
                        watering, swelling, discomfort, and bloodshot eyes often
                        linked to allergies, infections, dryness, irritation, or
                        eye strain.
                      </p>
                    </div>
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get eye care in 4 simple steps.
                      </h3>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=eeb&condition=Eye%20Redness",
                    )
                  }
                >
                  Book Appointment →
