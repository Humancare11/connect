    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Eye Redness?</h3>
            <p className="sp-block-body">
              Eye redness can cause irritation, burning, itching, watering,
              swelling, discomfort, and bloodshot eyes often linked to
              allergies, infections, dryness, irritation, or eye strain.
            </p>
          </div>
          ...
          <div>
            <h3 className="sp-block-title">Get eye care in 4 simple steps.</h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Eye Redness care",
