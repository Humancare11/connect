...
// ─────────────────────────────────────────────────────────────────
export default function UpperRespiratoryInfection({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        An upper respiratory infection can cause coughing,
                        congestion, sore throat, runny nose, fever, sinus
                        pressure, and fatigue often caused by viral infections
                        affecting the nose, throat, and airways.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get fast care for upper respiratory infection symptoms
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=Upper%20Respiratory%20Infection",
                    )
                  }
                >
                  Book Appointment →
