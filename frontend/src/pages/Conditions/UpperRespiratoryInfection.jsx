...
import ConditionBannerImage from "../../assets/ConditionImages/RespiratoryHealth/Upper-Respiratory-Infection.webp";
        ...
        <div className="sp-about-right">
          <div>
            ...
            <p className="sp-block-body">
              An upper respiratory infection can cause coughing, congestion,
              sore throat, runny nose, fever, sinus pressure, and fatigue often
              caused by viral infections affecting the nose, throat, and
              airways.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get fast care for upper respiratory infection symptoms with
              ...
              and prescriptions when appropriate without the need for an urgent
              care visit.
            </p>
          </div>
          ...
          <div>
            <h3 className="sp-block-title">
              Treat upper respiratory symptoms in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Upper Respiratory Infection care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Upper%20Respiratory%20Infection")}>Start Consultation →</button>
