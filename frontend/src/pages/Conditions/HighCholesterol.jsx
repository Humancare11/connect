...
const pageData = {
  ...
  description: "Elevated cholesterol affects heart health",
...
//
// NOTE: The 4-step heading below reads "Get Fatty Liver Follow-Up care in
// 4 simple steps." and its list items reference "Fatty Liver Follow-Up
// care" rather than "High Cholesterol" care. This mismatch already
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        stroke, poor circulation, chest discomfort, and other
                        cardiovascular conditions caused by excess cholesterol
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Manage high cholesterol with ongoing support through
                        ...
                        cholesterol management support, treatment guidance,
                        lifestyle recommendations, and prescriptions when
                        appropriate without frequent clinic visits.
                      </p>
                    </div>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=chronic&condition=High%20Cholesterol",
                    )
                  }
                >
                  Start Consultation →
