    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is High Cholesterol?</h3>
            <p className="sp-block-body">
              High cholesterol can increase the risk of heart disease, stroke, poor circulation, chest discomfort, and other cardiovascular conditions caused by excess cholesterol buildup in the blood.
          ...
          <div>
            ...
            <p className="sp-block-body">
              Manage high cholesterol with ongoing support through Humancare Connect. Our telemedicine services make it easy to schedule an online doctor appointment and connect with a licensed provider from home. Through our secure telemedicine platform, you can receive cholesterol management support, treatment guidance, lifestyle recommendations, and prescriptions when appropriate without frequent clinic visits.
            </p>
          </div>
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=chronic&condition=High%20Cholesterol")}>Start Consultation →</button>
