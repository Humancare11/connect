...
export default function SafeSexCounseling({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Safe sex counseling provides education and support on
                        sexual health, contraception, sexually transmitted
                        infection prevention, consent, and healthy relationship
                        practices. It can help individuals make informed
                        decisions that support their overall health and well
                        being.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get confidential sexual health guidance with Humancare
                        ...
                        services for sexual health education, contraception
                        discussions, STI prevention guidance, and personalized
                        care recommendations. Telehealth services provide
                        convenient access to an experienced online provider who
                        can answer your questions, address concerns, and help
                        you make informed choices about your sexual and
                        reproductive health.
                      </p>
                    </div>
            ...
            <aside>
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=sexual&condition=Safe%20Sex%20Counseling",
                    )
                  }
                >
                  Book Appointment →
