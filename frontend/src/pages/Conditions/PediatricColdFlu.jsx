...
import ConditionBannerImage from "../../assets/ConditionImages/PediatricCare/Pediatric-Cold-&-Flu.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What is Pediatric Cold & Flu?</h3>
            <p className="sp-block-body">
              Pediatric cold and flu symptoms can cause fever, cough,
              congestion, sore throat, body aches, fatigue, chills, and
              irritability often linked to common viral infections in children.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              ...
              secure telemedicine platform, you can receive symptom evaluation,
              fever management guidance, treatment recommendations, and
          ...
          <div>
            <h3 className="sp-block-title">
              Get cold and flu care for your child in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Pediatric Cold & Flu care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=family&condition=Pediatric%20Cold%20%26%20Flu")}>Start Consultation →</button>
