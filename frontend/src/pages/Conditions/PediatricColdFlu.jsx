...
// ─────────────────────────────────────────────────────────────────
export default function PediatricColdFlu({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What is Pediatric Cold & Flu?
                      </h3>
                      <p className="condition-block-body">
                        Pediatric cold and flu symptoms can cause fever, cough,
                        congestion, sore throat, body aches, fatigue, chills,
                        and irritability often linked to common viral infections
                        in children.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        platform, you can receive symptom evaluation, fever
                        management guidance, treatment recommendations, and
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=family&condition=Pediatric%20Cold%20%26%20Flu",
                    )
                  }
                >
                  Book Appointment →
