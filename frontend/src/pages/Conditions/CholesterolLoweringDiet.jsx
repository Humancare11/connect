        ...
        <div className="sp-about-right">
          <div>
            ...
            <p className="sp-block-body">
              A cholesterol lowering diet focuses on healthy eating habits that
              may help improve cholesterol levels, support heart health, and
              reduce the risk of cardiovascular disease. Dietary changes can
              play an important role in long term wellness and preventive care.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get personalized nutrition support with Humancare Connect. Our
              ...
              healthcare services for dietary assessments, heart health
              guidance, nutrition planning, and personalized care
              recommendations. Telehealth services provide convenient access to
              an experienced online provider who can help you make informed food
              choices, improve cholesterol management, and support your overall
              health goals.
            </p>
          </div>
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Cholesterol-Lowering%20Diet")}>Start Consultation →</button>
