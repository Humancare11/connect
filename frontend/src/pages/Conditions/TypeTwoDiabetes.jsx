    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Type 2 Diabetes?</h3>
            <p className="sp-block-body">
              Type 2 diabetes can cause increased thirst, frequent urination,
              fatigue, blurred vision, slow healing, and blood sugar imbalances
              that may affect long-term health if left unmanaged.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Manage Type 2 diabetes more confidently with Humancare Connect.
              ...
              Through our secure telemedicine platform, you can receive blood
              sugar management support, treatment guidance, lifestyle
          ...
          <div>
            <h3 className="sp-block-title">
              Manage diabetes care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Type 2 Diabetes care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=chronic&condition=Type%202%20Diabetes")}>Start Consultation →</button>
