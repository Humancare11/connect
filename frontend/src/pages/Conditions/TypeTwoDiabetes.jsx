                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Type 2 diabetes can cause increased thirst, frequent
                        urination, fatigue, blurred vision, slow healing, and
                        blood sugar imbalances that may affect long-term health
                        if left unmanaged.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Manage Type 2 diabetes more confidently with Humancare
                        ...
                        telemedicine platform, you can receive blood sugar
