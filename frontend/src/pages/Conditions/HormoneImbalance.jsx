...
//
// NOTE: The SEO title below begins with a stray "�" mojibake character
// and the SEO url has a pre-existing typo ("hormone-imblance" instead of
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Hormone imbalance can affect many aspects of health and
                        may cause symptoms such as fatigue, mood changes, weight
                        fluctuations, irregular periods, sleep disturbances, low
                        libido, hot flashes, or changes in energy levels
                        depending on the hormones involved.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get personalized support for hormone imbalance with
                        ...
                        healthcare services for symptom evaluation, hormone
                        health assessments, treatment guidance, and personalized
                        care recommendations. Telehealth services provide
                        convenient access to an experienced online provider who
                        can help identify potential hormonal concerns, discuss
                        available treatment options, and support your overall
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get Hormone Imbalance care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Hormone Imbalance care",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=chronic&condition=Hormone%20Imbalance",
                    )
                  }
                >
                  Start Consultation →
