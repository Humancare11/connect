        ...
        <div className="sp-glass-card">
            ...
            <div className="sp-about-grid">
                ...
                <div className="sp-about-right">
                    <div>
                        <h3 className="sp-block-title">What Is Hormone Imbalance?</h3>
                        <p className="sp-block-body">
                            Hormone imbalance can affect many aspects of health and may cause symptoms such as fatigue, mood changes, weight fluctuations, irregular periods, sleep disturbances, low libido, hot flashes, or changes in energy levels depending on the hormones involved.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="sp-block-body">
                            Get personalized support for hormone imbalance with Humancare Connect. Our telemedicine services make it easy to schedule an online doctor appointment and connect with a licensed provider from home. Through our secure telemedicine platform, you can access virtual healthcare services for symptom evaluation, hormone health assessments, treatment guidance, and personalized care recommendations. Telehealth services provide convenient access to an experienced online provider who can help identify potential hormonal concerns, discuss available treatment options, and support your overall health and well being.           
                         </p>
                    </div>

                    <div>
                        <h3 className="sp-block-title">Get Hormone Imbalance care in 4 simple steps.</h3>
                        <div className="sp-benefits-grid">
                            {[
                                "Choose Hormone Imbalance care", "Share your symptoms and concerns ",
  ...
  const navigate = useNavigate();
    ...
    return (
        <div className="sp-sbc">
            ...
            <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=chronic&condition=Hormone%20Imbalance")}>Start Consultation →</button>
