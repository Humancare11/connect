        ...
        <div className="sp-about-right">
          <div>
            ...
            <p className="sp-block-body">
              Hormone imbalance can affect many aspects of health and may cause
              symptoms such as fatigue, mood changes, weight fluctuations,
              irregular periods, sleep disturbances, low libido, hot flashes, or
              changes in energy levels depending on the hormones involved.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get personalized support for hormone imbalance with Humancare
              ...
              access virtual healthcare services for symptom evaluation, hormone
              health assessments, treatment guidance, and personalized care
              ...
              hormonal concerns, discuss available treatment options, and
