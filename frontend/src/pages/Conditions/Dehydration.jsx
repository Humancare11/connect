...
import ConditionBannerImage from "../../assets/ConditionImages/DigestiveCare/Dehydration.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Dehydration?</h3>
            <p className="sp-block-body">
              Dehydration can cause extreme thirst, dizziness, dry mouth,
              fatigue, headaches, weakness, dark urine, and lightheadedness
              caused by illness, vomiting, diarrhea, heat, or not drinking
              enough fluids.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get fast care for dehydration symptoms with Humancare Connect. Our
              ...
              symptom evaluation, hydration guidance, treatment recommendations,
              and prescriptions when appropriate without waiting at urgent care.
            </p>
          </div>

          <div>
            <h3 className="sp-block-title">
              Recover from dehydration in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Dehydration care",
                "Share your symptoms and health concerns",
                "Connect with an online provider",
                "Receive hydration guidance and personalized care recommendations",
              ].map((b) => (
  ...
  return (
    <div className="sp-sbc">
      ...
      <button
        ...
        onClick={() =>
          navigate(
            "/category-consultant?category=general&condition=Dehydration",
          )
        }
      >
        Start Consultation →
