...
export default function Dehydration({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Dehydration can cause extreme thirst, dizziness, dry
                        mouth, fatigue, headaches, weakness, dark urine, and
                        lightheadedness caused by illness, vomiting, diarrhea,
                        heat, or not drinking enough fluids.
                      </p>
                    </div>
                    <div>
                      <h3 className="condition-block-title">How?</h3>
                      <p className="condition-block-body">
                        Get fast care for dehydration symptoms with Humancare
