...
import ConditionBannerImage from "../../assets/ConditionImages/DigestiveCare/Weight-Loss-Planning.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Weight-Loss Planning?</h3>
            <p className="sp-block-body">
              Weight loss planning focuses on creating realistic and sustainable
              approaches to achieving a healthier weight through nutrition,
              physical activity, lifestyle changes, and personalized health
              recommendations based on individual goals and needs.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Start your weight loss journey with Humancare Connect. Our
              ...
              healthcare services for weight management assessments, nutrition
              guidance, lifestyle planning, and personalized care
              recommendations. Telehealth services provide convenient access to
              an experienced online provider who can help you develop a
              customized weight loss plan, track progress, and support your long
          ...
          <div>
            <h3 className="sp-block-title">
              Get Weight-Loss Planning care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Weight-Loss Planning care",
                "Share your health history, concerns, and weight loss goals",
  ...
  return (
    <div className="sp-sbc">
      ...
      <button
        ...
        onClick={() =>
          navigate(
            "/category-consultant?category=general&condition=Weight-Loss%20Planning",
          )
        }
      >
        Start Consultation →
