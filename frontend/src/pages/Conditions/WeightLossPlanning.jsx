...
// ─────────────────────────────────────────────────────────────────
export default function WeightLossPlanning({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Weight loss planning focuses on creating realistic and
                        sustainable approaches to achieving a healthier weight
                        through nutrition, physical activity, lifestyle changes,
                        and personalized health recommendations based on
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Start your weight loss journey with Humancare Connect.
                        ...
                        weight management assessments, nutrition guidance,
                        lifestyle planning, and personalized care
                        recommendations. Telehealth services provide convenient
                        access to an experienced online provider who can help
                        you develop a customized weight loss plan, track
                        progress, and support your long term health and wellness
                        goals.
                      </p>
                    </div>
