...
// ─────────────────────────────────────────────────────────────────
export default function NeckPain({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        headaches, reduced movement, and discomfort that may
                        result from poor posture, muscle strain, stress,
                        injuries, or long hours of screen use.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get convenient neck pain care with Humancare Connect.
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=eeb&condition=Neck%20Pain",
                    )
                  }
                >
                  Book Appointment →
