    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Neck Pain?</h3>
            <p className="sp-block-body">
              Neck pain can cause stiffness, muscle tension, soreness,
              headaches, reduced movement, and discomfort that may result from
              poor posture, muscle strain, stress, injuries, or long hours of
              screen use.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get convenient neck pain care with Humancare Connect. Our
          ...
          <div>
            <h3 className="sp-block-title">
              Relieve neck pain in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Neck Pain care",
