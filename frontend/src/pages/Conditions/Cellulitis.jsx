                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Cellulitis can cause redness, swelling, warmth,
                        tenderness, pain, and skin inflammation that may spread
                        quickly if left untreated. It commonly affects the legs,
                        arms, or other areas of the skin.
                      </p>
                    </div>
                    <div>
                      <h3 className="condition-block-title">How?</h3>
                      <p className="condition-block-body">
                        Get prompt care for cellulitis symptoms with Humancare
                        ...
                        without waiting for an urgent care visit.
                      </p>
                    </div>
                    <div>
                      <h3 className="condition-block-title">
            ...
            <aside>
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=skin&condition=Cellulitis",
                    )
                  }
                >
                  Start Consultation →
