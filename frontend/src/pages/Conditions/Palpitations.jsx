    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Palpitations?</h3>
            <p className="sp-block-body">
              Palpitations are sensations of a racing, pounding, fluttering, or
              irregular heartbeat that may occur occasionally or more
              frequently. They can be associated with stress, anxiety, caffeine
              intake, medications, hormonal changes, or underlying health
              conditions.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get support for palpitations with Humancare Connect. Our
              ...
              healthcare services for symptom evaluation, health assessments,
              treatment guidance, and personalized care recommendations.
              Telehealth services provide convenient access to an experienced
              online provider who can review your symptoms, discuss possible
              causes, and recommend appropriate next steps to support your heart
          ...
          <div>
            <h3 className="sp-block-title">
              Get Palpitations care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Palpitations care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=chronic&condition=Palpitations")}>Start Consultation →</button>
