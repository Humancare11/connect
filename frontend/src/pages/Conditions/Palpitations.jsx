...
// ─────────────────────────────────────────────────────────────────
export default function Palpitations({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Palpitations are sensations of a racing, pounding,
                        fluttering, or irregular heartbeat that may occur
                        occasionally or more frequently. They can be associated
                        with stress, anxiety, caffeine intake, medications,
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        evaluation, health assessments, treatment guidance, and
                        personalized care recommendations. Telehealth services
                        provide convenient access to an experienced online
                        provider who can review your symptoms, discuss possible
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=chronic&condition=Palpitations",
                    )
                  }
                >
                  Book Appointment →
