...
export default function PubertyConcerns({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What are Puberty Concerns?
                      </h3>
                      <p className="condition-block-body">
                        Puberty concerns can include questions about physical
                        development, growth patterns, hormonal changes,
                        menstrual cycles, emotional changes, delayed puberty,
                        early puberty, or other concerns related to adolescent
                        development.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get trusted support for puberty concerns with Humancare
                        ...
                        services for developmental guidance, symptom evaluation,
                        hormone related health concerns, and personalized care
                        recommendations. Telehealth services provide convenient
                        access to an experienced online provider who can answer
                        questions, address concerns, and help support healthy
                        physical and emotional development during puberty.
                      </p>
                    </div>
            ...
            <aside>
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=family&condition=Puberty%20Concerns",
                    )
                  }
                >
                  Book Appointment →
