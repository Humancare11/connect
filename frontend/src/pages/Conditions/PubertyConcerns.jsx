...
import ConditionBannerImage from "../../assets/ConditionImages/PediatricCare/Puberty-Concerns-in-teens.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What are Puberty Concerns?</h3>
            <p className="sp-block-body">
              Puberty concerns can include questions about physical development,
              growth patterns, hormonal changes, menstrual cycles, emotional
              changes, delayed puberty, early puberty, or other concerns related
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get trusted support for puberty concerns with Humancare Connect.
              ...
              healthcare services for developmental guidance, symptom
              evaluation, hormone related health concerns, and personalized care
              recommendations. Telehealth services provide convenient access to
              an experienced online provider who can answer questions, address
              concerns, and help support healthy physical and emotional
          ...
          <div>
            <h3 className="sp-block-title">
              Get Puberty Concerns care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Puberty Concerns care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=family&condition=Puberty%20Concerns")}>Start Consultation →</button>
