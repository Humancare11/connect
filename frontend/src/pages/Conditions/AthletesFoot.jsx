    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What is Athlete’s Foot?</h3>
            <p className="sp-block-body">
              Athlete’s foot can cause itching, burning, peeling skin, redness,
              cracking, and discomfort usually affecting the feet and toes due
              to a contagious fungal infection.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Treat athlete’s foot quickly and conveniently with Humancare
              Connect. Our telemedicine services allow you to book an online
              ...
              evaluation, treatment recommendations, skincare guidance, and
          ...
          <div>
            <h3 className="sp-block-title">
              Get athlete’s foot treatment in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Athlete’s Foot care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=skin&condition=Athlete%E2%80%99s%20Foot")}>Start Consultation →</button>
