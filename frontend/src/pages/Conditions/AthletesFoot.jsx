...
export default function AthletesFoot({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Athlete’s foot can cause itching, burning, peeling skin,
                        redness, cracking, and discomfort usually affecting the
                        feet and toes due to a contagious fungal infection.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Treat athlete’s foot quickly and conveniently with
                        ...
                        evaluation, treatment recommendations, skincare
            ...
            <aside>
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=skin&condition=Athlete%E2%80%99s%20Foot",
                    )
                  }
                >
                  Book Appointment →
