...
import ConditionBannerImage from "../../assets/ConditionImages/ChronicCare/Tremor.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Tremor?</h3>
            <p className="sp-block-body">
              A tremor is an involuntary shaking or rhythmic movement that can
              affect the hands, arms, head, legs, or other parts of the body.
              Tremors may occur occasionally or persist over time and can
              interfere with daily activities such as writing, eating, or using
              tools.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get support for tremor symptoms with Humancare Connect. Our
              ...
              healthcare services for symptom evaluation, neurological health
              assessments, treatment guidance, and personalized care
              ...
              causes of tremors, review your symptoms, and recommend appropriate
          ...
          <div>
            <h3 className="sp-block-title">
              Get Tremor care in 4 simple steps.
            </h3>
  ...
  return (
    <div className="sp-sbc">
      ...
      <button
        ...
        onClick={() =>
          navigate("/category-consultant?category=chronic&condition=Tremor")
        }
      >
        Start Consultation →
      </button>
