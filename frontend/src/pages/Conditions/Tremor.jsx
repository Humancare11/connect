...
// ─────────────────────────────────────────────────────────────────
export default function Tremor({ categoryId } = {}) {
              ...
              <div className="condition-glass-card">
                ...
                <div className="condition-about-grid">
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">What Is Tremor?</h3>
                      <p className="condition-block-body">
                        A tremor is an involuntary shaking or rhythmic movement
                        that can affect the hands, arms, head, legs, or other
                        parts of the body. Tremors may occur occasionally or
                        persist over time and can interfere with daily
                        activities such as writing, eating, or using tools.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get support for tremor symptoms with Humancare Connect.
                        ...
                        symptom evaluation, neurological health assessments,
                        treatment guidance, and personalized care
                        recommendations. Telehealth services provide convenient
                        access to an experienced online provider who can help
                        identify potential causes of tremors, review your
                        symptoms, and recommend appropriate next steps for
                        ongoing care.
                      </p>
                    </div>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=chronic&condition=Tremor",
                    )
                  }
                >
                  Book Appointment →
