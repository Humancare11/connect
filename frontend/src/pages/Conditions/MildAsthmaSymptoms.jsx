...
// ─────────────────────────────────────────────────────────────────
export default function MildAsthmaSymptoms({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        tightness, shortness of breath, and breathing discomfort
                        triggered by allergies, exercise, weather changes, or
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get convenient asthma care from home with Humancare
                        ...
                        platform, you can receive symptom evaluation, breathing
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=family&condition=Mild%20Asthma%20Symptoms",
                    )
                  }
                >
                  Book Appointment →
