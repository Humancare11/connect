    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Are Mild Asthma Symptoms?</h3>
            <p className="sp-block-body">
              Mild asthma symptoms can cause wheezing, coughing, chest
              tightness, shortness of breath, and breathing discomfort triggered
              by allergies, exercise, weather changes, or respiratory
              infections.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get convenient asthma care from home with Humancare Connect. Our
              ...
              breathing care guidance, treatment recommendations, and
              prescriptions when appropriate without the need for an urgent care
              visit.
            </p>
          </div>
          ...
          <div>
            <h3 className="sp-block-title">
              Manage mild asthma symptoms in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Mild Asthma Symptoms care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=family&condition=Mild%20Asthma%20Symptoms")}>Start Consultation →</button>
