...
import ConditionBannerImage from "../../assets/ConditionImages/SexualHealth/STI-Consultation.webp";
...
// ─────────────────────────────────────────────────────────────────
export default function StiConsultation({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        STI concerns can include unusual discharge, burning
                        during urination, itching, sores, irritation, exposure
                        concerns, or questions about sexually transmitted
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get fast and confidential STI care with Humancare
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=sexual&condition=STI%20Consultation",
                    )
                  }
                >
                  Book Appointment →
