        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    ...
                    <p className="condition-block-body">
                      Dizziness can cause lightheadedness, spinning sensations,
                      balance issues, nausea, weakness, or feeling faint and may
                      be linked to inner ear conditions, dehydration,
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Dizziness")}>
                Start Consultation →
              </button>
