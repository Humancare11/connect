...
import ConditionBannerImage from "../../../assets/ConditionImages/UrgentCare/Dizziness.webp";
...
const pageData = {
  badge: "Urgent Care",
  heading: "Dizziness",
  description: "Lightheadedness and balance problems",
...
// ─────────────────────────────────────────────────────────────────
export default function Dizziness({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Dizziness can cause lightheadedness, spinning
                        sensations, balance issues, nausea, weakness, or feeling
                        faint and may be linked to inner ear conditions,
                        dehydration, infections, or other health concerns.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get care for dizziness symptoms with Humancare Connect
                        from the comfort of home. Our telemedicine services make
                        it easy to schedule an online doctor appointment and
                        connect with a licensed provider for symptom evaluation,
                        treatment guidance, and personalized care through our
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get dizziness care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose dizziness care",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=Dizziness",
                    )
                  }
                >
                  Book Appointment →
