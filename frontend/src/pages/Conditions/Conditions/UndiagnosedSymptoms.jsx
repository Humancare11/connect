...
// ─────────────────────────────────────────────────────────────────
export default function UndiagnosedSymptoms() {
          ...
          <div className="condition-page-layout">
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What are Undiagnosed Symptoms?
                      </h3>
                      <p className="condition-block-body">
                        Undiagnosed symptoms can include persistent pain, fatigue,
                        dizziness, digestive issues, skin changes, or other health
                        concerns that have not yet been linked to a specific
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get guidance for undiagnosed symptoms with Humancare
                        ...
                        services for symptom assessment, medical guidance, and
                        recommendations for appropriate next steps. Telehealth
                        services allow an experienced online provider to review
                        your concerns, help identify possible causes, and create a
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get Undiagnosed Symptoms care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Undiagnosed Symptoms care",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Undiagnosed%20Symptoms")}>
                  Start Consultation →
                </button>
