...
// ─────────────────────────────────────────────────────────────────
export default function UndiagnosedSymptoms({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Undiagnosed symptoms can include persistent pain,
                        fatigue, dizziness, digestive issues, skin changes, or
                        other health concerns that have not yet been linked to a
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        your concerns, help identify possible causes, and create
                        a personalized care plan without the need for an in
                        person visit.
                      </p>
                    </div>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=Undiagnosed%20Symptoms",
                    )
                  }
                >
                  Book Appointment →
