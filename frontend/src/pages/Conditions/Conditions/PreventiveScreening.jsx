        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      ...
                      evaluations, preventive care recommendations, and guidance
                      on appropriate screenings based on your age, medical
                      history, and lifestyle. Telehealth services provide
                      convenient access to an experienced online provider who
                      can help you stay proactive about your long term health
                      and wellness.
                    </p>
                  </div>
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Preventive%20Screening")}>
                Start Consultation →
              </button>
