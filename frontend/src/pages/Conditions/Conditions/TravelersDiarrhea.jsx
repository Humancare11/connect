        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    ...
                    <p className="condition-block-body">
                      Traveler’s diarrhea can cause loose stools, stomach
                      cramps, nausea, bloating, dehydration, and digestive
                      discomfort often triggered by contaminated food, water, or
                      sudden dietary changes while traveling.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get quick digestive care wherever you are with Humancare
                      Connect. Our telemedicine services make it easy to
                      schedule an online doctor appointment and connect with a
                      licensed provider from home or while traveling. Through
                      ...
                      without searching for urgent care on the go.
                    </p>
                  </div>

                  <div>
                    <h3 className="condition-block-title">
                      Get travel digestive support in 4 simple steps.
                    </h3>
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=travel&condition=Travelers%27%20Diarrhea")}>
                Start Consultation →
              </button>
