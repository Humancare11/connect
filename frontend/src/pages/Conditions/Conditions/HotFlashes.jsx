...
import ConditionBannerImage from "../../../assets/ConditionImages/WomensHealth/hot-flashes.webp";
...
const pageData = {
  ...
  heading: "Hot Flashes",
  description: "Relief from sudden heat episodes",
...
// ─────────────────────────────────────────────────────────────────
export default function HotFlashes() {
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    ...
                    <p className="condition-block-body">
                      Hot flashes are sudden feelings of warmth that often
                      affect the face, neck, and chest and may be accompanied by
                      sweating, flushing, chills, or discomfort. They are
                      commonly associated with hormonal changes, including
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get support for hot flashes with Humancare Connect. Our
                      ...
                      evaluation, hormone related health concerns, treatment
                      guidance, and personalized care recommendations.
                      Telehealth services provide convenient access to an
                      experienced online provider who can help identify possible
                      causes of hot flashes and recommend appropriate strategies
                  ...
                  <div>
                    <h3 className="condition-block-title">
                      Get Hot Flashes care in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose Hot Flashes care",
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=women&condition=Hot%20Flashes")}>
                Start Consultation →
              </button>
