...
// ─────────────────────────────────────────────────────────────────
export default function HrtGuidance({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        individuals understand treatment options, manage
                        symptoms related to hormonal changes, and make informed
                        decisions about their reproductive and overall health.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        healthcare services for hormone health discussions,
                        treatment evaluations, symptom management, and
                        personalized care recommendations. Telehealth services
                        provide convenient access to an experienced online
                        provider who can answer your questions, review your
                        health history, and help determine whether HRT may be
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=women&condition=HRT%20Guidance",
                    )
                  }
                >
                  Book Appointment →
