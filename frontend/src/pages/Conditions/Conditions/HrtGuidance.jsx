...
import ConditionBannerImage from "../../../assets/ConditionImages/WomensHealth/hrt-guidance.webp";
...
const pageData = {
  ...
  heading: "HRT Guidance",
  description: "Personalized support for hormone therapy",
...
// ─────────────────────────────────────────────────────────────────
export default function HrtGuidance() {
          ...
          <div className="condition-page-layout">
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What is HRT guidance?
                      </h3>
                      <p className="condition-block-body">
                        Hormone replacement therapy (HRT) guidance can help
                        individuals understand treatment options, manage symptoms
                        related to hormonal changes, and make informed decisions
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get expert guidance for hormone replacement therapy with
                        ...
                        services for hormone health discussions, treatment
                        evaluations, symptom management, and personalized care
                        recommendations. Telehealth services provide convenient
                        access to an experienced online provider who can answer
                        your questions, review your health history, and help
                        determine whether HRT may be appropriate for your
                        individual needs.
                      </p>
                    </div>
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get HRT Guidance care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose HRT Guidance care",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=women&condition=HRT%20Guidance")}>
                  Start Consultation →
                </button>
