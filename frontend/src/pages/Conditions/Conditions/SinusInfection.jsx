...
// ─────────────────────────────────────────────────────────────────
export default function SinusInfection({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Sinus infections can cause facial pressure, congestion,
                        headaches, thick mucus, cough, sore throat, and pain
                        around the nose and eyes often caused by viral or
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get sinus infection care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Sinus Infection care",
