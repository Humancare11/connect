...
const pageData = {
  ...
  heading: "Burnout",
  description: "Emotional, mental, and physical exhaustion",
...
// ─────────────────────────────────────────────────────────────────
export default function AdhdEvaluation({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Burnout can cause chronic stress, exhaustion, lack of
                        motivation, difficulty concentrating, irritability,
                        sleep problems, and emotional fatigue that may affect
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get support for burnout symptoms with Humancare Connect.
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Recover from burnout in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose burnout support",
                          "Share your symptoms and stress concerns",
                          "Connect with an online provider",
                          "Receive personalized support and care recommendations",
                        ].map((b) => (
          ...
          <div className="condition-container">
            <div className="condition-faq-layout">
              ...
              <div className="condition-faq-sidebar">
                ...
                <div className="condition-faq-stat">🌍 Available Globally</div>
              </div>
