                                    ...
                                    <div className="condition-about-right">
                                        <div>
                                            ...
                                            <p className="condition-block-body">
                                                Burnout can cause chronic stress, exhaustion, lack of motivation, difficulty concentrating, irritability, sleep problems, and emotional fatigue that may affect work, relationships, and overall well-being.
