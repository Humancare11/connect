...
// ─────────────────────────────────────────────────────────────────
export default function AngerManagement({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Anger is a natural emotion, but frequent, intense, or
                        difficult to manage anger can affect relationships, work
                        performance, and overall emotional well being. Learning
                        effective coping strategies can help improve emotional
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get support for anger management with Humancare Connect.
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get Anger Management care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Anger Management care",
