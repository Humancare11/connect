...
const pageData = {
  ...
  description: "Common vaginal bacterial imbalance",
...
// ─────────────────────────────────────────────────────────────────
export default function BacterialVaginosis() {
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    ...
                    <p className="condition-block-body">
                      Bacterial vaginosis can cause unusual vaginal discharge,
                      odor, irritation, itching, and discomfort caused by an
                      imbalance of natural bacteria in the vaginal area.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get fast and discreet care for bacterial vaginosis
                  ...
                  <div>
                    <h3 className="condition-block-title">
                      Get bacterial vaginosis care in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose Bacterial Vaginosis care",
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=women&condition=Bacterial%20Vaginosis")}>
                Start Consultation →
              </button>
