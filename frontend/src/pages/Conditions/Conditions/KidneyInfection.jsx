...
const pageData = {
  ...
  heading: "Kidney Infection",
  description: "Serious urinary infection affecting kidneys",
...
// ─────────────────────────────────────────────────────────────────
export default function KidneyInfection() {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        A kidney infection can cause fever, chills, back or side
                        pain, nausea, vomiting, fatigue, and painful urination
                        caused by a bacterial infection that may spread from the
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get prompt care for kidney infection symptoms with
                        ...
                        appropriate without the stress of waiting at urgent
                        care.
                      </p>
                    </div>
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get kidney infection care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Kidney Infection care",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=Kidney%20Infection",
                    )
                  }
                >
                  Start Consultation →
