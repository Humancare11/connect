...
// ─────────────────────────────────────────────────────────────────
export default function SoreThroat({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        care, and prescriptions when appropriate without
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get care for your sore throat symptoms in 4 simple
                        steps.
                      </h3>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=Sore%20Throat",
                    )
                  }
                >
                  Book Appointment →
