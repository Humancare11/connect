...
const pageData = {
  badge: "Urgent Care",
  heading: "Sore Throat",
  description: "Pain, irritation, or a scratchy throat",
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    ...
                    <p className="condition-block-body">
                      A sore throat can make it painful to swallow, talk, or
                      eat, and is often caused by viral infections, allergies,
                      or irritation.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get fast relief for sore throat symptoms with Humancare
                      ...
                      care, and prescriptions when appropriate without visiting
                      urgent care.
                    </p>
                  </div>
                  ...
                  <div>
                    <h3 className="condition-block-title">
                      Get care for your sore throat symptoms in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose Sore Throat care",
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Sore%20Throat")}>
                Start Consultation →
              </button>
