        ...
        <div className="condition-page-layout">
            ...
            <div className="condition-glass-card">
              ...
              <div className="condition-about-grid">
                ...
                <div className="condition-about-right">
                  <div>
                    <h3 className="condition-block-title">What is Shingles?</h3>
                    <p className="condition-block-body">
                      Shingles can cause a painful rash, burning sensations,
                      itching, tingling, and fluid-filled blisters triggered by
                      reactivation of the chickenpox virus. Symptoms often
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      ...
                      comfort of home. Our telemedicine services make it easy to
                      schedule an online doctor appointment and connect with a
                      licensed provider quickly. Through our secure virtual
                      healthcare services, you can receive symptom evaluation,
                      treatment guidance, pain management support, and
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=skin&condition=Shingles")}>
                Start Consultation →
              </button>
