...
const pageData = {
  ...
  heading: "Shingles",
  description: "Painful rash with skin blisters",
...
// ─────────────────────────────────────────────────────────────────
export default function Shingles({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Shingles can cause a painful rash, burning sensations,
                        itching, tingling, and fluid-filled blisters triggered
                        by reactivation of the chickenpox virus. Symptoms often
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get timely shingles care with Humancare Connect from the
                        comfort of home. Our telemedicine services make it easy
                        to schedule an online doctor appointment and connect
                        with a licensed provider quickly. Through our secure
                        virtual healthcare services, you can receive symptom
                        evaluation, treatment guidance, pain management support,
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Manage shingles symptoms in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Shingles care",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=skin&condition=Shingles",
                    )
                  }
                >
                  Book Appointment →
