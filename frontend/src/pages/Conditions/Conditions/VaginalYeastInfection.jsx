...
const pageData = {
  ...
  heading: "Vaginal Yeast Infection",
  description: "Itching, irritation, and vaginal discomfort",
...
// ─────────────────────────────────────────────────────────────────
export default function VaginalYeastInfection({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        A vaginal yeast infection can cause itching, burning,
                        irritation, redness, unusual discharge, and discomfort
                        caused by an overgrowth of yeast in the vaginal area.
                      </p>
                    </div>
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get yeast infection treatment in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Vaginal Yeast Infection care",
