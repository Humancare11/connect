...
// ─────────────────────────────────────────────────────────────────
export default function IrregularPeriods({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Irregular periods can cause missed cycles, unusually
                        heavy or light bleeding, cramping, hormonal changes,
                        mood swings, and changes in menstrual timing that may be
                        linked to stress, hormones, birth control, or underlying
                        health conditions.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get personalized care for irregular periods with
                        ...
                        hormone health guidance, symptom evaluation, treatment
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=women&condition=Irregular%20Periods",
                    )
                  }
                >
                  Book Appointment →
