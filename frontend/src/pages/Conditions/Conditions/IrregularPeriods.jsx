...
import ConditionBannerImage from "../../../assets/ConditionImages/WomensHealth/irregular-periods.webp";
...
const pageData = {
  ...
  description: "Unpredictable or missed menstrual cycles",
...
// ─────────────────────────────────────────────────────────────────
export default function IrregularPeriods() {
          ...
          <div className="condition-page-layout">
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Irregular periods can cause missed cycles, unusually heavy
                        or light bleeding, cramping, hormonal changes, mood
                        swings, and changes in menstrual timing that may be linked
                        to stress, hormones, birth control, or underlying health
                        conditions.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get personalized care for irregular periods with Humancare
                        ...
                        healthcare services, you can receive hormone health
                        guidance, symptom evaluation, treatment recommendations,
                        and prescriptions when appropriate without the need for an
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get period care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Irregular Periods care",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=women&condition=Irregular%20Periods")}>
                  Start Consultation →
                </button>
