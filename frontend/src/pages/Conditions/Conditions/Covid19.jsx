...
import ConditionBannerImage from "../../../assets/ConditionImages/UrgentCare/COVID-19.webp";
...
const pageData = {
  badge: "Urgent Care",
  heading: "Covid-19",
  description: "Contagious viral respiratory illness",
          ...
          <div className="condition-page-layout">
              ...
              <div className="condition-glass-card">
                ...
                <div className="condition-about-grid">
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">What is Covid-19?</h3>
                      <p className="condition-block-body">
                        COVID-19 can cause fever, cough, fatigue, sore throat,
                        congestion, shortness of breath, body aches, and other
                        flu-like symptoms that range from mild to severe.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get trusted care for COVID-19 symptoms with Humancare
                        Connect. Our telemedicine services allow you to book an
                        ...
                        guidance, recovery support, and prescriptions when
                        appropriate without exposing others at urgent care or
                        clinics.
                      </p>
                    </div>
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get COVID-19 care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose COVID-19 care",
                          "Share your symptoms and recent exposure",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Covid-19")}>
                  Start Consultation →
                </button>
