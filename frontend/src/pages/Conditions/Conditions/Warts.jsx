...
// ─────────────────────────────────────────────────────────────────
export default function Warts({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        infection and can appear on the hands, feet, face, or
                        other areas of the body. They may feel rough,
                        uncomfortable, or spread over time if left untreated.
                      </p>
                    </div>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=skin&condition=Warts",
                    )
                  }
                >
                  Book Appointment →
