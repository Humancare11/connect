        ...
        <div className="condition-page-layout">
            ...
            <div className="condition-glass-card">
              ...
              <div className="condition-about-grid">
                ...
                <div className="condition-about-right">
                  <div>
                    <h3 className="condition-block-title">What is warts?</h3>
                    <p className="condition-block-body">
                      Warts are common skin growths caused by a viral infection
                      and can appear on the hands, feet, face, or other areas of
                      the body. They may feel rough, uncomfortable, or spread
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Humancare Connect makes wart treatment simple and
                      convenient. With our telemedicine services, you can
                      connect with a licensed provider through a secure online
                      doctor appointment from the comfort of home. Get expert
                      skin evaluations, personalized treatment options, and
                      prescriptions when appropriate using our trusted virtual
                      healthcare services.
                    </p>
                  </div>
                  ...
                  <div>
                    <h3 className="condition-block-title">
                      Remove wart concerns in 4 easy steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        ...
                        "Receive treatment options and care recommendations",
                      ].map((b) => (
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=skin&condition=Warts")}>
                Start Consultation →
              </button>
