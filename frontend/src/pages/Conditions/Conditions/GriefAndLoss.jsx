...
// ─────────────────────────────────────────────────────────────────
export default function GriefAndLoss({ categoryId } = {}) {
                ...
                <div className="condition-about-grid">
                  ...
                  <div className="condition-about-right">
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get compassionate emotional support through Humancare
                        ...
                        support, grief counseling guidance, treatment
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get grief support in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Grief and Loss care",
                          "Share your emotional concerns and symptoms",
                          "Connect with an online provider",
                          "Receive personalized support and care guidance",
                        ].map((b) => (
