...
import ConditionBannerImage from "../../../assets/ConditionImages/TravelHealth/Fitness-to-Travel-Evaluation.webp";
...
const pageData = {
  badge: "Travel Health",
  heading: "Fitness-to-Travel Evaluation",
  description: "Medical clearance and travel readiness",
...
// ─────────────────────────────────────────────────────────────────
export default function FitnessTravelEvaluation() {
          ...
          <div className="condition-page-layout">
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What is Fitness-to-Travel Evaluation?
                      </h3>
                      <p className="condition-block-body">
                        Fitness-to-travel evaluations can help assess symptoms,
                        medical conditions, recent illnesses, pregnancy concerns,
                        medication needs, or overall health readiness before
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Travel with confidence through Humancare Connect. Our
                        ...
                        can receive travel health evaluations, medical guidance,
                        treatment recommendations, and documentation support when
                        appropriate without the need for an in-person clinic
                        visit.
                      </p>
                    </div>
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get travel clearance in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Fitness-to-Travel Evaluation",
                          "Share your health history and travel concerns",
                          "Connect with an online provider",
                          "Receive medical guidance and travel support",
                        ].map((b) => (
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=travel&condition=Fitness-to-Travel%20Evaluation")}>
                  Start Consultation →
                </button>
