...
// ─────────────────────────────────────────────────────────────────
export default function FitnessTravelEvaluation({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        medical conditions, recent illnesses, pregnancy
                        concerns, medication needs, or overall health readiness
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        treatment recommendations, and documentation support
                        when appropriate without the need for an in-person
                        clinic visit.
                      </p>
                    </div>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=travel&condition=Fitness-to-Travel%20Evaluation",
                    )
                  }
                >
                  Book Appointment →
