        ...
        <div className="condition-page-layout">
              ...
              <div className="condition-about-grid">
                ...
                <div className="condition-about-right">
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get discreet and convenient care for erectile dysfunction
                      ...
                      treatment guidance, personalized care recommendations, and
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=men&condition=Erectile%20Dysfunction")}>
                Start Consultation →
              </button>
