...
import ConditionBannerImage from "../../../assets/ConditionImages/MensHealth/Erectile-Dysfunction.webp";
...
const pageData = {
  ...
  description: "Difficulty getting or maintaining erections",
...
// ─────────────────────────────────────────────────────────────────
export default function ErectileDysfunction({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Erectile dysfunction can cause difficulty achieving or
                        maintaining an erection, reduced sexual performance, low
                        confidence, stress, and intimacy concerns that may be
                        linked to circulation, hormones, stress, or other health
                        conditions.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get discreet and convenient care for erectile
                        dysfunction with Humancare Connect. Our telemedicine
                        ...
                        receive symptom evaluation, treatment guidance,
                        personalized care recommendations, and prescriptions
                        when appropriate without the discomfort of an in-person
                        clinic visit.
                      </p>
                    </div>
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get ED treatment in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Erectile Dysfunction care",
                          "Share your symptoms and health history",
                          "Connect with an online provider",
                          "Receive treatment guidance and prescription support",
                        ].map((b) => (
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=men&condition=Erectile%20Dysfunction",
                    )
                  }
                >
                  Book Appointment →
