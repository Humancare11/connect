...
// ─────────────────────────────────────────────────────────────────
export default function MultiSystemComplaints({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        healthcare services for symptom assessment, treatment
                        guidance, and recommendations for further evaluation
                        when needed. Telehealth services allow an experienced
                        online provider to review your symptoms, identify
                        possible underlying causes, and help create a
                        personalized care plan without the need for an in person
                        visit.
                      </p>
                    </div>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=Multi-System%20Complaints",
                    )
                  }
                >
                  Book Appointment →
