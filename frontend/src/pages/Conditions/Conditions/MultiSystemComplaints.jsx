...
const pageData = {
  badge: "Urgent Care",
  heading: "Multi-System Complaints",
...
// ─────────────────────────────────────────────────────────────────
export default function MultiSystemComplaints() {
          ...
          <div className="condition-page-layout">
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What are multi-system complaints?
                      </h3>
                      <p className="condition-block-body">
                        Multi system complaints involve symptoms affecting more
                        than one area of the body, such as fatigue, pain,
                        digestive issues, headaches, dizziness, respiratory
                        concerns, or other unexplained health problems that may
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get personalized care for multi system complaints with
                        ...
                        services for symptom assessment, treatment guidance, and
                        recommendations for further evaluation when needed.
                        Telehealth services allow an experienced online provider
                        to review your symptoms, identify possible underlying
                        causes, and help create a personalized care plan without
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get Multi-System Complaints care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Select Multi-System Complaints care",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Multi-System%20Complaints")}>
                  Start Consultation →
                </button>
