...
// ─────────────────────────────────────────────────────────────────
export default function LowTestosteroneSymptoms({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        drive, reduced muscle strength, mood changes, weight
                        gain, low energy, and difficulty focusing that may
                        affect overall health and daily performance.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        secure telemedicine platform, you can receive hormone
                        health guidance, symptom evaluation, treatment
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=men&condition=Low%20Testosterone%20Symptoms",
                    )
                  }
                >
                  Book Appointment →
