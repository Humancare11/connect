...
const pageData = {
  ...
  heading: "Low Milk Supply",
  description: "Support for breastfeeding concerns",
...
// ─────────────────────────────────────────────────────────────────
export default function LowMilkSupply() {
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    ...
                    <p className="condition-block-body">
                      Low milk supply can make it challenging to meet a baby's
                      feeding needs and may be associated with concerns about
                      milk production, infant feeding patterns, breastfeeding
                      techniques, or other maternal health factors.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get personalized support for low milk supply with
                      ...
                      services for breastfeeding guidance, lactation support,
                      ...
                      potential factors affecting milk production and recommend
                      strategies to support successful breastfeeding and
                      maternal well being.
                    </p>
                  </div>
                  ...
                  <div>
                    <h3 className="condition-block-title">
                      Get Low Milk Supply care in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose Low Milk Supply care",
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=women&condition=Low%20Milk%20Supply")}>
                Start Consultation →
              </button>
