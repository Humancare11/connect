...
// ─────────────────────────────────────────────────────────────────
export default function LowMilkSupply({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        healthcare services for breastfeeding guidance,
                        lactation support, symptom evaluation, and personalized
                        care recommendations. Telehealth services provide
                        convenient access to an experienced online provider who
                        can help identify potential factors affecting milk
                        production and recommend strategies to support
                        successful breastfeeding and maternal well being.
                      </p>
                    </div>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=women&condition=Low%20Milk%20Supply",
                    )
                  }
                >
                  Book Appointment →
