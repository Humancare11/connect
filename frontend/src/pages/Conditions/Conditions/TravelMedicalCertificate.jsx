...
import ConditionBannerImage from "../../../assets/ConditionImages/TravelHealth/Travel-Medical-Certificate.webp";
...
const pageData = {
  badge: "Travel Health",
  heading: "Travel Medical Certificate",
  description: "Medical documentation for travel needs",
...
// ─────────────────────────────────────────────────────────────────
export default function TravelMedicalCertificate() {
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    <h3 className="condition-block-title">
                      What is travel medical certificate?
                    </h3>
                    <p className="condition-block-body">
                      Travel medical certificates may be needed for illness
                      recovery, fitness to travel, medical clearance,
                      prescription documentation, or health-related requirements
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get convenient travel medical support with Humancare
                      ...
                      telemedicine platform, you can receive medical
                      evaluations, travel health guidance, and documentation
                      support when appropriate without the hassle of an
                  ...
                  <div>
                    <h3 className="condition-block-title">
                      Get travel medical support in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose Travel Medical Certificate care",
                        "Share your travel and medical concerns",
                        "Connect with an online provider",
                        "Receive medical guidance and documentation support",
                      ].map((b) => (
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=travel&condition=Travel%20Medical%20Certificate")}>
                Start Consultation →
              </button>
