...
const pageData = {
  badge: "Urgent Care",
  heading: "Minor Burns",
  description: "Mild burns causing skin irritation",
...
// ─────────────────────────────────────────────────────────────────
export default function MinorBurns() {
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    ...
                    <p className="condition-block-body">
                      Minor burns can cause redness, pain, swelling, blistering,
                      and skin sensitivity often caused by heat, hot liquids,
                      steam, or minor household accidents.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get quick care for minor burn symptoms with Humancare
                      ...
                      healthcare services, you can receive treatment guidance,
                      wound care recommendations, and prescriptions when
                      appropriate without visiting urgent care.
                    </p>
                  </div>

                  <div>
                    <h3 className="condition-block-title">
                      Treat minor burns in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Select Minor Burns care",
                        "Share details about your burn symptoms",
                        "Connect with an online provider",
                        "Receive treatment guidance and recovery care recommendations",
                      ].map((b) => (
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Minor%20Burns")}>
                Start Consultation →
              </button>
