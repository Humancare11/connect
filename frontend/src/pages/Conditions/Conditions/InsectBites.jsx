        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      ...
                      services, you can receive treatment recommendations,
                      symptom care, and prescriptions when appropriate without
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Insect%20Bites")}>
                Start Consultation →
              </button>
