...
const pageData = {
  badge: "Urgent Care",
  heading: "Seasonal Allergies",
  description: "Sneezing, congestion, and itchy eyes",
...
// ─────────────────────────────────────────────────────────────────
export default function SeasonalAllergies() {
          ...
          <div className="condition-page-layout">
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Seasonal allergies can cause sneezing, a runny nose,
                        congestion, itchy eyes, coughing, and sinus pressure
                        triggered by pollen, dust, mold, and other environmental
                        allergens.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Manage seasonal allergy symptoms with Humancare Connect
                        from the comfort of home. Our telemedicine services let
                        you schedule an online doctor appointment and connect with
                        a licensed provider for symptom relief, treatment
                        recommendations, and prescriptions when appropriate
                        through our secure virtual healthcare services.
                      </p>
                    </div>

                    <div>
                      <h3 className="condition-block-title">
                        Find allergy relief in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Seasonal Allergies care",
                          "Share your symptoms online",
                          "Connect with an online provider",
                          "Receive treatment guidance and symptom relief options",
                        ].map((b) => (
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Seasonal%20Allergies")}>
                  Start Consultation →
                </button>
