...
import ConditionBannerImage from "../../../assets/ConditionImages/UrgentCare/Food-Poisioning.webp";
...
const pageData = {
  ...
  description: "Stomach illness from contaminated food",
          ...
          <div className="condition-page-layout">
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Food poisoning can cause nausea, vomiting, diarrhea,
                        stomach cramps, fever, dehydration, and weakness often
                        caused by contaminated food or drinks.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get fast care for food poisoning symptoms with Humancare
                        ...
                        platform, you can receive symptom evaluation, hydration
                        guidance, treatment recommendations, and prescriptions
                        when appropriate without the need for an urgent care
                        visit.
                      </p>
                    </div>
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Recover from food poisoning in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Food Poisoning care",
                          "Share your symptoms and recent food history",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Food%20Poisoning")}>
                  Start Consultation →
                </button>
