...
// ─────────────────────────────────────────────────────────────────
export default function ReferralCoordinationOverseas({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        continuity of care, treatment planning, and navigation
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        and connect with a licensed provider from anywhere.
                        Through our secure telemedicine platform, you can access
                        virtual healthcare services for medical record reviews,
                        referral guidance, treatment planning, and personalized
                        care recommendations. Telehealth services provide
                        convenient access to an experienced online provider who
                        can help coordinate specialist referrals, discuss
                        healthcare options abroad, and support a smoother
                        healthcare experience across international borders.
                      </p>
                    </div>

                    <div>
                      <h3 className="condition-block-title">
                        Get Referral Coordination Overseas care in 4 simple
                        steps.
                      </h3>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=travel&condition=Referral%20Coordination%20Overseas",
                    )
                  }
                >
                  Book Appointment →
