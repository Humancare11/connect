...
const pageData = {
  badge: "Travel Health",
  heading: "Referral Coordination Overseas",
  description: "Connecting you with care abroad",
...
// ─────────────────────────────────────────────────────────────────
export default function ReferralCoordinationOverseas() {
          ...
          <div className="condition-page-layout">
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What is Referral Coordination Overseas?
                      </h3>
                      <p className="condition-block-body">
                        Referral coordination overseas helps individuals access
                        appropriate medical specialists, healthcare facilities,
                        and treatment options in another country. It can support
                        continuity of care, treatment planning, and navigation of
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get assistance with overseas healthcare coordination
                        through Humancare Connect. Our telemedicine services make
                        it easy to schedule an online doctor appointment and
                        connect with a licensed provider from anywhere. Through
                        our secure telemedicine platform, you can access virtual
                        healthcare services for medical record reviews, referral
                        guidance, treatment planning, and personalized care
                        recommendations. Telehealth services provide convenient
                        access to an experienced online provider who can help
                        coordinate specialist referrals, discuss healthcare
                        options abroad, and support a smoother healthcare
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get Referral Coordination Overseas care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Referral Coordination Overseas care",
                          "Share your medical history, healthcare needs, and destination details",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=travel&condition=Referral%20Coordination%20Overseas")}>
                  Start Consultation →
                </button>
