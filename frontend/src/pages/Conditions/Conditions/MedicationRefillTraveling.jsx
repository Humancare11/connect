...
// ─────────────────────────────────────────────────────────────────
export default function MedicationRefillTraveling({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What is Medication Refill While Traveling?
                      </h3>
                      <p className="condition-block-body">
                        Running out of medication while traveling can cause
                        stress, missed doses, treatment interruptions, and
                        health concerns especially when access to a local
                        pharmacy or provider is limited.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get convenient prescription refill support with
                        Humancare Connect wherever you travel. Our telemedicine
                        services make it easy to schedule an online doctor
                        appointment and connect with a licensed provider from
                        anywhere. Through our secure virtual healthcare
                        services, you can receive medication refill guidance,
                        treatment support, and prescriptions when appropriate
                        without the hassle of finding urgent care while away
                        from home.
                      </p>
                    </div>
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Refill medications while traveling in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Medication Refill While Traveling care",
                          "Share your prescription and travel details",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=travel&condition=Medication%20Refill%20While%20Traveling",
                    )
                  }
                >
                  Book Appointment →
