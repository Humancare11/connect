        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    ...
                    <p className="condition-block-body">
                      ...
                      stress, missed doses, treatment interruptions, and health
                      concerns especially when access to a local pharmacy or
                      provider is limited.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get convenient prescription refill support with Humancare
                      Connect wherever you travel. Our telemedicine services
                      ...
                      finding urgent care while away from home.
                    </p>
                  </div>
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=travel&condition=Medication%20Refill%20While%20Traveling")}>
                Start Consultation →
              </button>
