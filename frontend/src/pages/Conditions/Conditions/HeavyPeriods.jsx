...
import ConditionBannerImage from "../../../assets/ConditionImages/WomensHealth/heavy-periods.webp";
...
const pageData = {
  ...
  heading: "Heavy Periods",
  description: "Excessive menstrual bleeding and cramps",
...
// ─────────────────────────────────────────────────────────────────
export default function HeavyPeriods() {
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    ...
                    <p className="condition-block-body">
                      Heavy periods can cause excessive bleeding, severe
                      cramping, fatigue, bloating, dizziness, and discomfort
                      that may interfere with daily activities and overall
                      well-being.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get supportive care for heavy periods with Humancare
                      ...
                      hormone health guidance, treatment recommendations, and
                  ...
                  <div>
                    <h3 className="condition-block-title">
                      Manage heavy periods in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose Heavy Periods care",
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=women&condition=Heavy%20Periods")}>
                Start Consultation →
              </button>
