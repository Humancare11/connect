...
import ConditionBannerImage from "../../../assets/ConditionImages/UrgentCare/Acid-Reflux-Gerd.webp";
...
const pageData = {
  ...
  description: "Burning chest and stomach discomfort",
...
// ─────────────────────────────────────────────────────────────────
export default function AcidRefluxGerd() {
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    ...
                    <p className="condition-block-body">
                      Acid reflux and GERD can cause heartburn, chest
                      discomfort, bloating, sour taste, nausea, and irritation
                      in the throat caused by stomach acid flowing back into the
                      esophagus.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get relief from acid reflux and GERD symptoms with
                      ...
                      telemedicine platform, you can receive treatment guidance,
                      symptom management, lifestyle recommendations, and
                  ...
                  <div>
                    <h3 className="condition-block-title">
                      Get relief from acid reflux in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose Acid Reflux / GERD care",
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Acid%20Reflux%20%2F%20GERD")}>
                Start Consultation →
              </button>
