...
// ─────────────────────────────────────────────────────────────────
export default function SubstanceUseSupport({ categoryId } = {}) {
              ...
              <div className="condition-glass-card">
                ...
                <div className="condition-about-grid">
                  ...
                  <div className="condition-about-right">
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get substance use support in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Substance Use Support care",
                          "Share your concerns and health history",
                          "Connect with an online provider",
                          "Receive personalized support and recovery guidance",
                        ].map((b) => (
