...
// ─────────────────────────────────────────────────────────────────
export default function PostpartumConcerns({ categoryId } = {}) {
                ...
                <div className="condition-about-grid">
                  ...
                  <div className="condition-about-right">
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get supportive postpartum care with Humancare Connect
                        ...
                        virtual healthcare services, you can receive postpartum
                        guidance, symptom evaluation, treatment recommendations,
                        and ongoing recovery support without unnecessary clinic
                        visits.
                      </p>
                    </div>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=women&condition=Postpartum%20Concerns",
                    )
                  }
                >
                  Book Appointment →
