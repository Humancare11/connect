...
const pageData = {
  ...
  heading: "Postpartum Concerns",
  description: "Recovery and health after childbirth",
...
// ─────────────────────────────────────────────────────────────────
export default function PostpartumConcerns() {
          ...
          <div className="condition-page-layout">
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What is Postpartum Concerns?
                      </h3>
                      <p className="condition-block-body">
                        Postpartum concerns can include fatigue, mood changes,
                        pain, bleeding, breastfeeding challenges, hormonal
                        changes, healing concerns, and emotional or physical
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get supportive postpartum care with Humancare Connect from
                        ...
                        healthcare services, you can receive postpartum guidance,
                        symptom evaluation, treatment recommendations, and ongoing
                        recovery support without unnecessary clinic visits.
                      </p>
                    </div>

                    <div>
                      <h3 className="condition-block-title">
                        Get postpartum support in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Postpartum Concerns care",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=women&condition=Postpartum%20Concerns")}>
                  Start Consultation →
                </button>
