...
// ─────────────────────────────────────────────────────────────────
export default function VaccinationAdvice() {
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      ...
                      health guidance, and answers to vaccine related questions.
                      Telehealth services provide convenient access to an
                      experienced online provider who can help you make informed
                      decisions about vaccinations based on your age, health
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Vaccination%20Advice")}>
                Start Consultation →
              </button>
