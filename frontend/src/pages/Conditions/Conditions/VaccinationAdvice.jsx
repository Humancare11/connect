...
const pageData = {
  badge: "Urgent Care",
  heading: "Vaccination Advice",
  description: "Guidance for recommended immunizations",
...
// ─────────────────────────────────────────────────────────────────
export default function VaccinationAdvice({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What are Vaccination Advice?
                      </h3>
                      <p className="condition-block-body">
                        Vaccination advice helps individuals and families
                        understand recommended immunizations, vaccine schedules,
                        booster requirements, travel vaccines, and preventive
                        measures to support long term health and protection.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get trusted vaccination guidance with Humancare Connect.
                        ...
                        vaccine recommendations, immunization planning, travel
                        health guidance, and answers to vaccine related
                        questions. Telehealth services provide convenient access
                        to an experienced online provider who can help you make
                        informed decisions about vaccinations based on your age,
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get Vaccination Advice in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Vaccination Advice",
                          "Share your health history and concerns",
                          "Connect with an online provider",
                          "Receive personalized vaccination guidance and care recommendations",
                        ].map((b) => (
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=Vaccination%20Advice",
                    )
                  }
                >
                  Book Appointment →
