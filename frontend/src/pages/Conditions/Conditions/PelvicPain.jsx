...
import ConditionBannerImage from "../../../assets/ConditionImages/WomensHealth/pelvic-pain.webp";
...
const pageData = {
  ...
  heading: "Pelvic Pain",
  description: "Relief for pelvic discomfort",
...
// ─────────────────────────────────────────────────────────────────
export default function PelvicPain() {
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    ...
                    <p className="condition-block-body">
                      Pelvic pain can cause discomfort in the lower abdomen or
                      pelvic region and may be related to reproductive, urinary,
                      digestive, or musculoskeletal conditions. Symptoms can
                      range from mild aching to persistent or severe pain that
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get care for pelvic pain with Humancare Connect. Our
                      ...
                      your symptoms, discuss potential causes, and recommend
                      appropriate next steps to help manage your discomfort and
                  ...
                  <div>
                    <h3 className="condition-block-title">
                      Get Pelvic Pain care in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose Pelvic Pain care",
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=women&condition=Pelvic%20Pain")}>
                Start Consultation →
              </button>
