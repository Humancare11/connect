...
// ─────────────────────────────────────────────────────────────────
export default function RelationshipStress({ categoryId } = {}) {
              ...
              <div className="condition-glass-card">
                ...
                <div className="condition-about-grid">
                  ...
                  <div className="condition-about-right">
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Navigate relationship stress in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Relationship Stress care",
                          "Share your concerns and emotional challenges",
                          "Connect with an online provider",
                          "Receive guidance and personalized care support",
                        ].map((b) => (
