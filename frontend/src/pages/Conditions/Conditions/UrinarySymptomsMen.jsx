...
const pageData = {
  badge: "Men's Health",
  heading: "Urinary Symptoms in Men",
  description: "Bladder and urinary health concerns",
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    <h3 className="condition-block-title">
                      What are Urinary Symptoms in Men?
                    </h3>
                    <p className="condition-block-body">
                      Urinary symptoms in men can cause frequent urination, weak
                      urine flow, burning during urination, urgency, nighttime
                      urination, pelvic discomfort, and bladder control issues
                      that may affect daily comfort and quality of life.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get convenient and discreet care for urinary symptoms with
                      ...
                      treatment guidance, prostate and urinary health support,
                  ...
                  <div>
                    <h3 className="condition-block-title">
                      Get urinary symptom support in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose Urinary Symptoms in Men care",
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=men&condition=Urinary%20Symptoms%20in%20Men")}>
                Start Consultation →
              </button>
