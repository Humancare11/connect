...
import ConditionBannerImage from "../../../assets/ConditionImages/SkinCondition/Psoriasis.webp";
...
// ─────────────────────────────────────────────────────────────────
export default function Psoriasis({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Psoriasis can cause thick, scaly patches of skin,
                        redness, itching, dryness, irritation, and discomfort
                        that may appear on the scalp, elbows, knees, or other
                        areas of the body.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Manage psoriasis symptoms more comfortably with
                        ...
                        symptom evaluation, skincare guidance, treatment
                        recommendations, and prescriptions when appropriate
                        without the hassle of an in-person visit.
                      </p>
                    </div>

                    <div>
                      <h3 className="condition-block-title">
                        Manage psoriasis flare-ups in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Psoriasis care",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=skin&condition=Psoriasis",
                    )
                  }
                >
                  Book Appointment →
