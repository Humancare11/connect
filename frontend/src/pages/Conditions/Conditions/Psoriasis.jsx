        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    ...
                    <p className="condition-block-body">
                      Psoriasis can cause thick, scaly patches of skin, redness,
                      itching, dryness, irritation, and discomfort that may
                      appear on the scalp, elbows, knees, or other areas of the
                      body.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Manage psoriasis symptoms more comfortably with Humancare
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=skin&condition=Psoriasis")}>
                Start Consultation →
              </button>
