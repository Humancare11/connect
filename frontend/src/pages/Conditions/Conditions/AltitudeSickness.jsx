...
import ConditionBannerImage from "../../../assets/ConditionImages/TravelHealth/Altitude-Sickness.webp";
...
const pageData = {
  ...
  description: "Symptoms caused by high elevation",
...
// ─────────────────────────────────────────────────────────────────
export default function AltitudeSickness({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Altitude sickness can cause headaches, dizziness,
                        nausea, fatigue, shortness of breath, trouble sleeping,
                        and weakness that may occur after traveling to high
                        elevations or mountainous areas.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get quick support for altitude sickness symptoms with
                        ...
                        our secure telemedicine platform, you can receive
                        symptom evaluation, hydration guidance, treatment
                        recommendations, and prescriptions when appropriate
                        without searching for urgent care while traveling.
                      </p>
                    </div>

                    <div>
                      <h3 className="condition-block-title">
                        Get altitude sickness support in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Altitude Sickness care",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=travel&condition=Altitude%20Sickness",
                    )
                  }
                >
                  Book Appointment →
