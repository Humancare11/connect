        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    ...
                    <p className="condition-block-body">
                      Altitude sickness can cause headaches, dizziness, nausea,
                      fatigue, shortness of breath, trouble sleeping, and
                      weakness that may occur after traveling to high elevations
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=travel&condition=Altitude%20Sickness")}>
                Start Consultation →
              </button>
