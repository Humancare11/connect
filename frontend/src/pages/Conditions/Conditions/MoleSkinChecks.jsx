...
import ConditionBannerImage from "../../../assets/ConditionImages/SkinCondition/Mole-&-Skin-Checks.webp";
...
// ─────────────────────────────────────────────────────────────────
export default function MoleSkinChecks() {
          ...
          <div className="condition-page-layout">
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What are mole and skin checks?
                      </h3>
                      <p className="condition-block-body">
                        Mole and skin checks help assess new, changing, or unusual
                        moles, spots, growths, discoloration, or other skin
                        concerns that may require medical attention or further
                        evaluation.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get professional guidance for skin concerns with Humancare
                        ...
                        services for skin assessments, symptom evaluation,
                        treatment recommendations, and personalized care guidance.
                        Telehealth services provide convenient access to an
                        experienced online provider who can review your concerns,
                        discuss potential causes, and recommend appropriate next
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get Mole & Skin Checks care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Mole & Skin Checks care",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=skin&condition=Mole%20%26%20Skin%20Checks")}>
                  Start Consultation →
                </button>
