...
// ─────────────────────────────────────────────────────────────────
export default function MoleSkinChecks({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Mole and skin checks help assess new, changing, or
                        unusual moles, spots, growths, discoloration, or other
                        skin concerns that may require medical attention or
                        further evaluation.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get professional guidance for skin concerns with
                        ...
                        healthcare services for skin assessments, symptom
                        evaluation, treatment recommendations, and personalized
                        care guidance. Telehealth services provide convenient
                        access to an experienced online provider who can review
                        your concerns, discuss potential causes, and recommend
                        appropriate next steps for your skin health.
                      </p>
                    </div>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=skin&condition=Mole%20%26%20Skin%20Checks",
                    )
                  }
                >
                  Book Appointment →
