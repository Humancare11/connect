...
// ─────────────────────────────────────────────────────────────────
export default function MinorInfections({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What are minor infections?
                      </h3>
                      <p className="condition-block-body">
                        Minor infections can cause symptoms such as mild fever,
                        sore throat, cough, congestion, skin irritation, urinary
                        discomfort, or other localized symptoms that may require
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get timely care for minor infections with Humancare
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get Minor Infection care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Select Minor Infections care",
