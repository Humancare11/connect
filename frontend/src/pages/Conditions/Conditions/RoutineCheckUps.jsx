...
const pageData = {
  ...
  description: "Ongoing care for everyday health",
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    ...
                    <p className="condition-block-body">
                      Routine check ups help monitor your overall health,
                      identify potential concerns early, manage existing
                      conditions, and support long term wellness through regular
                      medical evaluations.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Stay on top of your health with routine check ups through
                      ...
                      services for general health assessments, medication
                      reviews, preventive care guidance, and wellness
                      recommendations. Telehealth services provide convenient
                      access to an experienced online provider who can help you
                      maintain your health and address concerns before they
                      become more serious.
                    </p>
                  </div>
                  ...
                  <div>
                    <h3 className="condition-block-title">
                      Get Routine Check-Ups care in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose Routine Check-Ups care",
                        "Share your health concerns and medical history",
                        "Connect with an online provider",
                        "Receive personalized health guidance and care recommendations",
                      ].map((b) => (
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Routine%20Check-Ups")}>
                Start Consultation →
              </button>
