...
// ─────────────────────────────────────────────────────────────────
export default function RoutineCheckUps({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        conditions, and support long term wellness through
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        healthcare services for general health assessments,
                        medication reviews, preventive care guidance, and
                        wellness recommendations. Telehealth services provide
                        convenient access to an experienced online provider who
                        can help you maintain your health and address concerns
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=Routine%20Check-Ups",
                    )
                  }
                >
                  Book Appointment →
