...
const pageData = {
  ...
  heading: "Ringworm",
  description: "Fungal infection causing itchy skin",
...
// ─────────────────────────────────────────────────────────────────
export default function Ringworm() {
        ...
        <div className="condition-page-layout">
            ...
            <div className="condition-glass-card">
              ...
              <div className="condition-about-grid">
                ...
                <div className="condition-about-right">
                  <div>
                    <h3 className="condition-block-title">What is Ringworm?</h3>
                    <p className="condition-block-body">
                      Ringworm can cause red, itchy, circular rashes, flaky
                      skin, irritation, and discomfort caused by a contagious
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get fast treatment for ringworm symptoms with Humancare
                      ...
                      guidance, skincare recommendations, and prescriptions when
                  ...
                  <div>
                    <h3 className="condition-block-title">
                      Treat ringworm symptoms in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose Ringworm care",
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=skin&condition=Ringworm")}>
                Start Consultation →
              </button>
