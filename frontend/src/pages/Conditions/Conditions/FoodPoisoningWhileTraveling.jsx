...
// ─────────────────────────────────────────────────────────────────
export default function FoodPoisoningWhileTraveling({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Food poisoning while traveling can cause nausea,
                        vomiting, diarrhea, stomach cramps, dehydration, fever,
                        and weakness often linked to contaminated food, unsafe
                        water, or sudden dietary changes during travel.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        evaluation, hydration guidance, treatment
                        recommendations, and prescriptions when appropriate
                        without the stress of finding urgent care away from
                        home.
                      </p>
                    </div>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=travel&condition=Food%20Poisoning%20While%20Traveling",
                    )
                  }
                >
                  Book Appointment →
