...
import ConditionBannerImage from "../../../assets/ConditionImages/TravelHealth/Food-Poisoning-While-Traveling.webp";
...
const pageData = {
  badge: "Travel Health",
  heading: "Food Poisoning While Traveling",
  description: "Stomach illness during travel trips",
...
// ─────────────────────────────────────────────────────────────────
export default function FoodPoisoningWhileTraveling() {
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    <h3 className="condition-block-title">
                      What is Food Poisoning While Traveling?
                    </h3>
                    <p className="condition-block-body">
                      Food poisoning while traveling can cause nausea, vomiting,
                      diarrhea, stomach cramps, dehydration, fever, and weakness
                      often linked to contaminated food, unsafe water, or sudden
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get fast digestive care wherever you are with Humancare
                      Connect. Our telemedicine services make it easy to
                      schedule an online doctor appointment and connect with a
                      licensed provider while traveling. Through our secure
                      telemedicine platform, you can receive symptom evaluation,
                      hydration guidance, treatment recommendations, and
                      prescriptions when appropriate without the stress of
                      finding urgent care away from home.
                    </p>
                  </div>

                  <div>
                    <h3 className="condition-block-title">
                      Recover from travel food poisoning in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose Food Poisoning While Traveling care",
                        "Share your symptoms and travel details",
                        "Connect with an online provider",
                        "Receive treatment guidance and recovery support",
                      ].map((b) => (
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=travel&condition=Food%20Poisoning%20While%20Traveling")}>
                Start Consultation →
              </button>
