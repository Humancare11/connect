...
import ConditionBannerImage from "../../../assets/ConditionImages/WomensHealth/menopause-symptoms.webp";
...
const pageData = {
  ...
  heading: "Menopause Symptoms",
  description: "Hormonal changes affecting daily life",
...
// ─────────────────────────────────────────────────────────────────
export default function MenopauseSymptoms() {
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    ...
                    <p className="condition-block-body">
                      Menopause symptoms can cause hot flashes, night sweats,
                      mood changes, sleep problems, fatigue, vaginal dryness,
                      and irregular periods caused by hormonal changes during
                      menopause.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Manage menopause symptoms with supportive care through
                      ...
                      telemedicine platform, you can receive hormone health
                      guidance, symptom management support, treatment
                  ...
                  <div>
                    <h3 className="condition-block-title">
                      Manage menopause symptoms in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose Menopause Symptoms care",
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=women&condition=Menopause%20Symptoms")}>
                Start Consultation →
              </button>
