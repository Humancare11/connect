...
// ─────────────────────────────────────────────────────────────────
export default function MalariaPrevention({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Malaria prevention focuses on reducing the risk of
                        malaria infection when traveling to or living in areas
                        where the disease is common. Preventive measures may
                        include medications, mosquito bite protection, travel
                        health planning, and awareness of regional health risks.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        healthcare services for travel health assessments,
                        preventive care recommendations, medication guidance,
                        and personalized care planning. Telehealth services
                        provide convenient access to an experienced online
                        provider who can review your travel plans, discuss
                        malaria prevention strategies, and help you reduce your
                        risk of infection.
                      </p>
                    </div>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=travel&condition=Malaria%20Prevention",
                    )
                  }
                >
                  Book Appointment →
