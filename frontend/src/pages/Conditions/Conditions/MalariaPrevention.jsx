...
import ConditionBannerImage from "../../../assets/ConditionImages/TravelHealth/Malaria-Prevention.webp";
...
const pageData = {
  ...
  description: "Protection against mosquito borne illnesss.",
...
// ─────────────────────────────────────────────────────────────────
export default function MalariaPrevention() {
          ...
          <div className="condition-page-layout">
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Malaria prevention focuses on reducing the risk of malaria
                        infection when traveling to or living in areas where the
                        disease is common. Preventive measures may include
                        medications, mosquito bite protection, travel health
                        planning, and awareness of regional health risks.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Stay protected with malaria prevention guidance from
                        Humancare Connect. Our telemedicine services make it easy
                        to schedule an online doctor appointment and connect with
                        a licensed provider from home. Through our secure
                        telemedicine platform, you can access virtual healthcare
                        services for travel health assessments, preventive care
                        recommendations, medication guidance, and personalized
                        care planning. Telehealth services provide convenient
                        access to an experienced online provider who can review
                        your travel plans, discuss malaria prevention strategies,
                        and help you reduce your risk of infection.
                      </p>
                    </div>

                    <div>
                      <h3 className="condition-block-title">
                        Get Malaria Prevention care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Malaria Prevention care",
                          "Share your travel destination and health history",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=travel&condition=Malaria%20Prevention")}>
                  Start Consultation →
                </button>
