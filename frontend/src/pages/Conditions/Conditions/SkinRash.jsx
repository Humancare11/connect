        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    ...
                    <p className="condition-block-body">
                      Skin rashes can cause redness, itching, bumps, dryness,
                      swelling, irritation, and discomfort triggered by
                      allergies, infections, heat, eczema, or skin
                      sensitivities.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get fast care for skin rash symptoms with Humancare
                      ...
                      appropriate without the need for an in-person visit.
                    </p>
                  </div>

                  <div>
                    <h3 className="condition-block-title">
                      Get skin rash treatment in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose Skin Rash care",
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=skin&condition=Skin%20Rash")}>
                Start Consultation →
              </button>
