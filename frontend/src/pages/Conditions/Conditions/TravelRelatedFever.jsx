...
// ─────────────────────────────────────────────────────────────────
export default function TravelRelatedFever({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        aches, sweating, headaches, nausea, and weakness that
                        may be linked to infections, food exposure, climate
                        changes, or illnesses picked up while traveling.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        symptom evaluation, treatment guidance, hydration
                        support, and prescriptions when appropriate without
                        searching for urgent care while away from home.
                      </p>
                    </div>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=travel&condition=Travel-Related%20Fever",
                    )
                  }
                >
                  Book Appointment →
