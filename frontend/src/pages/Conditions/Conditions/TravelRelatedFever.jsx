...
const pageData = {
  badge: "Travel Health",
  heading: "Travel-Related Fever",
  description: "Fever and illness during travel",
...
// ─────────────────────────────────────────────────────────────────
export default function TravelRelatedFever() {
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    <h3 className="condition-block-title">
                      What is travel related fever?
                    </h3>
                    <p className="condition-block-body">
                      Travel-related fever can cause chills, fatigue, body
                      aches, sweating, headaches, nausea, and weakness that may
                      be linked to infections, food exposure, climate changes,
                      or illnesses picked up while traveling.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get fast medical support for travel-related fever with
                      ...
                      evaluation, treatment guidance, hydration support, and
                      prescriptions when appropriate without searching for
                      urgent care while away from home.
                    </p>
                  </div>

                  <div>
                    <h3 className="condition-block-title">
                      Get travel fever care in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose Travel-Related Fever care",
                        "Share your symptoms and recent travel details",
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=travel&condition=Travel-Related%20Fever")}>
                Start Consultation →
              </button>
