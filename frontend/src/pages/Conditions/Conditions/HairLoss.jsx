...
// ─────────────────────────────────────────────────────────────────
export default function HairLoss({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        patchy bald spots, excessive shedding, and changes in
                        hair growth that may be linked to genetics, hormones,
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Take control of hair loss with Humancare Connect from
                        ...
                        treatment options, scalp evaluations, and prescriptions
                        when appropriate through our secure telemedicine
                        platform.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="condition-benefits-grid">
                        {[
                          ...
                          "Upload photos and share your concerns",
                          "Connect with an online provider",
                          "Receive personalized treatment and care recommendations",
                        ].map((b) => (
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=skin&condition=Hair%20Loss",
                    )
                  }
                >
                  Book Appointment →
