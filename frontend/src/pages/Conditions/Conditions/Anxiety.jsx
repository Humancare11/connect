...
// ─────────────────────────────────────────────────────────────────
export default function Anxiety({ categoryId } = {}) {
                ...
                <div className="condition-about-grid">
                  ...
                  <div className="condition-about-right">
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get compassionate support for anxiety with Humancare
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get anxiety support in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Anxiety care",
                          "Share your symptoms and mental health concerns",
