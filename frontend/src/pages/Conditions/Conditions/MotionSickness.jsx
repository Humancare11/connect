...
import ConditionBannerImage from "../../../assets/ConditionImages/TravelHealth/Motion-Sickness.webp";
...
const pageData = {
  ...
  description: "Nausea and dizziness during travel",
...
// ─────────────────────────────────────────────────────────────────
export default function MotionSickness({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Motion sickness can cause nausea, dizziness, vomiting,
                        sweating, headaches, and stomach discomfort triggered by
                        movement during car rides, flights, cruises, or other
                        forms of travel.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get fast relief for motion sickness symptoms with
                        ...
                        hassle of finding urgent care while traveling.
                      </p>
                    </div>

                    <div>
                      <h3 className="condition-block-title">
                        Manage motion sickness in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Motion Sickness care",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=travel&condition=Motion%20Sickness",
                    )
                  }
                >
                  Book Appointment →
