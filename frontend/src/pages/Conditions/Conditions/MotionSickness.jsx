        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      ...
                      treatment guidance, travel health support, and
                      prescriptions when appropriate without the hassle of
                      finding urgent care while traveling.
                    </p>
                  </div>
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=travel&condition=Motion%20Sickness")}>
                Start Consultation →
              </button>
