...
// ─────────────────────────────────────────────────────────────────
export default function FungalSkinInfection({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Fungal skin infections can cause itching, redness,
                        rashes, peeling skin, irritation, discoloration, and
                        discomfort that may spread across different areas of the
                        body.
                      </p>
                    </div>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=skin&condition=Fungal%20Skin%20Infection",
                    )
                  }
                >
                  Book Appointment →
