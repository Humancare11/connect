...
import ConditionBannerImage from "../../../assets/ConditionImages/WomensHealth/emergency-contraception-guidance.webp";
...
const pageData = {
  ...
  heading: "Emergency Contraception Guidance",
  description: "Time-sensitive pregnancy prevention support",
...
// ─────────────────────────────────────────────────────────────────
export default function EmergencyContraceptionGuidance() {
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    <h3 className="condition-block-title">
                      What is emergency contraception guidance?
                    </h3>
                    <p className="condition-block-body">
                      Emergency contraception guidance can help with questions
                      about pregnancy prevention after unprotected sex, missed
                      birth control, medication timing, side effects, and
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get confidential support quickly with Humancare Connect.
                      ...
                      platform, you can receive timely guidance, treatment
                      recommendations, and prescriptions when appropriate
                      without the stress of an in-person clinic visit.
                    </p>
                  </div>

                  <div>
                    <h3 className="condition-block-title">
                      Get emergency contraception guidance in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose Emergency Contraception Guidance",
                        "Share your concerns and health history",
                        "Connect with an online provider",
                        "Receive confidential guidance and treatment support",
                      ].map((b) => (
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=women&condition=Emergency%20Contraception%20Guidance")}>
                Start Consultation →
              </button>
