...
const pageData = {
  badge: "Travel Health",
  heading: "Jet Lag ",
  description: "Sleep disruption from time zone changes",
...
// ─────────────────────────────────────────────────────────────────
export default function JetLag({ categoryId } = {}) {
                ...
                <div className="condition-about-grid">
                  ...
                  <div className="condition-about-right">
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Recover from jet lag more comfortably with Humancare
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Recover from jet lag in 4 simple steps.
                      </h3>
