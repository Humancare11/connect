...
// ─────────────────────────────────────────────────────────────────
export default function Ptsd({ categoryId } = {}) {
              ...
              <div className="condition-glass-card">
                ...
                <div className="condition-about-grid">
                  ...
                  <div className="condition-about-right">
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get PTSD support in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Post-Traumatic Stress Disorder (PTSD) care",
                          "Share your symptoms and emotional concerns",
                          "Connect with an online provider",
                          "Receive personalized mental health support and care guidance",
                        ].map((b) => (
