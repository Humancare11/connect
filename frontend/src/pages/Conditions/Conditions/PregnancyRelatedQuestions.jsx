...
// ─────────────────────────────────────────────────────────────────
export default function PregnancyRelatedQuestions({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        body changes, nutrition questions, medication safety,
                        mild symptoms, and general health concerns during
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get trusted pregnancy support with Humancare Connect
                        ...
                        virtual healthcare services, you can receive pregnancy
                        guidance, symptom evaluation, treatment recommendations,
                        and answers to common pregnancy-related questions
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=women&condition=Pregnancy%20Related%20Questions",
                    )
                  }
                >
                  Book Appointment →
