...
const pageData = {
  ...
  heading: "Pregnancy Related Questions",
  description: "Guidance and support during pregnancy",
...
// ─────────────────────────────────────────────────────────────────
export default function PregnancyRelatedQuestions() {
          ...
          <div className="condition-page-layout">
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What is Pregnancy Related Questions care?
                      </h3>
                      <p className="condition-block-body">
                        Pregnancy-related concerns can include nausea, fatigue,
                        body changes, nutrition questions, medication safety, mild
                        symptoms, and general health concerns during different
                        stages of pregnancy.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get trusted pregnancy support with Humancare Connect from
                        ...
                        healthcare services, you can receive pregnancy guidance,
                        symptom evaluation, treatment recommendations, and answers
                        to common pregnancy-related questions without unnecessary
                        clinic visits.
                      </p>
                    </div>
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get pregnancy support in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Pregnancy Related Questions care",
                          "Share your symptoms and concerns",
                          "Connect with an online provider",
                          "Receive guidance and personalized care recommendations",
                        ].map((b) => (
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=women&condition=Pregnancy%20Related%20Questions")}>
                  Start Consultation →
                </button>
