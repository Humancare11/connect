...
import ConditionBannerImage from "../../../assets/ConditionImages/UrineryKidneyHealth/urinary-incontinence.webp";
...
const pageData = {
  ...
  description: "Loss of bladder control and leakage",
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    ...
                    <p className="condition-block-body">
                      Urinary incontinence can cause accidental urine leakage,
                      sudden urges to urinate, frequent bathroom trips,
                      nighttime urination, and bladder control issues that may
                      affect daily activities and confidence.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get discreet support for urinary incontinence with
                      ...
                      bladder health guidance, treatment recommendations, and
                  ...
                  <div>
                    <h3 className="condition-block-title">
                      Improve bladder control in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose Urinary Incontinence care",
                        "Share your symptoms and bladder concerns",
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Urinary%20Incontinence")}>
                Start Consultation →
              </button>
