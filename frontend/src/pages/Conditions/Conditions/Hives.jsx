...
import ConditionBannerImage from "../../../assets/ConditionImages/SkinCondition/Hives.webp";
          ...
          <div className="condition-page-layout">
              ...
              <div className="condition-glass-card">
                ...
                <div className="condition-about-grid">
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">What is hives?</h3>
                      <p className="condition-block-body">
                        Hives can cause red, swollen, itchy patches on the skin
                        that may appear suddenly due to allergies, infections,
                        medications, stress, or other immune reactions.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get quick relief for hives with Humancare Connect. Our
                        ...
                        you can receive symptom evaluation, allergy guidance,
                        treatment recommendations, and prescriptions when
                        appropriate without the wait of an in-person visit.
                      </p>
                    </div>

                    <div>
                      <h3 className="condition-block-title">
                        Treat hives in 4 easy steps.
                      </h3>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=skin&condition=Hives")}>
                  Start Consultation →
                </button>
