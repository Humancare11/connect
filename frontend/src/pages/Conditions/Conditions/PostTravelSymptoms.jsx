...
const pageData = {
  badge: "Travel Health",
  heading: "Post-Travel Symptoms",
  description: "Care for health concerns after travel",
...
// ─────────────────────────────────────────────────────────────────
export default function PostTravelSymptoms() {
          ...
          <div className="condition-page-layout">
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What are Post-Travel Symptoms?
                      </h3>
                      <p className="condition-block-body">
                        Post travel symptoms can include fever, diarrhea, nausea,
                        fatigue, rash, respiratory symptoms, stomach discomfort,
                        or other health concerns that develop during or after
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get support for post travel symptoms with Humancare
                        ...
                        services for symptom evaluation, travel related health
                        assessments, treatment recommendations, and personalized
                        care planning. Telehealth services provide convenient
                        access to an experienced online provider who can review
                        your travel history, assess your symptoms, and recommend
                        appropriate next steps to support your recovery and
                        overall well being.
                      </p>
                    </div>
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get Post-Travel Symptoms care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Post-Travel Symptoms care",
                          "Share your symptoms, travel history, and concerns",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=travel&condition=Post-Travel%20Symptoms")}>
                  Start Consultation →
                </button>
