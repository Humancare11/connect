...
// ─────────────────────────────────────────────────────────────────
export default function PostTravelSymptoms({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Post travel symptoms can include fever, diarrhea,
                        nausea, fatigue, rash, respiratory symptoms, stomach
                        discomfort, or other health concerns that develop during
                        or after returning from domestic or international
                        travel.
                      </p>
                    </div>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=travel&condition=Post-Travel%20Symptoms",
                    )
                  }
                >
                  Book Appointment →
