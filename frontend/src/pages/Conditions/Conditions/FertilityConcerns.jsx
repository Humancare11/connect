...
import ConditionBannerImage from "../../../assets/ConditionImages/WomensHealth/fertility-concerns.webp";
...
const pageData = {
  ...
  heading: "Fertility Concerns",
  description: "Guidance for your fertility journey",
...
// ─────────────────────────────────────────────────────────────────
export default function FertilityConcerns() {
          ...
          <div className="condition-page-layout">
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What is fertility concern?
                      </h3>
                      <p className="condition-block-body">
                        Fertility concerns can affect individuals and couples who
                        are having difficulty conceiving or have questions about
                        reproductive health, family planning, fertility factors,
                        or potential barriers to pregnancy.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get personalized support for fertility concerns with
                        ...
                        services for fertility evaluations, reproductive health
                        guidance, family planning discussions, and personalized
                        care recommendations. Telehealth services provide
                        convenient access to an experienced online provider who
                        can help assess your concerns, discuss potential factors
                        affecting fertility, and recommend appropriate next steps
                        to support your reproductive health goals.
                      </p>
                    </div>

                    <div>
                      <h3 className="condition-block-title">
                        Get Fertility Concerns care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Fertility Concerns Support",
                          "Share your symptoms, concerns, and reproductive health history",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=women&condition=Fertility%20Concerns")}>
                  Start Consultation →
                </button>
