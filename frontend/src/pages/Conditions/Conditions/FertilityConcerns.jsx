...
// ─────────────────────────────────────────────────────────────────
export default function FertilityConcerns({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Fertility concerns can affect individuals and couples
                        who are having difficulty conceiving or have questions
                        about reproductive health, family planning, fertility
                        factors, or potential barriers to pregnancy.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        healthcare services for fertility evaluations,
                        reproductive health guidance, family planning
                        discussions, and personalized care recommendations.
                        Telehealth services provide convenient access to an
                        experienced online provider who can help assess your
                        concerns, discuss potential factors affecting fertility,
                        and recommend appropriate next steps to support your
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=women&condition=Fertility%20Concerns",
                    )
                  }
                >
                  Book Appointment →
