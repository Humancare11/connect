...
// ─────────────────────────────────────────────────────────────────
export default function PreTravelVaccination({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        understand recommended immunizations, destination
                        specific health risks, vaccine requirements, and
                        preventive measures that can support a safer and
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=travel&condition=Pre-Travel%20Vaccination",
                    )
                  }
                >
                  Book Appointment →
