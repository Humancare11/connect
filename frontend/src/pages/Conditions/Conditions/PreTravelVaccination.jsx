...
const pageData = {
  badge: "Travel Health",
  heading: "Pre-Travel Vaccination",
  description: "Protection before international travel",
...
// ─────────────────────────────────────────────────────────────────
export default function PreTravelVaccination() {
          ...
          <div className="condition-page-layout">
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Pre travel vaccination consultations help travelers
                        understand recommended immunizations, destination specific
                        health risks, vaccine requirements, and preventive
                        measures that can support a safer and healthier travel
                        experience.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Prepare for your trip with confidence through Humancare
                        ...
                        services for travel health assessments, vaccination
                        guidance, destination specific recommendations, and
                        personalized care planning. Telehealth services provide
                        convenient access to an experienced online provider who
                        can review your travel plans, discuss recommended
                        vaccines, and help you stay protected while traveling.
                      </p>
                    </div>

                    <div>
                      <h3 className="condition-block-title">
                        Get Pre-Travel Vaccination care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Pre-Travel Vaccination care",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=travel&condition=Pre-Travel%20Vaccination")}>
                  Start Consultation →
                </button>
