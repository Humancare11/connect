...
import ConditionBannerImage from "../../../assets/ConditionImages/UrineryKidneyHealth/burning-urination.webp";
...
const pageData = {
  ...
  heading: "Burning Urination",
  description: "Pain or burning while urinating",
...
// ─────────────────────────────────────────────────────────────────
export default function BurningUrination() {
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    ...
                    <p className="condition-block-body">
                      Burning urination can cause pain, stinging, discomfort,
                      irritation, and frequent urges to urinate often linked to
                      urinary tract infections, bladder infections, dehydration,
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get fast relief for burning urination symptoms with
                      ...
                      without the hassle of an in-person clinic visit.
                    </p>
                  </div>

                  <div>
                    <h3 className="condition-block-title">
                      Get urinary symptom relief in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose Burning Urination care",
                        "Share your symptoms and urinary concerns",
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Burning%20Urination")}>
                Start Consultation →
              </button>
