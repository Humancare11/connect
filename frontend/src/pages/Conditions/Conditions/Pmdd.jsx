...
const pageData = {
  ...
  heading: "Premenstrual Dysphoric Disorder (PMDD)",
  description: "Support for severe premenstrual symptoms",
        ...
        <div className="condition-page-layout">
            ...
            <div className="condition-glass-card">
              ...
              <div className="condition-about-grid">
                ...
                <div className="condition-about-right">
                  <div>
                    <h3 className="condition-block-title">What is PMDD?</h3>
                    <p className="condition-block-body">
                      Premenstrual dysphoric disorder (PMDD) is a condition that
                      can cause severe emotional and physical symptoms before
                      menstruation, including mood changes, irritability,
                      anxiety, depression, fatigue, and difficulty with daily
                      activities.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get personalized support for PMDD with Humancare Connect.
                      ...
                      symptom evaluation, treatment guidance, hormone related
                      health concerns, and personalized care recommendations.
                      Telehealth services provide convenient access to an
                      experienced online provider who can help manage PMDD
                      symptoms, improve quality of life, and support your
                  ...
                  <div>
                    <h3 className="condition-block-title">
                      Get PMDD care in 4 simple steps.
                    </h3>
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=women&condition=Premenstrual%20Dysphoric%20Disorder%20%28PMDD%29")}>
                Start Consultation →
              </button>
