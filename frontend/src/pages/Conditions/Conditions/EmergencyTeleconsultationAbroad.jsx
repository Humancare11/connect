...
import ConditionBannerImage from "../../../assets/ConditionImages/TravelHealth/Emergency-Teleconsultation-Abroad.webp";
...
const pageData = {
  badge: "Travel Health",
  heading: "Emergency Teleconsultation Abroad",
  description: "Urgent medical support while overseas",
...
// ─────────────────────────────────────────────────────────────────
export default function EmergencyTeleconsultationAbroad() {
          ...
          <div className="condition-page-layout">
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What is Emergency Teleconsultation Abroad?
                      </h3>
                      <p className="condition-block-body">
                        Emergency teleconsultation abroad can help with sudden
                        illness, infections, fever, stomach issues, prescription
                        needs, travel-related symptoms, or unexpected health
                        concerns while traveling internationally.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get fast medical support wherever you are with Humancare
                        Connect. Our telemedicine services make it easy to
                        schedule an online doctor appointment and connect with a
                        licensed provider from abroad. Through our secure virtual
                        healthcare services, you can receive urgent symptom
                        evaluation, treatment guidance, travel health support, and
                        prescriptions when appropriate without the stress of
                        finding local care in a foreign country.
                      </p>
                    </div>

                    <div>
                      <h3 className="condition-block-title">
                        Get emergency travel care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Emergency Teleconsultation Abroad",
                          "Share your symptoms and travel concerns",
                          "Connect with an online provider",
                          "Receive urgent treatment guidance and care support",
                        ].map((b) => (
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=travel&condition=Emergency%20Teleconsultation%20Abroad")}>
                  Start Consultation →
                </button>
