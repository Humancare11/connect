...
// ─────────────────────────────────────────────────────────────────
export default function EmergencyTeleconsultationAbroad({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        licensed provider from abroad. Through our secure
                        virtual healthcare services, you can receive urgent
                        symptom evaluation, treatment guidance, travel health
                        support, and prescriptions when appropriate without the
                        stress of finding local care in a foreign country.
                      </p>
                    </div>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=travel&condition=Emergency%20Teleconsultation%20Abroad",
                    )
                  }
                >
                  Book Appointment →
