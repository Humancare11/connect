          ...
          <div className="condition-page-layout">
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        excessive hair growth, fertility challenges, mood changes,
                        and hormone imbalances that may affect overall
                        reproductive health.
                      </p>
                    </div>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=women&condition=Polycystic%20Ovary%20Syndrome%20%28PCOS%29")}>
                  Start Consultation →
                </button>
