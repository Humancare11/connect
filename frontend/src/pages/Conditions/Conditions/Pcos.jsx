...
import ConditionBannerImage from "../../../assets/ConditionImages/WomensHealth/pcos.webp";
...
const pageData = {
  ...
  description: "Hormonal disorder affecting ovaries",
...
// ─────────────────────────────────────────────────────────────────
export default function Pcos({ categoryId } = {}) {
              ...
              <div className="condition-glass-card">
                ...
                <div className="condition-about-grid">
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">What is PCOS?</h3>
                      <p className="condition-block-body">
                        PCOS can cause irregular periods, weight changes, acne,
                        excessive hair growth, fertility challenges, mood
                        changes, and hormone imbalances that may affect overall
                        reproductive health.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Manage PCOS symptoms with personalized care through
                        ...
                        hormone health guidance, symptom management support,
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Manage PCOS symptoms in 4 simple steps.
                      </h3>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=women&condition=Polycystic%20Ovary%20Syndrome%20%28PCOS%29",
                    )
                  }
                >
                  Book Appointment →
