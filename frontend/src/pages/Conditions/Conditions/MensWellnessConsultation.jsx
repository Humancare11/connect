...
import ConditionBannerImage from "../../../assets/ConditionImages/MensHealth/Mens-Wellness-Consultation.webp";
...
const pageData = {
  badge: "Men's Health",
  heading: "Men's Wellness Consultation",
  description: "Personalized care for men’s health",
...
// ─────────────────────────────────────────────────────────────────
export default function MensWellnessConsultation() {
          ...
          <div className="condition-page-layout">
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What is Mens Wellness Consultation?
                      </h3>
                      <p className="condition-block-body">
                        Men’s wellness consultations can help address energy
                        levels, sexual health, weight management, hormone
                        concerns, stress, preventive care, and overall health
                        goals that may affect daily performance and well-being.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Take charge of your health with Humancare Connect. Our
                        ...
                        you can receive personalized wellness guidance, treatment
                        recommendations, preventive care support, and
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Prioritize your health in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Men’s Wellness Consultation care",
                          "Share your health goals and concerns",
                          "Connect with an online provider",
                          "Receive personalized wellness guidance and care recommendations",
                        ].map((b) => (
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=men&condition=Men%27s%20Wellness%20Consultation")}>
                  Start Consultation →
                </button>
