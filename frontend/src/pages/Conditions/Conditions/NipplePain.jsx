...
import ConditionBannerImage from "../../../assets/ConditionImages/WomensHealth/nipple-pain.webp";
...
const pageData = {
  ...
  heading: "Nipple Pain",
  description: "Relief for breastfeeding discomfort",
...
// ─────────────────────────────────────────────────────────────────
export default function NipplePain() {
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    ...
                    <p className="condition-block-body">
                      Nipple pain can occur during breastfeeding and may cause
                      soreness, tenderness, cracking, irritation, or discomfort
                      that can make feeding sessions difficult for both parent
                      and baby.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get support for nipple pain with Humancare Connect. Our
                      ...
                      guidance, symptom evaluation, lactation support, and
                      personalized care recommendations. Telehealth services
                      provide convenient access to an experienced online
                      provider who can help identify the cause of nipple pain,
                      recommend effective solutions, and support a more
                  ...
                  <div>
                    <h3 className="condition-block-title">
                      Get Nipple Pain care in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose Nipple Pain care",
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=women&condition=Nipple%20Pain")}>
                Start Consultation →
              </button>
