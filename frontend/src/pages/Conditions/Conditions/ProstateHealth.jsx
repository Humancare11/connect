...
const pageData = {
  ...
  description: "Common concerns affecting prostate function",
...
// ─────────────────────────────────────────────────────────────────
export default function ProstateHealth({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Prostate health issues can cause frequent urination,
                        difficulty urinating, weak urine flow, pelvic
                        discomfort, nighttime urination, and bladder-related
                        symptoms that may affect daily comfort and quality of
                        life.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Manage prostate health concerns with confidence through
                        ...
                        symptom evaluation, treatment guidance, prostate health
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Support your prostate health in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Prostate Health care",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=men&condition=Prostate%20Health",
                    )
                  }
                >
                  Book Appointment →
