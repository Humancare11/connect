...
// ─────────────────────────────────────────────────────────────────
export default function LowSelfEsteem({ categoryId } = {}) {
                ...
                <div className="condition-about-grid">
                  ...
                  <div className="condition-about-right">
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get support for low self esteem with Humancare Connect.
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get Low Self-Esteem care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Low Self-Esteem care",
