...
// ─────────────────────────────────────────────────────────────────
export default function NeilProblems({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        brittleness, ridges, splitting, pain, swelling, or
                        changes in nail appearance that may be caused by
                        infections, injuries, skin conditions, or other
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        your nail concerns, discuss possible causes, and
                        recommend appropriate next steps without the need for an
                        in person visit.
                      </p>
                    </div>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=skin&condition=Nail%20Problems",
                    )
                  }
                >
                  Book Appointment →
