...
// ─────────────────────────────────────────────────────────────────
export default function NeilProblems() {
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    <h3 className="condition-block-title">
                      What is nail problems care?
                    </h3>
                    <p className="condition-block-body">
                      Nail problems can include discoloration, thickening,
                      brittleness, ridges, splitting, pain, swelling, or changes
                      in nail appearance that may be caused by infections,
                      injuries, skin conditions, or other underlying health
                      concerns.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get care for nail problems with Humancare Connect. Our
                      ...
                      your nail concerns, discuss possible causes, and recommend
                      appropriate next steps without the need for an in person
                      visit.
                    </p>
                  </div>
                  ...
                  <div>
                    <h3 className="condition-block-title">
                      Get Nail Problems care in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose Nail Problems care",
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=skin&condition=Nail%20Problems")}>
                Start Consultation →
              </button>
