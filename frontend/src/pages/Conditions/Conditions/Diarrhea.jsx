...
import ConditionBannerImage from "../../../assets/ConditionImages/UrgentCare/Diarrhea.webp";
          ...
          <div className="condition-page-layout">
              ...
              <div className="condition-glass-card">
                ...
                <div className="condition-about-grid">
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">What is Diarrhea?</h3>
                      <p className="condition-block-body">
                        Diarrhea can cause stomach cramps, loose stools,
                        dehydration, nausea, bloating, and discomfort, often
                        triggered by infections, food poisoning, medications, or
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get fast care for diarrhea symptoms with Humancare
                        ...
                        services, you can receive treatment guidance, hydration
                        recommendations, symptom management, and prescriptions
                        when appropriate without visiting urgent care.
                      </p>
                    </div>

                    <div>
                      <h3 className="condition-block-title">
                        Get digestive care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose digestive care",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Diarrhea")}>
                  Start Consultation →
                </button>
