...
const pageData = {
  ...
  heading: "Prenatal Consultation",
  description: "Pregnancy care and prenatal guidance",
...
// ─────────────────────────────────────────────────────────────────
export default function PrenatalConsultation() {
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    <h3 className="condition-block-title">
                      What is Prenatal Consultation?
                    </h3>
                    <p className="condition-block-body">
                      Prenatal consultations can help with pregnancy health
                      questions, nutrition guidance, prenatal symptoms,
                      medication safety, lifestyle recommendations, and routine
                      pregnancy care throughout each stage of pregnancy.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get trusted prenatal support with Humancare Connect from
                      the comfort of home. Our telemedicine services make it
                      easy to schedule an online doctor appointment and connect
                      with a licensed provider. Through our secure virtual
                      healthcare services, you can receive prenatal guidance,
                      symptom evaluation, treatment recommendations, and ongoing
                      pregnancy support without unnecessary clinic visits.
                    </p>
                  </div>

                  <div>
                    <h3 className="condition-block-title">
                      Get Prenatal Care support in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose Prenatal Consultation care",
                        "Share your pregnancy concerns and health history",
                        "Connect with an online provider",
                        "Receive prenatal guidance and personalized care recommendations",
                      ].map((b) => (
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=women&condition=Prenatal%20Consultation")}>
                Start Consultation →
              </button>
