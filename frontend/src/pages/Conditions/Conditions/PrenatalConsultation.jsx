...
// ─────────────────────────────────────────────────────────────────
export default function PrenatalConsultation({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        medication safety, lifestyle recommendations, and
                        routine pregnancy care throughout each stage of
                        pregnancy.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        virtual healthcare services, you can receive prenatal
                        guidance, symptom evaluation, treatment recommendations,
                        and ongoing pregnancy support without unnecessary clinic
                        visits.
                      </p>
                    </div>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=women&condition=Prenatal%20Consultation",
                    )
                  }
                >
                  Book Appointment →
