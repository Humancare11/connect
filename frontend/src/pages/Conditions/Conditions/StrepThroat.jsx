...
// ─────────────────────────────────────────────────────────────────
export default function StrepThroat() {
          ...
          <div className="condition-page-layout">
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Strep throat can cause severe sore throat pain, fever,
                        swollen glands, difficulty swallowing, and white patches
                        in the throat caused by a bacterial infection.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get fast treatment for strep throat symptoms with
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get strep throat treatment in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Strep Throat care",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Strep%20Throat")}>
                  Start Consultation →
                </button>
