...
// ─────────────────────────────────────────────────────────────────
export default function SleepRelatedAnxiety({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What is Sleep-Related Anxiety?
                      </h3>
                      <p className="condition-block-body">
                        Sleep related anxiety can cause excessive worry, racing
                        thoughts, nervousness, or stress that makes it difficult
                        to fall asleep, stay asleep, or achieve restful sleep,
                        leading to daytime fatigue and reduced well being.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get support for sleep related anxiety with Humancare
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get Sleep-Related Anxiety care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Sleep-Related Anxiety care",
