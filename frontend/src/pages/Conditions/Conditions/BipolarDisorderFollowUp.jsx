...
// ─────────────────────────────────────────────────────────────────
export default function BipolarDisorderFollowUp({ categoryId } = {}) {
                ...
                <div className="condition-about-grid">
                  ...
                  <div className="condition-about-right">
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Stay connected to your mental health care with Humancare
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get Bipolar Disorder Follow-Up care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Bipolar Disorder Follow-Up care",
                          "Share your symptoms, concerns, and treatment history",
