...
// ─────────────────────────────────────────────────────────────────
export default function Depression({ categoryId } = {}) {
                ...
                <div className="condition-about-grid">
                  ...
                  <div className="condition-about-right">
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get compassionate support for depression with Humancare
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get depression support in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Depression care",
                          "Share your symptoms and emotional concerns",
                          "Connect with an online provider",
                          "Receive treatment guidance and personalized mental health support",
                        ].map((b) => (
