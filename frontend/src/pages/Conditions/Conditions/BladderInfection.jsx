...
const pageData = {
  ...
  heading: "Bladder Infection",
  description: "Burning, pressure, and urinary discomfort",
...
// ─────────────────────────────────────────────────────────────────
export default function BladderInfection({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        A bladder infection can cause burning during urination,
                        pelvic pressure, frequent urges to urinate, cloudy
                        urine, discomfort, and lower abdominal pain often caused
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get fast relief for bladder infection symptoms with
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get bladder infection care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose bladder infection care",
                          "Share your symptoms and urinary concerns",
                          "Connect with an online provider",
                          "Receive treatment guidance and prescriptions if needed",
                        ].map((b) => (
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=Bladder%20Infection",
                    )
                  }
                >
                  Book Appointment →
