...
// ─────────────────────────────────────────────────────────────────
export default function HairLossMensHealth() {
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    ...
                    <p className="condition-block-body">
                      Hair loss can cause thinning hair, receding hairlines,
                      patchy bald spots, excessive shedding, and changes in hair
                      growth that may be linked to genetics, hormones, stress,
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Take control of hair loss with personalized care through
                      ...
                      telemedicine platform, you can receive scalp evaluations,
                  ...
                  <div>
                    <h3 className="condition-block-title">
                      Start hair loss treatment in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose Hair Loss care",
                        "Share your symptoms and hair concerns",
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=men&condition=Hair%20Loss")}>
                Start Consultation →
              </button>
