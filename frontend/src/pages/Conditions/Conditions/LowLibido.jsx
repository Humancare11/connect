...
// ─────────────────────────────────────────────────────────────────
export default function LowLibido({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Low libido refers to a reduced interest in sexual
                        activity that may affect relationships, emotional well
                        being, and quality of life. It can be influenced by
                        hormonal changes, stress, medical conditions,
                        medications, lifestyle factors, or emotional health
                        concerns.
                      </p>
                    </div>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=men&condition=Low%20Libido",
                    )
                  }
                >
                  Book Appointment →
