...
import ConditionBannerImage from "../../../assets/ConditionImages/MensHealth/Low-Libido.webp";
...
const pageData = {
  badge: "Men's Health",
  heading: "Low Libido",
  description: "Support for changes in sexual desire",
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    ...
                    <p className="condition-block-body">
                      Low libido refers to a reduced interest in sexual activity
                      that may affect relationships, emotional well being, and
                      quality of life. It can be influenced by hormonal changes,
                      stress, medical conditions, medications, lifestyle
                      factors, or emotional health concerns.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get personalized support for low libido with Humancare
                      ...
                      services for symptom evaluation, hormone related health
                      concerns, treatment guidance, and personalized care
                      recommendations. Telehealth services provide convenient
                      access to an experienced online provider who can help
                      identify potential causes of low libido and recommend
                      appropriate strategies to support your sexual health and
                      overall well being.
                    </p>
                  </div>
                  ...
                  <div>
                    <h3 className="condition-block-title">
                      Get Low Libido care in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose Low Libido care",
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=men&condition=Low%20Libido")}>
                Start Consultation →
              </button>
