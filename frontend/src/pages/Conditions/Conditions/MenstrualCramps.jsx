...
import ConditionBannerImage from "../../../assets/ConditionImages/WomensHealth/menstrual-cramps.webp";
...
const pageData = {
  ...
  description: "Painful cramping during periods",
          ...
          <div className="condition-page-layout">
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Menstrual cramps can cause lower abdominal pain, back
                        pain, bloating, fatigue, nausea, and discomfort before or
                        during menstrual cycles that may affect daily activities
                        and overall comfort.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get relief from menstrual cramps with Humancare Connect.
                        ...
                        platform, you can receive symptom evaluation, pain
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Relieve menstrual cramps in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Menstrual Cramps care",
                          "Share your symptoms and menstrual concerns",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=women&condition=Menstrual%20Cramps")}>
                  Start Consultation →
                </button>
