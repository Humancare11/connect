...
import ConditionBannerImage from "../../../assets/ConditionImages/UrineryKidneyHealth/blood-in-urine.webp";
...
const pageData = {
  ...
  heading: "Blood in Urine",
  description: "Pink, red, or dark urine",
...
// ─────────────────────────────────────────────────────────────────
export default function BloodInUrine() {
          ...
          <div className="condition-page-layout">
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Blood in urine can cause pink, red, or brown-colored urine
                        and may be linked to urinary tract infections, kidney
                        stones, bladder conditions, infections, or other
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get prompt care for blood in urine symptoms with Humancare
                        ...
                        treatment guidance, and next-step care recommendations
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get urinary symptom care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose urinary symptom care",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Blood%20in%20Urine")}>
                  Start Consultation →
                </button>
