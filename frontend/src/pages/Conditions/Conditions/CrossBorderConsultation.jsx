...
import ConditionBannerImage from "../../../assets/ConditionImages/TravelHealth/Cross-Border-Consultation.webp";
...
const pageData = {
  badge: "Travel Health",
  heading: "Cross-Border Consultation",
  description: "Healthcare guidance across locations",
...
// ─────────────────────────────────────────────────────────────────
export default function CrossBorderConsultation({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What is cross-border consultation?
                      </h3>
                      <p className="condition-block-body">
                        Cross border consultations provide access to medical
                        guidance for individuals seeking healthcare advice while
                        traveling, living abroad, relocating, or managing health
                        concerns across different countries and healthcare
                        systems.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get convenient access to healthcare support with
                        Humancare Connect. Our telemedicine services make it
                        easy to schedule an online doctor appointment and
                        connect with a licensed provider from wherever you are.
                        Through our secure telemedicine platform, you can access
                        virtual healthcare services for symptom evaluation,
                        treatment guidance, health assessments, and personalized
                        care recommendations. Telehealth services provide
                        convenient access to an experienced online provider who
                        can help you navigate healthcare concerns, discuss
                        treatment options, and support continuity of care across
                        borders.
                      </p>
                    </div>
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get Cross-Border Consultation care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Cross-Border Consultation care",
                          "Share your symptoms, health concerns, and location details",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=travel&condition=Cross-Border%20Consultation",
                    )
                  }
                >
                  Book Appointment →
