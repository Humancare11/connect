        ...
        <div className="condition-page-layout">
              ...
              <div className="condition-about-grid">
                ...
                <div className="condition-about-right">
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get convenient access to healthcare support with Humancare
                      Connect. Our telemedicine services make it easy to
                      schedule an online doctor appointment and connect with a
                      licensed provider from wherever you are. Through our
                      secure telemedicine platform, you can access virtual
                      healthcare services for symptom evaluation, treatment
                      guidance, health assessments, and personalized care
                      recommendations. Telehealth services provide convenient
                      access to an experienced online provider who can help you
                      navigate healthcare concerns, discuss treatment options,
                      and support continuity of care across borders.
                    </p>
                  </div>
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=travel&condition=Cross-Border%20Consultation")}>
                Start Consultation →
              </button>
