...
// ─────────────────────────────────────────────────────────────────
export default function NauseaAndVomiting({ categoryId } = {}) {
                ...
                <div className="condition-about-grid">
                  ...
                  <div className="condition-about-right">
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get quick care for nausea and vomiting symptoms with
                        Humancare Connect. Our telemedicine services help you
                        connect with a licensed provider through a secure online
                        doctor appointment from the comfort of home. Our
                        telemedicine platform offers treatment guidance, symptom
                        management, hydration support, and prescriptions when
                        appropriate without the stress of visiting urgent care.
                      </p>
                    </div>

                    <div>
                      <h3 className="condition-block-title">
                        Feel better faster in 4 easy steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Nausea & Vomiting care",
                          "Answer a few questions about your symptoms",
                          "Connect with an online provider",
                          "Get treatment recommendations and care support",
                        ].map((b) => (
