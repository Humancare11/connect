...
const pageData = {
  badge: "Urgent Care",
  heading: "Whole Family Illnesses",
  description: "Care for illnesses affecting families",
...
// ─────────────────────────────────────────────────────────────────
export default function WholeFamilyIllnesses() {
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    <h3 className="condition-block-title">
                      What are Whole Family Illnesses?
                    </h3>
                    <p className="condition-block-body">
                      Whole family illnesses can include contagious conditions
                      such as colds, flu, respiratory infections, stomach
                      viruses, and other common health concerns that affect
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get convenient care for the whole family with Humancare
                      ...
                      services for symptom evaluation, treatment guidance,
                      recovery recommendations, and prescriptions when
                      appropriate. Telehealth services provide a simple way for
                      families to receive quality care from an experienced
                      online provider without the need for multiple clinic
                      visits.
                    </p>
                  </div>
                  ...
                  <div>
                    <h3 className="condition-block-title">
                      Get Whole-Family Illnesses care in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose whole-family illness care",
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Whole%20Family%20Illnesses")}>
                Start Consultation →
              </button>
