              ...
              <div className="condition-glass-card">
                ...
                <div className="condition-about-grid">
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">What is Rosacea?</h3>
                      <p className="condition-block-body">
                        Rosacea can cause facial redness, flushing, visible blood
                        vessels, bumps, skin sensitivity, and irritation that
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Manage rosacea symptoms with confidence through Humancare
                        ...
                        you can receive personalized skincare guidance, treatment
                        recommendations, and prescriptions when appropriate
                        without the hassle of an in-person dermatology visit.
                      </p>
                    </div>
