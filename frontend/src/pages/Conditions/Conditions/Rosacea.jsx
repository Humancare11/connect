...
// ─────────────────────────────────────────────────────────────────
export default function Rosacea({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Rosacea can cause facial redness, flushing, visible
                        blood vessels, bumps, skin sensitivity, and irritation
                        that commonly affects the cheeks, nose, chin, and
                        forehead.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Manage rosacea symptoms with confidence through
                        ...
                        healthcare services, you can receive personalized
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get rosacea care in 4 simple steps.
                      </h3>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=skin&condition=Ringworm",
                    )
                  }
                >
                  Book Appointment →
