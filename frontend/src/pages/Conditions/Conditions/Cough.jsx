...
// ─────────────────────────────────────────────────────────────────
export default function Cough({ categoryId } = {}) {
              ...
              <div className="condition-glass-card">
                ...
                <div className="condition-about-grid">
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">What is Cough?</h3>
                      <p className="condition-block-body">
                        A cough can cause throat irritation, chest discomfort,
                        mucus buildup, wheezing, and breathing discomfort often
                        linked to colds, flu, allergies, bronchitis, or other
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get cough relief in 4 simple steps.
                      </h3>
