...
// ─────────────────────────────────────────────────────────────────
export default function Vertigo({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Vertigo can cause dizziness, spinning sensations,
                        nausea, balance problems, motion sensitivity, and
                        difficulty standing or walking often related to inner
                        ear or balance disorders.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get fast care for vertigo symptoms with Humancare
                        ...
                        recommendations without the hassle of an in-person
                        visit.
                      </p>
                    </div>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=Vertigo",
                    )
                  }
                >
                  Book Appointment →
