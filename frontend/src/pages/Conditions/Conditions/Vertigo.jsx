...
const pageData = {
  badge: "Urgent Care",
  heading: "Vertigo",
  description: "Spinning sensation and balance issues",
        ...
        <div className="condition-page-layout">
            ...
            <div className="condition-glass-card">
              ...
              <div className="condition-about-grid">
                ...
                <div className="condition-about-right">
                  <div>
                    <h3 className="condition-block-title">What is Vertigo?</h3>
                    <p className="condition-block-body">
                      Vertigo can cause dizziness, spinning sensations, nausea,
                      balance problems, motion sensitivity, and difficulty
                      standing or walking often related to inner ear or balance
                      disorders.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get fast care for vertigo symptoms with Humancare Connect.
                      Our telemedicine services make it easy to book an online
                      ...
                      and personalized care recommendations without the hassle
                  ...
                  <div>
                    <h3 className="condition-block-title">
                      Get vertigo care in 4 simple steps.
                    </h3>
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Vertigo")}>
                Start Consultation →
              </button>
