...
const pageData = {
  badge: "Urgent Care",
  heading: "Migraine",
  description: "Severe headaches with intense pain",
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    ...
                    <p className="condition-block-body">
                      Migraines can cause throbbing head pain, nausea,
                      sensitivity to light or sound, dizziness, and difficulty
                      focusing that may interfere with daily life.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Humancare Connect makes it easier to manage migraine
                      symptoms without leaving home. Our telemedicine services
                      allow you to schedule an online doctor appointment and
                      connect with a licensed provider for personalized
                      treatment options, symptom management, and prescriptions
                      when appropriate through our secure virtual healthcare
                      services.
                    </p>
                  </div>
                  ...
                  <div>
                    <h3 className="condition-block-title">
                      Find migraine relief in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Select Migraine care",
                        "Tell us about your symptoms",
                        "Meet with an online provider",
                        "Receive a treatment plan and ongoing care guidance",
                      ].map((b) => (
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Migraine")}>
                Start Consultation →
              </button>
