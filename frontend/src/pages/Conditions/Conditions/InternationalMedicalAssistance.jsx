...
import ConditionBannerImage from "../../../assets/ConditionImages/TravelHealth/International-Medical-Assistance.webp";
...
const pageData = {
  badge: "Travel Health",
  heading: "International Medical Assistance",
  description: "Medical support while traveling abroad",
...
// ─────────────────────────────────────────────────────────────────
export default function InternationalMedicalAssistance() {
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    ...
                    <p className="condition-block-body">
                      International medical concerns can include illness,
                      infections, prescription needs, travel-related symptoms,
                      medication questions, or unexpected health issues that
                      happen while traveling outside your home country.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get reliable healthcare support wherever you travel with
                      Humancare Connect. Our telemedicine services make it easy
                      to schedule an online doctor appointment and connect with
                      a licensed provider from anywhere. Through our secure
                      virtual healthcare services, you can receive symptom
                      evaluation, treatment guidance, travel health support, and
                      prescriptions when appropriate without the stress of
                      finding local urgent care abroad.
                    </p>
                  </div>

                  <div>
                    <h3 className="condition-block-title">
                      Get international medical support in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose International Medical Assistance care",
                        "Share your symptoms and travel concerns",
                        "Connect with an online provider",
                        "Receive treatment guidance and personalized care support",
                      ].map((b) => (
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=travel&condition=International%20Medical%20Assistance")}>
                Start Consultation →
              </button>
