...
// ─────────────────────────────────────────────────────────────────
export default function KidneyStones({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Kidney stones can cause severe back or side pain,
                        painful urination, nausea, blood in urine, abdominal
                        discomfort, and frequent urges to urinate caused by hard
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get fast support for kidney stone symptoms with
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=Kidney%20Stones",
                    )
                  }
                >
                  Book Appointment →
