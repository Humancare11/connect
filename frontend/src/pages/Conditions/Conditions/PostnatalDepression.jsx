...
// ─────────────────────────────────────────────────────────────────
export default function PostnatalDepression({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Postnatal depression is a mental health condition that
                        can occur after childbirth and may cause persistent
                        sadness, anxiety, mood changes, fatigue, difficulty
                        bonding with a baby, or feelings of being overwhelmed
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        you manage emotional challenges after childbirth and
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=women&condition=Postnatal%20Depression",
                    )
                  }
                >
                  Book Appointment →
