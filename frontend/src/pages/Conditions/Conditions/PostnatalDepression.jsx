...
const pageData = {
  ...
  description: "Support for emotional well being after childbirth",
...
// ─────────────────────────────────────────────────────────────────
export default function PostnatalDepression() {
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    ...
                    <p className="condition-block-body">
                      Postnatal depression is a mental health condition that can
                      occur after childbirth and may cause persistent sadness,
                      anxiety, mood changes, fatigue, difficulty bonding with a
                      baby, or feelings of being overwhelmed that affect daily
                      life and well being.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get compassionate support for postnatal depression with
                      ...
                      services for mental health support, symptom evaluation,
                      treatment guidance, and personalized care recommendations.
                      Telehealth services provide convenient access to an
                      experienced online provider who can help you manage
                      emotional challenges after childbirth and support your
                  ...
                  <div>
                    <h3 className="condition-block-title">
                      Get Postnatal Depression care in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose Postnatal Depression care",
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=women&condition=Postnatal%20Depression")}>
                Start Consultation →
              </button>
