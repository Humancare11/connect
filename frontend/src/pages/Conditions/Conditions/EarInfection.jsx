...
import ConditionBannerImage from "../../../assets/ConditionImages/UrgentCare/Ear-Infection.webp";
...
const pageData = {
  ...
  description: "Pain, pressure, or ear discomfort",
...
// ─────────────────────────────────────────────────────────────────
export default function EarInfection({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Ear infections can cause ear pain, pressure, muffled
                        hearing, drainage, and irritation caused by bacteria,
                        viruses, or fluid buildup.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get fast care for ear infection symptoms with Humancare
                        ...
                        relief, and prescriptions when appropriate without the
                        hassle of an in-person visit.
                      </p>
                    </div>

                    <div>
                      <h3 className="condition-block-title">
                        Get care for your ear infection symptoms in 4 simple
                        steps.
                      </h3>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=Ear%20Infection",
                    )
                  }
                >
                  Book Appointment →
