...
import ConditionBannerImage from "../../../assets/ConditionImages/SkinCondition/Itchy-Skin.webp";
...
const pageData = {
  ...
  heading: "Itchy Skin",
  description: "Persistent itching and skin irritation",
...
// ─────────────────────────────────────────────────────────────────
export default function ItchySkin() {
          ...
          <div className="condition-page-layout">
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Itchy skin can cause dryness, redness, irritation,
                        flaking, bumps, and discomfort often triggered by
                        allergies, eczema, skin sensitivities, infections, or
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get fast relief for itchy skin symptoms with Humancare
                        ...
                        platform, you can receive symptom evaluation, skincare
                        guidance, treatment recommendations, and prescriptions
                        when appropriate without waiting for an in-person visit.
                      </p>
                    </div>

                    <div>
                      <h3 className="condition-block-title">
                        Soothe itchy skin in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Itchy Skin care",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=skin&condition=Itchy%20Skin")}>
                  Start Consultation →
                </button>
