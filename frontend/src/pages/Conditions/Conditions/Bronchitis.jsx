...
import ConditionBannerImage from "../../../assets/ConditionImages/UrgentCare/Bronchitis.webp";
...
const pageData = {
  badge: "Urgent Care",
  heading: "Bronchitis",
  description: "Inflammation causes a persistent cough",
...
// ─────────────────────────────────────────────────────────────────
export default function Bronchitis() {
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    ...
                    <p className="condition-block-body">
                      Bronchitis can cause coughing, chest discomfort, mucus
                      buildup, wheezing, and fatigue often triggered by viral
                      infections or airway irritation.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get fast care for bronchitis symptoms with Humancare
                      ...
                      relief, and prescriptions when appropriate without waiting
                      at urgent care.
                    </p>
                  </div>
                  ...
                  <div>
                    <h3 className="condition-block-title">
                      Get care for your bronchitis symptoms in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose Bronchitis care",
                        "Share your symptoms online",
                        "Connect with a provider through our virtual healthcare services",
                        "Receive treatment, care guidance, and prescriptions if needed",
                      ].map((b) => (
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Bronchitis")}>
                Start Consultation →
              </button>
