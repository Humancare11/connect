...
const pageData = {
  ...
  heading: "Weaning Guidance",
  description: "Support for a smooth transition",
...
// ─────────────────────────────────────────────────────────────────
export default function WeaningGuidance() {
        ...
        <div className="condition-page-layout">
                ...
                <div className="condition-about-right">
                  <div>
                    <h3 className="condition-block-title">
                      What is Weaning Guidance?
                    </h3>
                    <p className="condition-block-body">
                      Weaning guidance helps parents navigate the process of
                      gradually transitioning a baby from breastfeeding or
                      bottle feeding to other sources of nutrition while
                      supporting both infant development and parental well
                      being.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="condition-block-body">
                      Get personalized weaning support with Humancare Connect.
                      ...
                      feeding guidance, nutrition support, developmental
                      recommendations, and personalized care planning.
                      Telehealth services provide convenient access to an
                      experienced online provider who can help answer your
                      questions, address concerns, and create a weaning approach
                  ...
                  <div>
                    <h3 className="condition-block-title">
                      Get Weaning Guidance care in 4 simple steps.
                    </h3>
                    <div className="condition-benefits-grid">
                      {[
                        "Choose Weaning Guidance care",
          ...
          <aside>
            ...
            <div className="condition-sbc">
              ...
              <button className="condition-sbc-cta" onClick={() => navigate("/category-consultant?category=women&condition=Weaning%20Guidance")}>
                Start Consultation →
              </button>
