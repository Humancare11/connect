...
// ─────────────────────────────────────────────────────────────────
export default function BladderProblems({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Bladder problems can cause symptoms such as frequent
                        urination, urgency, leakage, discomfort, difficulty
                        emptying the bladder, or changes in urinary habits that
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get support for bladder problems with Humancare Connect.
                        ...
                        symptom evaluation, treatment guidance, urinary health
                        ...
                        potential causes of bladder concerns and recommend
                        appropriate next steps to support your comfort and
                        overall well being.
                      </p>
                    </div>
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get Bladder Problems care in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Bladder Problems care",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=men&condition=Bladder%20Problems",
                    )
                  }
                >
                  Book Appointment →
