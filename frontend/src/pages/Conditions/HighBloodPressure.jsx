                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        High blood pressure can cause headaches, dizziness,
                        chest discomfort, fatigue, and increased strain on the
                        heart and blood vessels, often without noticeable
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Manage high blood pressure with convenient care through
                        ...
                        secure telemedicine platform, you can receive blood
                        pressure management support, treatment guidance,
                        lifestyle recommendations, and prescriptions when
                        appropriate without the need for frequent office visits.
                      </p>
                    </div>

                    <div>
                      <h3 className="condition-block-title">
                        Manage blood pressure in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose High Blood Pressure care",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=chronic&condition=High%20Blood%20Pressure",
                    )
                  }
                >
                  Start Consultation →
