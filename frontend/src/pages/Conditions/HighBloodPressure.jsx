    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is High Blood Pressure?</h3>
            <p className="sp-block-body">
              High blood pressure can cause headaches, dizziness, chest discomfort, fatigue, and increased strain on the heart and blood vessels, often without noticeable symptoms in the early stages.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Manage high blood pressure with convenient care through Humancare Connect. Our telemedicine services make it easy to schedule an online doctor appointment and connect with a licensed provider from home. Through our secure telemedicine platform, you can receive blood pressure management support, treatment guidance, lifestyle recommendations, and prescriptions when appropriate without the need for frequent office visits.

            </p>
          </div>

          <div>
            <h3 className="sp-block-title">Manage blood pressure in 4 simple steps.</h3>
            <div className="sp-benefits-grid">
              {[
                "Choose High Blood Pressure care", "Share your symptoms and health history",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=chronic&condition=High%20Blood%20Pressure")}>Start Consultation →</button>
