...
import ConditionBannerImage from "../../assets/ConditionImages/RespiratoryHealth/Wheezing.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What is Wheezing?</h3>
            <p className="sp-block-body">
              Wheezing can cause noisy breathing, chest tightness, coughing,
              shortness of breath, and airway irritation often linked to asthma,
              allergies, respiratory infections, or other breathing conditions.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get fast care for wheezing symptoms with Humancare Connect. Our
              ...
              evaluation, breathing care guidance, treatment recommendations,
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Wheezing")}>Start Consultation →</button>
