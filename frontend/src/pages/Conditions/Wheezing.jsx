...
// ─────────────────────────────────────────────────────────────────
export default function Wheezing({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Wheezing can cause noisy breathing, chest tightness,
                        coughing, shortness of breath, and airway irritation
                        often linked to asthma, allergies, respiratory
                        infections, or other breathing conditions.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get fast care for wheezing symptoms with Humancare
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=Wheezing",
                    )
                  }
                >
                  Book Appointment →
