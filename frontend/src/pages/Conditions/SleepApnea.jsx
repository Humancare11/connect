...
import ConditionBannerImage from "../../assets/ConditionImages/ChronicCare/Sleep-Apnea.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Sleep Apnea?</h3>
            <p className="sp-block-body">
              Sleep apnea can cause loud snoring, interrupted breathing, daytime
              fatigue, morning headaches, poor sleep quality, and difficulty
              staying asleep that may affect overall health and energy levels.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Manage sleep apnea symptoms with convenient care through Humancare
              ...
              receive symptom evaluation, sleep health guidance, treatment
              recommendations, and ongoing care support without frequent
              in-person visits.
            </p>
          </div>
          ...
          <div>
            <h3 className="sp-block-title">
              Improve sleep health in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Sleep Apnea care",
                "Share your symptoms and sleep concerns",
  ...
  return (
    <div className="sp-sbc">
      ...
      <button
        ...
        onClick={() =>
          navigate(
            "/category-consultant?category=chronic&condition=Sleep%20Apnea",
          )
        }
      >
        Start Consultation →
