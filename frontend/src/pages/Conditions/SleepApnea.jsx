...
export default function SleepApneas({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Sleep apnea can cause loud snoring, interrupted
                        breathing, daytime fatigue, morning headaches, poor
                        sleep quality, and difficulty staying asleep that may
                        affect overall health and energy levels.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Manage sleep apnea symptoms with convenient care through
                        ...
                        symptom evaluation, sleep health guidance, treatment
                        recommendations, and ongoing care support without
