        ...
        <div className="sp-about-right">
          <div>
            ...
            <p className="sp-block-body">
              Chronic medication management helps monitor long-term medications,
              dosage adjustments, refill needs, treatment effectiveness, side
              effects, and ongoing care for chronic health conditions.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Manage your medications with confidence through Humancare Connect.
              ...
              medication management support, treatment guidance, prescription
              refills, and personalized care recommendations without frequent
              in-person visits.
            </p>
          </div>
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Chronic%20Medication%20Management")}>Start Consultation →</button>
