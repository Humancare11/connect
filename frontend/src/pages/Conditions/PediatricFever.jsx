...
import ConditionBannerImage from "../../assets/ConditionImages/PediatricCare/Pediatric-Fever.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What is Pediatric Fever?</h3>
            <p className="sp-block-body">
              Pediatric fever can cause high temperature, chills, fatigue,
              irritability, poor appetite, body aches, and discomfort in
              children often linked to viral infections, colds, flu, or other
              common illnesses.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get trusted care for your child’s fever with Humancare Connect.
              ...
              symptom evaluation, fever management guidance, treatment
          ...
          <div>
            <h3 className="sp-block-title">
              Get pediatric fever care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Pediatric Fever care",
                "Share your child’s symptoms and temperature details",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=family&condition=Pediatric%20Fever")}>Start Consultation →</button>
