...
// ─────────────────────────────────────────────────────────────────
export default function PediatricFever({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Pediatric fever can cause high temperature, chills,
                        fatigue, irritability, poor appetite, body aches, and
                        discomfort in children often linked to viral infections,
                        colds, flu, or other common illnesses.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get trusted care for your child’s fever with Humancare
                        ...
                        fever management guidance, treatment recommendations,
                        and prescriptions when appropriate without the stress of
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=family&condition=Pediatric%20Fever",
                    )
                  }
                >
                  Book Appointment →
