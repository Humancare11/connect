...
export default function EyeIrritation({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Eye irritation can cause burning, itching, redness,
                        watering, dryness, sensitivity, and discomfort often
                        linked to allergies, infections, screen strain, contact
                        lenses, or environmental irritants.
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="condition-block-body">
                        ...
                        Through our secure virtual healthcare services, you can
                        receive symptom evaluation, treatment guidance, eye care
            ...
            <aside>
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=eeb&condition=Eye%20Irritation",
                    )
                  }
                >
                  Book Appointment →
