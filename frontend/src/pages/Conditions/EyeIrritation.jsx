    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Eye Irritation?</h3>
            <p className="sp-block-body">
              Eye irritation can cause burning, itching, redness, watering,
              dryness, sensitivity, and discomfort often linked to allergies,
              infections, screen strain, contact lenses, or environmental
              irritants.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get fast eye care from home with Humancare Connect. Our
              ...
              evaluation, treatment guidance, eye care recommendations, and
              prescriptions when appropriate without the need for an in-person
              clinic visit.
            </p>
          </div>
          ...
          <div>
            <h3 className="sp-block-title">
              Get eye irritation relief in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Eye Irritation care",
                "Share your symptoms and eye concerns",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=eeb&condition=Eye%20Irritation")}>Start Consultation →</button>
