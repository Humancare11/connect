...
// ─────────────────────────────────────────────────────────────────
export default function LabResultReview({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What is lab result review?
                      </h3>
                      <p className="condition-block-body">
                        Lab result reviews can help explain blood work, urine
                        tests, cholesterol levels, hormone panels, glucose
                        results, infection screenings, and other medical reports
                        that may be difficult to understand on your own.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get clear answers about your lab results with Humancare
                        ...
                        result explanations, treatment guidance, follow-up
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=Lab%20Result%20Review",
                    )
                  }
                >
                  Book Appointment →
