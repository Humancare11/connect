...
import ConditionBannerImage from "../../assets/ConditionImages/PrescriptionsAndContinuityCare/Lab-Result-Review.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What is lab result review?</h3>
            <p className="sp-block-body">
              Lab result reviews can help explain blood work, urine tests,
              cholesterol levels, hormone panels, glucose results, infection
              screenings, and other medical reports that may be difficult to
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get clear answers about your lab results with Humancare Connect.
              ...
              Through our secure telemedicine platform, you can receive
              personalized result explanations, treatment guidance, follow-up
              recommendations, and ongoing care support without the need for an
          ...
          <div>
            <h3 className="sp-block-title">
              Review lab results in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Lab Result Review care",
                "Upload your lab reports and health details",
                "Connect with an online provider",
                "Receive clear explanations and personalized care guidance",
              ].map((b) => (
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Lab%20Result%20Review")}>Start Consultation →</button>
