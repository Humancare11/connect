...
import ConditionBannerImage from "../../assets/ConditionImages/PediatricCare/Pink-Eye-in-Children.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What is Pink Eye in Children?</h3>
            <p className="sp-block-body">
              Pink eye in children can cause redness, itching, watery eyes,
              swelling, irritation, discharge, and discomfort often linked to
              viral infections, bacterial infections, or allergies.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get trusted pediatric eye care from home with Humancare Connect.
              Our telemedicine services make it easy to schedule an online
              doctor appointment and connect with a licensed provider. Through
              our secure virtual healthcare services, you can receive symptom
              evaluation, treatment guidance, and prescriptions when appropriate
              without the hassle of an urgent care visit.
            </p>
          </div>

          <div>
            <h3 className="sp-block-title">
              Get pink eye care for your child in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Pink Eye in Children care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=family&condition=Pink%20Eye%20in%20Children")}>Start Consultation →</button>
