...
// ─────────────────────────────────────────────────────────────────
export default function SwollenFeetAnkles({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What Is Swollen Feet or Ankles?
                      </h3>
                      <p className="condition-block-body">
                        Swollen feet or ankles can cause puffiness, discomfort,
                        tightness, pain, stiffness, and difficulty walking that
                        may be linked to fluid retention, injury, circulation
                        issues, pregnancy, or underlying health conditions.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get convenient care for swollen feet or ankles with
                        ...
                        evaluation, treatment guidance, circulation support, and
