        ...
        <div className="sp-about-right">
          <div>
            ...
            <p className="sp-block-body">
              Food intolerance planning helps identify foods that may trigger
              symptoms such as bloating, stomach discomfort, gas, headaches,
              nausea, or digestive issues. Understanding potential food
              sensitivities can support better nutrition and overall well being.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get personalized support for food intolerance concerns with
              ...
              can access virtual healthcare services for symptom evaluation,
              dietary assessments, nutrition guidance, and personalized care
              recommendations. Telehealth services provide convenient access to
              an experienced online provider who can help identify potential
              food triggers, develop a balanced eating plan, and support your
              long term digestive health goals.
            </p>
          </div>
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Food%20Intolerance%20Planning")}>Start Consultation →</button>
