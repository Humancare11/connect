                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Specialist referrals may be needed for ongoing symptoms,
                        chronic conditions, advanced evaluations, specialized
                        treatments, or medical concerns that require care from a
                        specialist provider.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get connected to the right care through Humancare
                        ...
                        referral guidance, treatment recommendations, and
                        ongoing care support without the hassle of an in-person
                        clinic visit.
                      </p>
                    </div>
            ...
            <aside>
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=Specialist%20Referral",
                    )
                  }
                >
                  Start Consultation →
