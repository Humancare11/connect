...
import ConditionBannerImage from "../../assets/ConditionImages/PrescriptionsAndContinuityCare/Specialist-Referral.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What is a specialist referral?</h3>
            <p className="sp-block-body">
              Specialist referrals may be needed for ongoing symptoms, chronic
              conditions, advanced evaluations, specialized treatments, or
              medical concerns that require care from a specialist provider.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get connected to the right care through Humancare Connect. Our
              ...
              symptom evaluation, referral guidance, treatment recommendations,
              and ongoing care support without the hassle of an in-person clinic
              visit.
            </p>
          </div>
          ...
          <div>
            <h3 className="sp-block-title">
              Get specialist referral support in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Specialist Referral care",
                "Share your symptoms and medical concerns",
                "Connect with an online provider",
                "Receive referral guidance and personalized care support",
              ].map((b) => (
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Specialist%20Referral")}>Start Consultation →</button>
