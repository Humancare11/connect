                ...
                <div className="sp-about-right">
                    <div>
                        ...
                        <p className="sp-block-body">
                            Arthritis can cause joint pain, stiffness, swelling, inflammation, reduced flexibility, and discomfort that may affect the knees, hands, hips, back, and other joints over time.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="sp-block-body">
                            Manage arthritis symptoms more comfortably with Humancare Connect. Our telemedicine services make it easy to schedule an online doctor appointment and connect with a licensed provider from home. Through our secure virtual healthcare services, you can receive symptom evaluation, pain management guidance, treatment recommendations, and prescriptions when appropriate without the hassle of frequent in-person visits.

                        </p>
                    </div>

                    <div>
                        <h3 className="sp-block-title">Manage arthritis pain in 4 simple steps.
                        Earlier disease detection</h3>
                        <div className="sp-benefits-grid">
                            {[
                                "Choose Arthritis care", "Share your symptoms and joint concerns",
