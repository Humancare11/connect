...
export default function Arthritis({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Arthritis can cause joint pain, stiffness, swelling,
                        inflammation, reduced flexibility, and discomfort that
                        may affect the knees, hands, hips, back, and other
                        joints over time.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Manage arthritis symptoms more comfortably with
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Manage arthritis pain in 4 simple steps. Earlier disease
                        detection
                      </h3>
            ...
            <aside>
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=chronic&condition=Arthritis",
                    )
                  }
                >
                  Book Appointment →
