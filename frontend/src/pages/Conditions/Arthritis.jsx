    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Arthritis?</h3>
            <p className="sp-block-body">
              Arthritis can cause joint pain, stiffness, swelling, inflammation,
              reduced flexibility, and discomfort that may affect the knees,
              hands, hips, back, and other joints over time.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Manage arthritis symptoms more comfortably with Humancare Connect.
              ...
              symptom evaluation, pain management guidance, treatment
              recommendations, and prescriptions when appropriate without the
              hassle of frequent in-person visits.
            </p>
          </div>

          <div>
            <h3 className="sp-block-title">
              Manage arthritis pain in 4 simple steps. Earlier disease detection
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Arthritis care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=chronic&condition=Arthritis")}>Start Consultation →</button>
