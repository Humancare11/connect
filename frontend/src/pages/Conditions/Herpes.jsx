...
import ConditionBannerImage from "../../assets/ConditionImages/SexualHealth/Herpes.webp";
...
// ─────────────────────────────────────────────────────────────────
export default function Herpes({ categoryId } = {}) {
              ...
              <div className="condition-glass-card">
                ...
                <div className="condition-about-grid">
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">What is Herpes?</h3>
                      <p className="condition-block-body">
                        Herpes can cause painful blisters, sores, itching,
                        burning, irritation, and discomfort around the mouth or
                        genital area caused by the herpes simplex virus (HSV).
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get discreet and confidential herpes care with Humancare
                        ...
                        evaluation, treatment guidance, outbreak management
                        support, and prescriptions when appropriate without the
                        stress of an in-person clinic visit.
                      </p>
                    </div>
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=sexual&condition=Herpes",
                    )
                  }
                >
                  Book Appointment →
