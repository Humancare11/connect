...
//
// NOTE: The pre-migration file had no local ConditionBannerImage import
// at all — it used a hardcoded Unsplash URL directly. There is no local
// asset to fall back to here, so the original hardcoded URL is preserved
// as-is — see migration report.
// ─────────────────────────────────────────────────────────────────
const pageData = {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Medical certificates may be required for work, school,
                        travel, recovery, illness verification, fitness
                        clearance, or other health-related documentation needs
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get convenient medical certificate support with
                        ...
                        medical evaluations, treatment guidance, and
                        documentation support when appropriate without the need
                    ...
                    <div>
                      <h3 className="condition-block-title">
                        Get medical documentation in 4 simple steps.
                      </h3>
                      <div className="condition-benefits-grid">
                        {[
                          "Choose Medical Certificate care",
                          "Share your medical concerns and requirements",
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=Medical%20Certificate",
                    )
                  }
                >
                  Book Appointment →
