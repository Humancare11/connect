    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What is a Medical Certificate?</h3>
            <p className="sp-block-body">
              Medical certificates may be required for work, school, travel,
              recovery, illness verification, fitness clearance, or other
              health-related documentation needs after a medical evaluation.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get convenient medical certificate support with Humancare Connect.
              ...
              medical evaluations, treatment guidance, and documentation support
              when appropriate without the need for an in-person clinic visit.
            </p>
          </div>
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Medical%20Certificate")}>Start Consultation →</button>
