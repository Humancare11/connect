    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What is a Prescription Refill?</h3>
            <p className="sp-block-body">
              Prescription refill needs can happen when medications run low,
              prescriptions expire, travel interrupts access to care, or ongoing
              treatment requires continued medication support.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get fast and convenient prescription refill support with Humancare
              ...
              receive medication refill guidance, treatment support, and
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Prescription%20Refill")}>Start Consultation →</button>
