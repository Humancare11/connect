...
import ConditionBannerImage from "../../assets/ConditionImages/ChronicCare/Treatment-Plan-Reviews.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is a Treatment Plan Review?</h3>
            <p className="sp-block-body">
              A treatment plan review helps evaluate current medications,
              therapies, lifestyle recommendations, and medical care strategies
              to ensure they align with your diagnosis, health goals, and
              overall well being.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get expert guidance on your current care plan with Humancare
              ...
              access virtual healthcare services for treatment evaluations,
              medication reviews, symptom assessments, and personalized care
              recommendations. Telehealth services provide convenient access to
              an experienced online provider who can review your existing
              treatment plan, answer your questions, and help determine whether
              adjustments or additional options may be beneficial.
            </p>
          </div>

          <div>
            <h3 className="sp-block-title">
              Get Treatment Plan Review care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Treatment Plan Review care",
                "Share your diagnosis, treatment plan, and concerns",
  ...
  return (
    <div className="sp-sbc">
      ...
      <button
        ...
        onClick={() =>
          navigate(
            "/category-consultant?category=chronic&condition=Treatment%20Plan%20Review",
          )
        }
      >
        Start Consultation →
