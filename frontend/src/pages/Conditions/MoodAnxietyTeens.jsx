    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What is Mood & Anxiety in Teens?</h3>
            <p className="sp-block-body">
              Mood and anxiety concerns in teens can include persistent sadness,
              excessive worry, irritability, stress, social challenges, changes
              in behavior, difficulty concentrating, or emotional struggles that
              affect daily life, school performance, and relationships.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get compassionate support for teen mental health with Humancare
              ...
              access virtual healthcare services for emotional wellness support,
              symptom evaluation, coping strategies, and personalized care
              recommendations. Telehealth services provide convenient access to
              an experienced online provider who can help teens manage mood and
              anxiety concerns, build healthy coping skills, and support overall
