                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Bloating can cause stomach fullness, tightness, gas,
                        abdominal pressure, cramping, and digestive discomfort
                        often linked to diet, indigestion, constipation, IBS, or
                        food sensitivities.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Find relief from bloating symptoms with Humancare
                        ...
                        symptom evaluation, treatment recommendations, and
            ...
            <aside>
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=Bloating",
                    )
                  }
                >
                  Start Consultation →
