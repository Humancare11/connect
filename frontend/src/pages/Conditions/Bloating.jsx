    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Bloating?</h3>
            <p className="sp-block-body">
              Bloating can cause stomach fullness, tightness, gas, abdominal
              pressure, cramping, and digestive discomfort often linked to diet,
              indigestion, constipation, IBS, or food sensitivities.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Find relief from bloating symptoms with Humancare Connect. Our
              telemedicine services make it easy to book an online doctor
              appointment and connect with a licensed provider from home.
              Through our secure telemedicine platform, you can receive
              digestive health guidance, symptom evaluation, treatment
          ...
          <div>
            <h3 className="sp-block-title">
              Relieve bloating symptoms in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Bloating care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Bloating")}>Start Consultation →</button>
