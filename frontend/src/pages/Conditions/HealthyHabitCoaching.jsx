...
// ─────────────────────────────────────────────────────────────────
export default function HealthyHabitCoaching({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">
                        What Is Healthy Habit Coaching?
                      </h3>
                      <p className="condition-block-body">
                        Healthy habit coaching helps individuals develop
                        positive lifestyle behaviors that support physical
                        health, mental well being, and long term wellness.
                        Common focus areas include nutrition, exercise, sleep,
                        stress management, and daily self care practices.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Create lasting healthy habits with Humancare Connect.
                        ...
                        lifestyle assessments, wellness coaching, goal setting,
                        and personalized care recommendations. Telehealth
                        services provide convenient access to an experienced
                        online provider who can help you build healthier
                        routines, stay motivated, and achieve your long term
