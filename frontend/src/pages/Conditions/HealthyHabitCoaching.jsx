...
import ConditionBannerImage from "../../assets/ConditionImages/DigestiveCareHealthy-Habit-Coaching.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Healthy Habit Coaching?</h3>
            <p className="sp-block-body">
              Healthy habit coaching helps individuals develop positive
              lifestyle behaviors that support physical health, mental well
              being, and long term wellness. Common focus areas include
              nutrition, exercise, sleep, stress management, and daily self care
              practices.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Create lasting healthy habits with Humancare Connect. Our
              ...
              healthcare services for lifestyle assessments, wellness coaching,
              goal setting, and personalized care recommendations. Telehealth
              services provide convenient access to an experienced online
              provider who can help you build healthier routines, stay
              motivated, and achieve your long term health and wellness goals.
            </p>
          </div>

          <div>
            <h3 className="sp-block-title">
              Get Healthy Habit Coaching care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Healthy Habit Coaching care",
                "Share your health goals, lifestyle habits, and concerns",
  ...
  return (
    <div className="sp-sbc">
      ...
      <button
        ...
        onClick={() =>
          navigate(
            "/category-consultant?category=general&condition=Healthy%20Habit%20Coaching",
          )
        }
      >
        Start Consultation →
