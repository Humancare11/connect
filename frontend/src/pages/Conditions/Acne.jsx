...
import ConditionBannerImage from "../../assets/ConditionImages/SkinCondition/Acne.webp";
...
// ─────────────────────────────────────────────────────────────────
export default function Acne({ categoryId } = {}) {
              ...
              <div className="condition-glass-card">
                ...
                <div className="condition-about-grid">
                  ...
                  <div className="condition-about-right">
                    <div>
                      <h3 className="condition-block-title">What is Acne?</h3>
                      <p className="condition-block-body">
                        Acne can cause pimples, blackheads, whiteheads, redness,
                        inflammation, and skin irritation often triggered by
                        hormones, stress, bacteria, or clogged pores.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Get personalized acne care with Humancare Connect from
                        the comfort of home. Our telemedicine services make it
                        easy to book an online doctor appointment and connect
                        with a licensed provider for treatment plans, skincare
                        guidance, and prescriptions when appropriate through our
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=skin&condition=Acne",
                    )
                  }
                >
                  Book Appointment →
