...
import ConditionBannerImage from "../../assets/ConditionImages/PediatricCare/Vomiting-and-Diarrhea-in-Children.webp";
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">
              What is Vomiting and Diarrhea in Children?
            </h3>
            <p className="sp-block-body">
              Vomiting and diarrhea in children can cause stomach cramps,
              dehydration, fever, nausea, fatigue, weakness, and digestive
              discomfort often linked to viral infections, food poisoning, or
              stomach bugs.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get trusted pediatric care from home with Humancare Connect. Our
              telemedicine services make it easy to schedule an online doctor
              appointment and connect with a licensed provider. Through our
              secure virtual healthcare services, you can receive symptom
              evaluation, hydration guidance, treatment recommendations, and
              prescriptions when appropriate without the stress of an urgent
              care visit.
            </p>
          </div>
          ...
          <div>
            <h3 className="sp-block-title">
              Get digestive care for your child in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Vomiting and Diarrhea in Children care",
                "Share your child’s symptoms and health concerns",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=family&condition=Vomiting%20and%20Diarrhea%20in%20Children")}>Start Consultation →</button>
