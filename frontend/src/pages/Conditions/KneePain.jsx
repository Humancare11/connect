    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What Is Knee Pain?</h3>
            <p className="sp-block-body">
              Knee pain can result from injuries, overuse, arthritis,
              inflammation, or other joint conditions. Symptoms may include
              aching, stiffness, swelling, instability, reduced mobility, or
              discomfort that affects walking, exercise, and daily activities.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Get support for knee pain with Humancare Connect. Our telemedicine
              services make it easy to schedule an online doctor appointment and
              connect with a licensed provider from home. Through our secure
              telemedicine platform, you can access virtual healthcare services
              for symptom evaluation, treatment recommendations, pain management
              guidance, and personalized care planning. Telehealth services
              provide convenient access to an experienced online provider who
              can assess your symptoms, discuss possible causes, and recommend
              appropriate next steps to help improve mobility and support joint
              health.
            </p>
          </div>
          ...
          <div>
            <h3 className="sp-block-title">
              Get Knee Pain care in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Knee Pain care",
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=eeb&condition=Knee%20Pain")}>Start Consultation →</button>
