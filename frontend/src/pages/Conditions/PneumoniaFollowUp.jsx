...
import ConditionBannerImage from "../../assets/ConditionImages/RespiratoryHealth/Pneumonia-Follow-Up.webp";
    ...
    <div className="sp-glass-card">
      ...
      <div className="sp-about-grid">
        ...
        <div className="sp-about-right">
          <div>
            <h3 className="sp-block-title">What is Pneumonia Follow-Up?</h3>
            <p className="sp-block-body">
              Pneumonia follow-up care helps monitor lingering symptoms like
              coughing, fatigue, chest discomfort, shortness of breath, and
              breathing issues after a recent pneumonia infection or treatment.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="sp-block-body">
              Stay on track with your recovery through Humancare Connect. Our
              ...
              follow-up evaluations, breathing care guidance, recovery support,
              and treatment recommendations without the hassle of another clinic
              visit.
            </p>
          </div>
          ...
          <div>
            <h3 className="sp-block-title">
              Continue your recovery in 4 simple steps.
            </h3>
            <div className="sp-benefits-grid">
              {[
                "Choose Pneumonia Follow-Up care",
                "Share your symptoms and recovery concerns",
                "Connect with an online provider",
                "Receive follow-up care and recovery guidance",
              ].map((b) => (
...
function StickyBookingCard() {
  ...
  return (
    <div className="sp-sbc">
      ...
      <button className="sp-sbc-cta" onClick={() => navigate("/category-consultant?category=general&condition=Pneumonia%20Follow-Up")}>Start Consultation →</button>
