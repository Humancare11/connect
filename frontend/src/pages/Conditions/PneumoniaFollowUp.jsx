...
// ─────────────────────────────────────────────────────────────────
export default function PneumoniaFollowUp({ categoryId } = {}) {
                  ...
                  <div className="condition-about-right">
                    <div>
                      ...
                      <p className="condition-block-body">
                        Pneumonia follow-up care helps monitor lingering
                        symptoms like coughing, fatigue, chest discomfort,
                        shortness of breath, and breathing issues after a recent
                        pneumonia infection or treatment.
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="condition-block-body">
                        Stay on track with your recovery through Humancare
                        ...
                        telemedicine platform, you can receive follow-up
                        evaluations, breathing care guidance, recovery support,
                        and treatment recommendations without the hassle of
            ...
            <aside>
              ...
              <div className="condition-sbc">
                ...
                <button
                  ...
                  onClick={() =>
                    navigate(
                      "/category-consultant?category=general&condition=Pneumonia%20Follow-Up",
                    )
                  }
                >
                  Book Appointment →
