  ...
  },
  {
    ...
    text: (
      <>
        ...
        <a href="mailto:support@humancareconnect.co" className="text-blue-600 hover:underline">
    ...
    <div style={{ width: "100%", minHeight: "100vh", background: "#f1f5f9", fontFamily: "system-ui, -apple-system, sans-serif", boxSizing: "border-box" }}>
      ...
      <div style={{ width: "100%", background: "#fff", borderBottom: "1px solid #e2e8f0" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "28px 28px"}}>
          ...
          <h1 style={{ fontSize: "26px", fontWeight: 700, color: "#0f172a", margin: "15px 0 4px", letterSpacing: "-0.02em" }}>California Consumer Privacy Act (CCPA) California Privacy Rights Notice</h1>
...
>
  This California Privacy Rights Notice applies to California residents and
  supplements our Privacy Policy in accordance with the California Consumer
  Privacy Act (CCPA), California Privacy Rights Act (CPRA), and CalOPPA.
</div>
  ...
  <p style={{ color: "#64748b", lineHeight: 1.8 }}>
    It explains your rights regarding personal information, how we collect,
    use, disclose, and protect that information, and how you may exercise
    those rights.
  </p>
  ...
  >
    <strong>Important:</strong> Certain information classified as Protected
    Health Information (PHI) under HIPAA is exempt from CCPA requirements.
  </div>
</SectionCard>
  ...
  <p style={{ color: "#64748b", lineHeight: 1.9 }}>
    • Providing and operating telehealth services<br />
    • Processing payments and managing accounts<br />
    • Verifying provider credentials<br />
    • Communicating service-related information<br />
    • Improving Platform functionality and performance<br />
    • Detecting fraud and security threats<br />
  ...
  >
    We do not sell personal information and do not use personal information
    for behavioral advertising.
  </div>
</SectionCard>

          {/* Managing Preferences */}
         <SectionCard icon={ShieldAlert} title="Disclosure of Personal Information">
  <p style={{ color: "#64748b", lineHeight: 1.9 }}>
    We may disclose personal information to:
  </p>

  <p style={{ color: "#64748b", lineHeight: 1.9 }}>
    • Service providers such as payment processors, communication platforms,
    and cloud infrastructure providers<br />
    • Healthcare providers facilitating consultations<br />
    • Law enforcement or government agencies when required by law
  </p>

  <p style={{ color: "#64748b", lineHeight: 1.8 }}>
    We do not sell personal information and do not share personal information
...
<SectionCard icon={Lock} title="Your California Privacy Rights">
  <p style={{ color: "#64748b", lineHeight: 1.9 }}>
    • Right to Know what information we collect and disclose<br />
    • Right to Delete personal information (subject to legal exceptions)<br />
    • Right to Correct inaccurate information<br />
    • Right to Opt-Out of Sale or Sharing (not applicable because we do not sell data)<br />
    • Right to Limit Use of Sensitive Personal Information<br />
...
<SectionCard icon={ShieldCheck} title="HIPAA Exemption">
  <p style={{ color: "#64748b", lineHeight: 1.8 }}>
    Personal information that constitutes Protected Health Information (PHI)
    under HIPAA is exempt from CCPA.
  </p>

  <p style={{ color: "#64748b", lineHeight: 1.8 }}>
    Health information created, received, or maintained in connection with
    medical consultations is governed by HIPAA rather than CCPA.
  </p>
</SectionCard>
{/*  */}
<SectionCard icon={FileSignature} title="How to Exercise Your Rights">
  ...
  <p style={{ color: "#64748b", lineHeight: 1.9 }}>
    • Email: support@humancareconnect.co<br />
    • Subject Line: "California Privacy Request"<br />
    • Include your full name, account email, and request details
  </p>

  <p style={{ color: "#64748b", lineHeight: 1.8 }}>
    We will verify your identity before processing requests and generally
...
<SectionCard icon={Scale} title="Authorized Agents">
  ...
  <p style={{ color: "#64748b", lineHeight: 1.8 }}>
    The authorized agent must provide written permission signed by you, and
    we may require identity verification before processing the request.
  </p>
</SectionCard>
{/*  */}
<SectionCard icon={AlertTriangle} title="Shine the Light">
  <p style={{ color: "#64748b", lineHeight: 1.8 }}>
    ...
    request information regarding disclosure of personal information for
    direct marketing purposes.
  </p>

  <p style={{ color: "#64748b", lineHeight: 1.8 }}>
    We do not disclose personal information to third parties for direct
    marketing purposes.
  </p>
</SectionCard>
{/*  */}
  ...
  <p style={{ color: "#64748b", lineHeight: 1.8 }}>
    Our Platform currently does not respond to browser Do Not Track (DNT)
    signals.
  </p>

  <p style={{ color: "#64748b", lineHeight: 1.8 }}>
    Please refer to our Cookie Policy for additional information regarding
...
<SectionCard icon={RefreshCw} title="Updates">
  <p style={{ color: "#64748b", lineHeight: 1.8 }}>
    We review and update this California Privacy Rights Notice at least once
    every 12 months.
  </p>
