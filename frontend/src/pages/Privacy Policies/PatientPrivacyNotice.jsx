        ...
        <div style={{ width: "100%", minHeight: "100vh", background: "#f1f5f9", fontFamily: "system-ui, -apple-system, sans-serif", boxSizing: "border-box" }}>
            ...
            <div style={{ width: "100%", background: "#fff", borderBottom: "1px solid #e2e8f0" }}>
                <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "28px 150px" }}>
                    ...
                    <h1 style={{ fontSize: "26px", fontWeight: 700, color: "#0f172a", margin: "15px 0 4px", letterSpacing: "-0.02em" }}>Patient Privacy Notice</h1>
            ...
            <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
                <div style={{ width: "100%", maxWidth: "750px", padding: "36px 24px 60px", display: "flex", flexDirection: "column", gap: "16px" }}>
                    ...
                    <SectionCard icon={ShieldAlert} title="How We Use Your Information">
                        ...
                        <ul>
                            <li>• Treatment: to facilitate teleconsultations, issue prescriptions, sick notes, fit-to-fly certificates, and other medical documentation</li>
                            <li>• Program delivery: to provide mental health, sexual health, and weight loss programs</li>
                            <li>• Operations: for appointment scheduling, case coordination, and platform administration</li>
                            <li>• Legal compliance: to comply with applicable laws including HIPAA, GDPR, and other applicable regulations</li>
                            <li>• Safety: to protect the safety of patients, doctors, and the public in emergency situations</li>
                        </ul>
                        <p style={{ fontSize: "14px", color: "#64748b", lineHeight: 1.8, margin: 0 }}>
                            We do not use your PHI for marketing, advertising, or sale to third parties.
                        </p>
                    </SectionCard>
                    ...
                    <SectionCard icon={Share2} title="How We Share Your Information">
                        ...
                        >
                            <strong style={{ color: "#1e40af" }}>
                                We never share your PHI with WhatsApp, social media, AI tools, or any
                                unapproved platform.
                            </strong>
                        </div>
                    </SectionCard>
                    ...
                    <SectionCard icon={Database} title="Data Retention">
                        <p style={{ color: "#64748b", lineHeight: 1.8, margin: 0 }}>
                            We retain your PHI for a minimum of 6 years from the date of creation or
                            last activity, as required by HIPAA (45 CFR 164.316). Longer retention
                            periods may apply based on applicable state or national law. After the
                            retention period, data is securely deleted using industry-standard methods.
                        </p>
                    </SectionCard>
                    ...
                    <SectionCard icon={Globe} title="International Data Transfers">
                        <p style={{ color: "#64748b", lineHeight: 1.8, margin: 0 }}>
                            Humancare Connect serves patients globally including the United States,
                            Europe, and the Middle East. If you are located in the European Economic
                            Area (EEA), your data may be transferred to and processed in the United
                            States. We ensure appropriate safeguards are in place for such transfers in
                            compliance with GDPR requirements.
                        </p>
                    </SectionCard>

                    {/* GDPR Rights */}
                    <SectionCard icon={FileCheck} title="GDPR — Additional Rights for EU/EEA Patients">
                        <p style={{ color: "#64748b", lineHeight: 1.8 }}>
                            If you are located in the EU or EEA, you have additional rights under the
                            General Data Protection Regulation (GDPR). Our legal basis for processing
                            your health data is Article 9(2)(h) GDPR (medical treatment purposes) and
                    ...
                    <SectionCard icon={Bell} title="Breach Notification">
                        <p style={{ color: "#64748b", lineHeight: 1.8, margin: 0 }}>
                            In the event of a data breach affecting your PHI, we will notify you in
                            accordance with HIPAA Breach Notification Rule requirements (within 60 days
                            of discovery) and GDPR requirements (within 72 hours to supervisory
                            authority where required). We will inform you of the nature of the breach,
                            data affected, and steps taken.
                        </p>
                    </SectionCard>
                    ...
                    <SectionCard icon={Stethoscope} title="Telehealth Disclaimer">
                        <p style={{ color: "#64748b", lineHeight: 1.8 }}>
                            Humancare Connect provides telehealth services for non-emergency medical
                            consultations only.
                        </p>
                        ...
                        >
                            Our platform is NOT a substitute for emergency medical care. If you are
                            experiencing a medical emergency, please call your local emergency services
                            immediately (911 in the USA).
                        </div>
                    </SectionCard>
                    ...
                    <SectionCard icon={UserCheck} title="Minimum Age">
                        <p style={{ color: "#64748b", lineHeight: 1.8 }}>
                            Our services are available to individuals aged 18 years and older only. We
                            do not knowingly collect PHI from minors. If you believe a minor has used
                            our services, please contact us immediately at
                            support@humancareconnect.co.
                        </p>
                    </SectionCard>
                    ...
                    <SectionCard icon={RefreshCw} title="Changes to This Notice">
                        <p style={{ color: "#64748b", lineHeight: 1.8 }}>
                            We may update this Privacy Notice periodically. We will notify you of
                            material changes by email or through the platform. The effective date at
                            the top of this notice reflects the most recent update.
                        </p>
                    </SectionCard>
