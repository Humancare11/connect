...
export default function PrivacyPolicy() {
    ...
    <div style={{ width: "100%", minHeight: "100vh", background: "#f1f5f9", fontFamily: "system-ui, -apple-system, sans-serif", boxSizing: "border-box" }}>
      ...
      <div style={{ width: "100%", background: "#fff", borderBottom: "1px solid #e2e8f0" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "28px 28px" }}>
          ...
          <h1 style={{ fontSize: "32px", fontWeight: 700, color: "#0f172a", margin: "15px 0 4px", }} >
            Privacy Policy
          </h1>
      ...
      <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
        <div style={{ width: "100%", maxWidth: "750px", padding: "36px 24px 60px", display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          {/* Notice */}
          <div
            style={{ background: "#eff6ff", border: "1px solid #bfdbfe", borderRadius: "14px", padding: "18px 22px", fontSize: "14px", color: "#1e40af", lineHeight: 1.7, }} >
          ...
          <SectionCard icon={ShieldCheck} title="1. Introduction">
            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              Humancare Connect, Inc. ("Humancare Connect," "we," "us," or "our")
              operates the telehealth platform at humancareworldwide.com and its
              associated mobile and web applications (collectively, the "Platform").
            </p>
          ...
          <SectionCard icon={Database} title="2. Information We Collect">
            ...
            <ul>
              <li>• Account registration information: name, email, DOB, phone number and password</li>
              <li>• Patient health information including symptoms, conditions, medications and medical history</li>
          ...
          {/* Section Card 3 */}
          <SectionCard icon={ShieldAlert} title="3. How We Use Your Information">
            <ul>
          ...
          {/* PHI and HIPAA */}
          <SectionCard icon={Lock} title="4. Protected Health Information (PHI) and HIPAA">
            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
  ...
  <ul>
    ...
    <li>• With service providers under BAAs and data processing agreements</li>
...
<SectionCard icon={Database} title="6. Data Retention">
  <p style={{ color: "#64748b", lineHeight: 1.8 }}>
    Medical records are retained for a minimum of 7 years from the date
    of last service, or longer where required by law.
  </p>
  ...
  <p style={{ color: "#64748b", lineHeight: 1.8 }}>
    ...
    privacy@humancareconnect.co
  </p>
</SectionCard>
{/* cookies */}
<SectionCard icon={SlidersHorizontal} title="7. Cookies and Tracking Technologies">
  <ul>
    <li>• Essential Cookies - Authentication and session management</li>
...
<SectionCard icon={ShieldAlert} title="8. Data Security">
  ...
  <p style={{ color: "#64748b", lineHeight: 1.8 }}>
    While we implement strong safeguards, no method of transmission over
...
{/*  */}
<SectionCard icon={ShieldCheck} title="10. California Privacy Rights (CCPA)">
  <p>California residents may exercise rights under the CCPA. Humancare Connect does not sell personal information.</p>
</SectionCard>
...
<SectionCard icon={ShieldCheck} title="12. Third-Party Links">
  <p>We are not responsible for privacy practices of third-party websites linked from our Platform.</p>
</SectionCard>
...
<SectionCard icon={RefreshCw} title="14. Changes to This Policy">
  <p>We may update this Privacy Policy periodically. Continued use of the Platform constitutes acceptance of changes.</p>
</SectionCard>
{/* Contact us  */}
