        ...
        <div style={{ width: "100%", minHeight: "100vh", background: "#f1f5f9", fontFamily: "system-ui, -apple-system, sans-serif", boxSizing: "border-box" }}>
            ...
            <div style={{ width: "100%", background: "#fff", borderBottom: "1px solid #e2e8f0" }}>
                <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "28px 28px" }}>
                    ...
                    <h1 style={{ fontSize: "26px", fontWeight: 700, color: "#0f172a", margin: "15px 0 4px", letterSpacing: "-0.02em" }}>NOTICE OF PRIVACY PRACTICES </h1>
            ...
            <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
                <div style={{ width: "100%", maxWidth: "750px", padding: "36px 24px 60px", display: "flex", flexDirection: "column", gap: "16px" }}>
                    ...
                    >
                        We are required by HIPAA and applicable federal and state laws to protect
                    ...
                    <SectionCard icon={ShieldCheck} title="Our Legal Duty">
                        <p style={{ color: "#64748b", lineHeight: 1.8 }}>
                            ...
                            Information (PHI), provide you with this Notice of our privacy practices,
                            and follow the terms currently in effect.
                        </p>

                        <p style={{ color: "#64748b", lineHeight: 1.8 }}>
                            We are required by the Health Insurance Portability and Accountability
                            Act of 1996 (HIPAA) and applicable federal and state laws to safeguard
                            your health information.
                        </p>
                    </SectionCard>
                    {/* for treatment */}
                    <SectionCard icon={Stethoscope} title="Use and Disclosure for Treatment">
                        <p style={{ color: "#64748b", lineHeight: 1.8 }}>
                            We may use or disclose your health information to provide, coordinate,
                            or manage your healthcare and related services.
                        </p>

                        <p style={{ color: "#64748b", lineHeight: 1.8 }}>
                            For example, information may be shared with physicians providing medical
                            consultations, second opinions, or healthcare providers involved in your
                            care.
                        </p>
                    </SectionCard>
                    ...
                    <SectionCard icon={CreditCard} title="Use and Disclosure for Payment">
                        <p style={{ color: "#64748b", lineHeight: 1.8 }}>
                            We may use or disclose your health information to process payments for
                            services provided to you.
                        </p>

                        <p style={{ color: "#64748b", lineHeight: 1.8 }}>
                            This may include sharing information with payment processors and billing
                            partners as necessary to complete transactions.
                        </p>
                    </SectionCard>
                    ...
                    <SectionCard icon={FileText} title="Other Permitted Uses and Disclosures">
                        <p style={{ color: "#64748b", lineHeight: 1.9 }}>
                            • As required by law, including court orders and subpoenas<br />
                            • Public health reporting and disease prevention activities<br />
                            • Government audits, inspections, and investigations<br />
                            • Law enforcement requests permitted by law<br />
                            • Preventing serious threats to health or safety<br />
                            • Business associates performing services on our behalf under HIPAA agreements
                        </p>
                    </SectionCard>
                    {/* uses requiring */}
                    <SectionCard icon={FileSignature} title="Uses and Disclosures Requiring Authorization">
                        <p style={{ color: "#64748b", lineHeight: 1.9 }}>
                            We will obtain your written authorization before:
                        </p>

                        <p style={{ color: "#64748b", lineHeight: 1.9 }}>
                            • Using or disclosing psychotherapy notes<br />
                            • Marketing activities involving PHI<br />
                            • Sale of PHI<br />
                            • Any use not otherwise described in this Notice
                        </p>

                        <p style={{ color: "#64748b", lineHeight: 1.8 }}>
                            You may revoke authorization at any time in writing, except where we
                            have already relied on it.
                        </p>
                    </SectionCard>
                    {/* your rights  */}
                    <SectionCard icon={Lock} title="Your Rights Regarding Health Information">
                        <p style={{ color: "#64748b", lineHeight: 1.9 }}>
                            • Right to access your records<br />
                            • Right to request amendments<br />
                            • Right to an accounting of disclosures<br />
                            • Right to request restrictions<br />
                            • Right to confidential communications<br />
                    ...
                    <SectionCard icon={Bell} title="Right to Be Notified of Breaches">
                        <p style={{ color: "#64748b", lineHeight: 1.8 }}>
                            We are required by law to notify you if we discover a breach involving
                    ...
                    <SectionCard icon={AlertTriangle} title="Changes to This Notice">
                        <p style={{ color: "#64748b", lineHeight: 1.8 }}>
                            We reserve the right to modify this Notice and make revised provisions
                            effective for all health information we maintain.
                        </p>

                        <p style={{ color: "#64748b", lineHeight: 1.8 }}>
                            Updated versions will be posted on our website and made available upon
                            request.
                        </p>
                    </SectionCard>
                    {/* complaint */}
                    <SectionCard icon={Scale} title="How to File a Complaint">
                        ...
                        >
                            <p><strong>Federal Office for Civil Rights</strong></p>
