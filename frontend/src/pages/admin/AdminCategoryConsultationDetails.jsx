...
export default function AdminCategoryConsultationDetails() {
    ...
    useEffect(() => {
        ...
        async function loadConsultation() {
            ...
            try {
                ...
                if (alive)
                    setError(
                        err.response?.data?.msg || "Failed to load consultation.",
                    );
            } finally {
    ...
    const doctor =
        consultation.assignedDoctorId || consultation.doctorId || null;
                    ...
                    <Section title="Doctor Details">
                        <div className="adp-info-grid">
                            ...
                            <InfoTile
                                ...
                                value={doctor?.specialization || consultation.assignedDoctorSpecialty}
                            />
