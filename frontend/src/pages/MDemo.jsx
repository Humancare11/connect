      ...
      <div className="nav">
        <div className="nav-inner" ref={innerRef}>
          <a className="brand" href="#" aria-label="Humancare Connect">
            <div className="brand-mark">
              <svg viewBox="0 0 24 24" fill="none">
                <path
                  d="M12 4C10 4 8 5.5 8 8v1H6a2 2 0 0 0-2 2v7a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-7a2 2 0 0 0-2-2h-2V8c0-2.5-2-4-4-4z"
                  stroke="currentColor"
                  strokeWidth="1.6"
                  strokeLinecap="round"
                />
          ...
          <nav className="nav-links">
            <a href="#doctors" onClick={scrollTo("#doctors")}>
              Find a Doctor
            </a>
            <a href="#how" onClick={scrollTo("#how")}>
              Ask a Question
            </a>
            <a href="#platform" onClick={scrollTo("#platform")}>
              Medical Services
            </a>
            <a href="#plans" onClick={scrollTo("#plans")}>
              Corporates
            </a>
