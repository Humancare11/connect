            ...
            {submitted ? (
                ...
                <>
                    ...
                    <p style={{ color: TEXT_DIM, fontSize: 13.5, lineHeight: 1.6, marginBottom: 22 }}>
                        Tell us a little about what you need, and a care coordinator will follow up
                ...
                >
                    {s.keyOutcomes.map((o, i) => (
                        ...
                        >
                            ...
                            />
                            <p style={{ color: TEXT_BODY, fontSize: 13, lineHeight: 1.6, margin: 0 }}>
                                {o}
                            </p>
                        </motion.div>
                    ))}
                ...
                <div>
                    <motion.div variants={fadeUp}>
                        ...
                        <p style={{ color: TEXT_DIM, fontSize: 15, lineHeight: 1.7, marginBottom: 36 }}>
                            Requesting a Doctor Note or Sick Note through Humancare Connect is quick,
                ...
                >
                    ...
                    >
                        ...
                        <p style={{ color: TEXT_DIM, fontSize: 14, lineHeight: 1.7, marginBottom: 24 }}>
                            Access trusted telemedicine services from wherever you are. Complete your
                            consultation online and receive medical documentation when appropriate.
                        </p>
            ...
            >
                <div style={{ padding: bp.isMobile ? 20 : 28 }}>
                    <p style={{ color: TEXT_BODY, fontSize: 15, lineHeight: 1.75, margin: "0 0 18px 0" }}>
                        Doctor Notes and Sick Notes are commonly requested when an illness, injury, or
                        medical condition affects an individual's ability to attend work, school, or
                        other responsibilities. These documents help confirm that a healthcare
                        professional has evaluated the patient's condition and may provide
                        recommendations regarding rest, recovery, or temporary activity limitations.
                    </p>
                    <p style={{ color: TEXT_BODY, fontSize: 15, lineHeight: 1.75, margin: "0 0 18px 0" }}>
                        Through Humancare Connect, patients can access telemedicine services and connect
                        with licensed healthcare providers from the comfort of home. During the
                        consultation, providers may review symptoms, discuss medical history, assess the
                        patient's condition, and determine whether medical documentation is appropriate
                        based on clinical findings.
                    </p>
                    <p style={{ color: TEXT_BODY, fontSize: 15, lineHeight: 1.75, margin: 0 }}>
                        Doctor Notes and Sick Notes are frequently requested for common illnesses such
                        as colds, flu symptoms, infections, migraines, gastrointestinal concerns, minor
                        injuries, and other short term health conditions. By combining virtual
                        healthcare services with professional medical evaluation, Humancare Connect
                        helps patients access convenient healthcare support while reducing unnecessary
                        clinic visits.
                    </p>
                </div>
            </motion.div>
    ...
    return (
        ...
        >
            ...
            >
                ...
                <div style={{ display: "grid", gridTemplateColumns: whyColumns, gap: 12 }}>
                    {whyUsItems.map(([Icon, title, desc], i) => (
                        ...
                        >
                            ...
                            <div>
                                <div style={{ color: TEXT_PRIMARY, fontWeight: 700, fontSize: 14, marginBottom: 4 }}>
                                    {title}
                                </div>
            ...
            >
                <motion.div variants={fadeUp}>
                    ...
                    <p style={{ color: TEXT_DIM, fontSize: 15, lineHeight: 1.7, marginBottom: 24 }}>
                        We've answered the most common questions below. Our care team is one message
                        away if yours isn't listed.
                    </p>
                    <button
                        style={{
                            padding: "11px 20px",
                    ...
                    {s.faqs.map((faq, i) => (
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <FiPlus
                                        style={{ fontSize: 14, color: open === i ? "#fff" : TEXT_DIM }}
                                    />
                                </div>
                            </button>
                            <AnimatePresence>
    ...
    >
        ...
        >
            <div>
                ...
                >
                    Connect with a licensed healthcare provider through secure telemedicine services
                    and discuss your healthcare needs from the comfort of home. Receive Doctor Notes
                    or Sick Notes when clinically appropriate and access convenient virtual healthcare
                    services designed to fit your schedule.
                </p>
                <div
                    style={{
                        display: "flex",
