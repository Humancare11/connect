            ...
            >
                ...
                <motion.div variants={fadeUp} style={{ position: "sticky", top: 96 }}>
                    ...
                    >
                        ...
                        <PrimaryBtn ac={s.accentColor} fullWidth> <a href="/login"> Get Started Today</a>
        ...
        >
            <div>
                ...
                >
                   START TODAY
                    <br />
                    <span style={{ color: s.accentColor }}>Take the Next Step Toward Better Health
</span>
                </h2>
                <p
                    style={{
                ...
                >
                  Whether you're monitoring an ongoing condition, investigating new symptoms, or staying proactive with preventive care, Humancare Connect makes it easy to access laboratory testing support from anywhere.<br /><br />
                ...
                >
                    ...
                    <GhostBtn><a href="/appointment-booking"> Request Your Lab Consultation Today</a>
                    </GhostBtn>
                    {/* <button
                        style={{
                            padding: "13px 24px",
