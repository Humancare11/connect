  ...
  return (
    <div className="hc-dash__page">
      ...
      <div className="hc-dash__header">
        ...
        <Link to="/appointment-booking" state={{ tab: "spec" }} className="hc-dash__book-btn">
      ...
      <div className="hc-dash__section">
        ...
        {loading ? (
          ...
          <div className="hc-dash__empty">
            ...
            <Link to="/appointment-booking" state={{ tab: "spec" }} className="hc-dash__empty-cta">Book Appointment</Link>
          </div>
        ) : (
