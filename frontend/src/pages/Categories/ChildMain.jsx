...
export default function ChildFamilyCare() {
  ...
  return (
    <div style={{ fontFamily: "'Satoshi', sans-serif", background: "var(--bg)", color: "var(--navy)", minHeight: "100vh" }}>
      ...
      <Helmet>
        <title>Online Children &amp; Family Care | Virtual Doctor Consultation | Humancare Connect</title>
        <meta name="description" content="Access online children and family care with trusted healthcare professionals. Get virtual doctor consultations, pediatric guidance, family healthcare support, and personalized medical advice from home." />
      </Helmet>
