...
keyServices: [
  ...
  },
  {
    ...
    description:
      "Long-term health planning following menopause.",
  },
  {
    Icon: FiShield,
...
const TRUST_CARDS = [
  ...
  },
  {
    ...
    description:
      "Access continued guidance as your healthcare needs evolve.",
  },
  {
    Icon: FiHeart,
                    ...
                    <div className="sp-container">
                        <Reveal>
                            <div className="sp-conditions__head">
                                ...
                                <h2>What We Treat</h2>
                                <p>
                                   Our menopause care specialists provide support for a wide range of menopause-related concerns and hormonal health needs.
                    ...
                    <div className="sp-cta__inner">
                        <Reveal>
                            ...
                            <p className="sp-cta__sub">
                                Connect with a menopause care specialist for personalized support, symptom management, hormonal health guidance, and treatment recommendations designed to help you thrive through every stage of menopause.
