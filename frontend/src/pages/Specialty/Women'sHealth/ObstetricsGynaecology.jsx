...
const SPECIALTY_DATA = {
    ...
    benefits: [
        ...
        },
        {
            ...
            description:
                "Identify health concerns before they become more serious.",
        },
        {
            Icon: FiUserCheck,
    ...
    conditions: [
        ...
        },
        {
            ...
            description:
                "Evaluation of symptoms related to changing hormone levels.",
        },
        {
            Icon: FiUsers,
    ...
    faqs: [
        ...
        {
            question: "What women's health concerns are commonly treated through telemedicine?",
            answer:
...
const TRUST_CARDS = [
    ...
    },
    {
        ...
        description:
            "Schedule consultations quickly and conveniently.",
    },
    {
        Icon: FiMonitor,
        title: "Telehealth Access",
        description:
            "Access women's healthcare services securely from home.",
    },
    {
        Icon: FiShield,
                    ...
                    <div className="sp-container">
                        <Reveal>
                            <div className="sp-conditions__head">
                                ...
                                <h2>What We Treat</h2>
                                <p>
                                    Our OB-GYN specialists provide expert care for a wide range of reproductive and gynecological health concerns.
                                </p>
                            </div>
                        </Reveal>
                    ...
                    <div className="sp-container">
                        ...
                        <Reveal>
                            <div className="sp-trust__head">
                                ...
                                <p>
                                    We combine experienced OB-GYN specialists with advanced telemedicine technology to provide convenient, compassionate, and personalized women's healthcare.
                                </p>
                            </div>
                        </Reveal>
                    ...
                    <div className="sp-cta__inner">
                        <Reveal>
                            ...
                            <p className="sp-cta__sub">
                                Whether you're seeking fertility support, pregnancy guidance, menstrual health care, contraception counseling, or routine women's healthcare, our specialists are here to help you achieve your health goals with confidence and compassion.
                            </p>
                        </Reveal>
