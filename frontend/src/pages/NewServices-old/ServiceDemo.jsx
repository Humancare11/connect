      ...
      {submitted ? (
        ...
        <>
          <div style={{
            ...
            background: `${s.accentColor}12`, marginBottom: 16,
          }}>
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ marginBottom: 16 }}>
              ...
              <input
                id="consult-name" type="text" required placeholder="Jordan Lee"
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <input
                id="consult-email" type="email" required placeholder="jordan@email.com"
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              <textarea
                id="consult-message" required rows={4} placeholder="Briefly describe your symptoms or what you'd like to discuss…"
                value={values.message} onChange={handleChange("message")}
                style={{ ...inputStyle, resize: "vertical", fontFamily: "inherit" }} {...focusHandlers}
              />
            </div>
