    ...
    <div className="dl-page">
      ...
      <aside className={`dl-sidebar${sideOpen ? " dl-sidebar--open" : ""}`}>
        ...
        <div className="dl-profile-card">
          ...
          <div
            className={`dl-online-badge ${isEnrolled ? "dl-online-badge--active" : ""}`}
            title={isEnrolled ? "Active" : "Pending"}
          />
        </div>
        ...
        <div className="dl-sidebar-footer">
          {!isEnrolled && (
            <Link
              to="/doctor-dashboard/enrollments"
              className="dl-enroll-nudge"
            >
              <svg
                width="13"
                height="13"
          ...
          {!isEnrolled && (
            <div className="dl-enroll-banner">
              ...
              <div className="dl-enroll-banner-text">
                <strong>Enrollment required</strong> — Complete your profile to
                unlock all features.
              </div>
              <Link
                to="/doctor-dashboard/enrollments"
                className="dl-enroll-banner-cta"
              >
                Enroll now →
              </Link>
            </div>
