  ...
  return (
    ...
    >
      ...
      {enrollment.profileUpdateRequestedAt && (
        <p className="dp-notice-text" style={{ marginTop: 4 }}>
          Submitted{" "}
    ...
    <>
      ...
      <div className="dp-adminlike">
        ...
        {toast && (
          ...
          >
            <p className="dp-notice-text" style={{ fontWeight: 800 }}>
              {toast.text}
            </p>
          </div>
        )}
        ...
        <div className="dp-hero">
          ...
          <div className="dp-chipbox">
            ...
            <span className="dp-chip dp-chip-ghost">
              ID: {doctor?.doctorId || "-"}
            </span>
            {source.consultantFees && (
              <span className="dp-chip dp-chip-ghost">
                {source.feeCurrency || "USD"} {source.consultantFees} / visit
              </span>
            )}
            {publicSlug && e.approvalStatus === "approved" && !editMode && (
              <button
                className="dp-chip dp-chip-ghost"
                type="button"
                style={{ cursor: "pointer" }}
                onClick={() => navigate(`/doctors/${publicSlug}`)}
              >
                View Public Profile
              </button>
            )}
            ...
            <Section icon="👤" title="Personal & Contact Details">
              <div className="dp-grid-wide">
                ...
                <InputField label="Languages Known" full>
                  {input("languagesKnown", "English, Hindi, Spanish")}
                </InputField>
              </div>
            </Section>
            ...
            <Section icon="📋" title="Submitted Documents">
              <div className="dp-grid">
                <DocumentCard
                  ...
                  doctorId={doctorId}
                  field="idProof"
                  onChange={(value) => update("idProof", value)}
                />
                <DocumentCard
                  editable
                  ...
                  doctorId={doctorId}
                  field="degreeFile"
                  onChange={(value) => update("degreeFile", value)}
                />
                <DocumentCard
                  editable
                  ...
                  onChange={(value) => update("medicalLicenseFile", value)}
                />
                <DocumentCard
                  editable
                  ...
                  onChange={(value) =>
                    update("malpracticeInsuranceFile", value)
                  }
                />
              </div>
            </Section>
            ...
            <Section icon="💳" title="Payout Information">
              <div className="dp-grid-wide">
                ...
                <InputField label="SWIFT / BIC">
                  {input("ifscCode", "SWIFT / BIC")}
                </InputField>
                <InputField label="PayPal ID">
                  {input("paypalId", "PayPal ID")}
                </InputField>
                <InputField label="Payout Email">
                  {input("payoutEmail", "Payout email", "email")}
                </InputField>
              </div>
            </Section>
          </>
            ...
            <Section icon="👤" title="Personal & Contact Details">
              {e.profilePhoto ? (
                ...
                >
                  <div
                    className="dp-avatar"
                    style={{ width: 72, height: 72, borderColor: "#16a34a" }}
                  >
                    <SignedImage
                      doctorId={doctorId}
                      field="profilePhoto"
            ...
            <Section icon="🩺" title="Professional Details">
              <div className="dp-grid">
                ...
                <ReadField
                  ...
                  value={e.medicalRegistrationNumber}
                />
                <ReadField
