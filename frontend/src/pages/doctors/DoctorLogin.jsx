...
export default function DoctorAuthPage() {
  ...
  const handleRegisterSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await api.post("/api/doctor/send-register-otp", {
  ...
  const handleForgotSend = async (e) => {
    ...
    try {
      ...
      setFormError(err.response?.data?.message || "Could not send OTP.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleForgotVerify = async (e) => {
    ...
    clrErr();
    try {
      const res = await api.post("/api/doctor/verify-forgot-otp", {
        email: forgotEmail,
        otp: otpValue,
      });
  ...
  const handleResetPassword = async (e) => {
    ...
    clrErr();
    try {
      await api.post("/api/doctor/reset-password", {
        resetToken,
        newPassword: newPass,
      });
      setView("auth");
        ...
        <div className="auth-form-box register-form-box">
          <form onSubmit={handleRegisterSubmit} className="register-form">
            ...
            <p className="form-subtitle">
              Join Humancare Connect as a healthcare professional
            </p>
        ...
        <div className="slide-panel-wrapper">
          <div className="slide-panel">
            <div className="panel-content panel-content-left">
              ...
              <p>
                Sign in to continue managing patients and appointments on
                Humancare Connect.
              </p>
              <button
            ...
            <div className="panel-content panel-content-right">
              ...
              <p>
                Register now and become part of our trusted network of
