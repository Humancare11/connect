      ...
      <div className="doctor-auth-form-box register-form-box">
        <form onSubmit={handleRegisterSubmit}>
          ...
          <div className="doctor-social-links">
            ...
            <button type="button" onClick={() => initiateGoogleLogin()} title="Continue with Google"
              style={{ background:"none", border:"1.5px solid #e5e7eb", borderRadius:"50%", width:40, height:40, display:"flex", alignItems:"center", justifyContent:"center", cursor:"pointer", padding:0 }}>
