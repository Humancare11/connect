    ...
    >
      ...
      <div style={{ width: "100%", display: "flex", justifyContent: "center" }}>
        ...
        >
          ...
          >
            This Cookie Policy explains how Humancare Connect uses cookies and
            similar technologies on our Platform, what information they collect,
          ...
          <SectionCard icon={Info} title="Introduction">
            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              Humancare Connect, Inc. uses cookies and similar tracking
              technologies on humancareconnect.co and related subdomains.
            </p>

            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              This Cookie Policy explains what cookies are, how we use them,
              your choices regarding their use, and how to manage your
              preferences.
            </p>
          ...
          <SectionCard icon={Cookie} title="What Are Cookies?">
            ...
            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              ...
              improve user experience, and provide information about website
              usage.
            </p>

            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              We may also use web beacons, pixels, local storage, and session
              storage technologies for similar purposes.
            </p>
          </SectionCard>
          ...
          <SectionCard icon={Layers} title="Types of Cookies We Use">
            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              We use a limited number of cookies necessary to operate, secure,
              ...
              >
                ...
                <thead>
                  <tr style={{ background: "#f8fafc" }}>
                    {["Cookie Type", "Purpose", "Duration", "Can Opt Out?"].map(
                      (h) => (
                        <th
                          key={h}
                          style={{
                ...
                <tbody>
                  {[
                    {
                      area: "Strictly Necessary",
                      description:
                        "Essential for the Platform to function — login sessions, security tokens, CSRF protection, load balancing.",
                      retention: "Session / up to 24 hours",
                      control: "No — required for service",
                    },
                    {
                      area: "Functional",
                      description:
                        "Remember your preferences — language, timezone, saved settings.",
                    ...
                    },
                    {
                      area: "Analytics",
                      description:
                        "Understand how visitors use our Platform — pages visited, session duration, error tracking (e.g., Google Analytics).",
            ...
            >
              <strong>Note:</strong> We do not use advertising, marketing, or
              cross-site tracking cookies. We do not sell data collected through
          ...
          <SectionCard icon={Database} title="Specific Cookies We Use">
            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              Below are the primary cookies placed on our Platform.
            </p>
            ...
            >
              ...
              >
                ...
                <thead>
                  <tr style={{ background: "#f8fafc" }}>
                    {["Cookie Name", "Provider", "Type", "Purpose"].map((h) => (
                      <th
                        key={h}
                        style={{
                          textAlign: "left",
                ...
                <tbody>
                  {[
                    ...
                    },
                    {
                      ...
                      provider: "Google Analytics",
                      type: "Analytics",
                      purpose: "Maintains Analytics session state",
                    },
                  ].map((row, i) => (
                    <tr
                      key={i}
          ...
          <SectionCard icon={Globe} title="Third-Party Cookies">
            <p style={{ color: "#64748b", lineHeight: 1.9 }}>
              ...
              <br />• Stripe for payment processing and fraud prevention
            </p>
          ...
          <SectionCard
            icon={Lock}
            title="Cookies and Protected Health Information"
          >
            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              Cookies used on our Platform do not contain Protected Health
              Information (PHI).
            </p>

            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              Medical records, consultation history, and health information are
              stored securely in protected databases and are never stored in
              cookies.
            </p>

            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              We do not use cookies to track health information across
          ...
          <SectionCard icon={Settings2} title="Your Cookie Choices">
            <p style={{ color: "#64748b", lineHeight: 1.9 }}>
              • Use our Cookie Consent Banner to accept, reject, or customize
              cookies
              <br />
              • Configure browser settings to block or delete cookies
              <br />• Disable Google Analytics using Google's opt-out browser
              add-on
            </p>
          ...
          <SectionCard icon={EyeOff} title="Do Not Track">
            ...
            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              Our Platform currently does not respond to DNT signals because
              there is no universally accepted industry standard for
              interpreting them.
            </p>
          </SectionCard>
          {/* gdpr */}
          <SectionCard icon={Users} title="GDPR and International Users">
            ...
            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              Non-essential cookies are processed only with consent, and consent
          ...
          <SectionCard icon={RefreshCw} title="Changes to This Policy">
            ...
            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              Material changes may be communicated through email or a prominent
