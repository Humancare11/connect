        ...
        >
          ...
          <SectionCard icon={Stethoscope} title="Description of Services">
            <p style={{ color: "#64748b", lineHeight: 1.9 }}>
              Humancare Connect is a telehealth marketplace platform that
              connects patients with licensed, US-based physicians for obtaining
              medical second opinions and consultations.
            </p>

            <p style={{ color: "#64748b", lineHeight: 1.9 }}>
              • Asynchronous and synchronous medical consultations via secure
              video, audio, or messaging
              <br />
              • Medical second opinions on diagnoses, treatment plans, and
              health concerns
              <br />• Access to licensed physicians across multiple specialties
            </p>
            ...
            >
              <p style={{ color: "#dc2626", fontWeight: 700, margin: 0 }}>
                IMPORTANT: Humancare Connect is NOT an emergency medical
                service. If you are experiencing a medical emergency, call 911
          ...
          <SectionCard icon={UserPlus} title="Account Registration">
            ...
            <p style={{ color: "#64748b", lineHeight: 1.9 }}>
              ...
              <br />• Not share your account credentials with others
            </p>

            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              You are responsible for all activity that occurs under your
              account. Humancare Connect is not liable for losses arising from
          ...
          <SectionCard icon={ShieldAlert} title="Medical Disclaimer">
            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              THE PLATFORM PROVIDES ACCESS TO MEDICAL SECOND OPINIONS AND
              CONSULTATIONS ONLY.
            </p>

            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              IT IS NOT A SUBSTITUTE FOR PROFESSIONAL MEDICAL ADVICE, DIAGNOSIS,
              OR TREATMENT FROM YOUR PRIMARY CARE PHYSICIAN OR SPECIALIST.
            </p>

            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              Physicians on the Platform are independent contractors and not
              employees of Humancare Connect.
            </p>

            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              The physician-patient relationship exists solely between you and
          ...
          <SectionCard icon={CreditCard} title="Payment Terms">
            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              Consultation fees are displayed on the Platform prior to booking.
              Fees vary by physician and consultation type.
            </p>
            ...
            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              By providing payment information, you authorize Humancare Connect
              and Stripe to charge your selected payment method.
            </p>

            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              Please review our Refund & Cancellation Policy for details
          ...
          <SectionCard icon={Ban} title="User Conduct">
            ...
            <p style={{ color: "#64748b", lineHeight: 1.9 }}>
              ...
              <br />
              • Interfere with Platform operations or servers
              <br />
              • Harass, abuse, or harm other users
              <br />
              • Reproduce or distribute Platform content without permission
              <br />• Use bots, scrapers, or automated tools on the Platform
            </p>
          </SectionCard>
          {/* intellectual */}
          <SectionCard icon={Copyright} title="Intellectual Property">
            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              ...
              software, is owned by Humancare Connect or its licensors and is
              protected by applicable intellectual property laws.
            </p>

            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              You are granted a limited, non-exclusive, non-transferable license
              to use the Platform solely for personal, non-commercial purposes.
            </p>
          </SectionCard>
          {/* privacy */}
          <SectionCard icon={Lock} title="Privacy">
            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              Your use of the Platform is governed by our Privacy Policy and our
              HIPAA Notice of Privacy Practices.
            </p>

            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              By using the Platform, you consent to the collection, use, and
              disclosure of information as described in those documents.
            </p>
          </SectionCard>
          {/* Limitation of Liability */}
          <SectionCard icon={AlertTriangle} title="Limitation of Liability">
            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, HUMANCARE CONNECT SHALL
          ...
          <SectionCard icon={Shield} title="Indemnification">
            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              You agree to indemnify and hold harmless Humancare Connect and its
          ...
          <SectionCard icon={Gavel} title="Governing Law">
            ...
            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              ...
              exclusively in the courts of New Castle County, Delaware.
            </p>
          </SectionCard>
          ...
          <SectionCard icon={RefreshCw} title="Modifications">
            ...
            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              Material changes will be posted on the Platform along with an
          ...
          <SectionCard icon={XCircle} title="Termination">
            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              ...
              access to the Platform at our discretion, with or without notice.
            </p>
