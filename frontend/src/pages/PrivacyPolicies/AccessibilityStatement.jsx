        ...
        >
          ...
          <SectionCard icon={Monitor} title="Our Commitment">
            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              Humancare Connect, Inc. is committed to ensuring that our website
              and telehealth platform at c and related subdomains (the
              "Platform") are accessible to everyone, including people with
              disabilities.
            </p>

            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              We believe that access to healthcare information and services is a
              fundamental right, and we are actively working to make our
              Platform usable by all individuals regardless of ability.
            </p>
          ...
          <SectionCard icon={ClipboardList} title="Scope">
            ...
            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              ...
              payment processors and integrated services, are subject to their
          ...
          <SectionCard icon={HeartHandshake} title="Our Accessibility Features">
            <p style={{ color: "#64748b", lineHeight: 1.9 }}>
              • Keyboard navigation — all core functions are accessible without
              a mouse
              <br />
              ...
              <br />
              • Sufficient color contrast meeting WCAG 2.1 AA standards
              <br />
              • Resizable text up to 200% browser zoom
              <br />
              • No flashing content exceeding accessibility thresholds
              <br />
              • Descriptive link text throughout the Platform
              <br />
              • Accessible form labels for all inputs
              <br />
              • Skip navigation links for faster access to content
              <br />• Consistent navigation across pages
            </p>
          </SectionCard>
          ...
          <SectionCard icon={AlertTriangle} title="Current Limitations">
            ...
            <p style={{ color: "#64748b", lineHeight: 1.9 }}>
              • Some older PDF documents may not yet be fully tagged for screen
              readers
              <br />
              • Certain third-party embedded components may have accessibility
              limitations
              <br />• Some video content may not yet include captions or audio
              descriptions
            </p>

            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              We are actively conducting accessibility audits and remediating
          ...
          <SectionCard icon={Laptop} title="Assistive Technology Compatibility">
            ...
            <p style={{ color: "#64748b", lineHeight: 1.9 }}>
              • JAWS, NVDA, VoiceOver (iOS/macOS), and TalkBack (Android)
              <br />
              • Dragon NaturallySpeaking voice recognition
              <br />
              • Browser zoom and text resizing tools
              <br />• High contrast browser modes
            </p>
          ...
          <SectionCard icon={Mail} title="Feedback and Contact">
            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              We welcome your feedback regarding the accessibility of our
              Platform. If you encounter any accessibility barriers, please
              contact us.
            </p>
          ...
          <SectionCard icon={Scale} title="Formal Complaints">
            ...
            <p style={{ color: "#64748b", lineHeight: 1.9 }}>
              • U.S. Department of Justice, Civil Rights Division (ADA)
              <br />• U.S. Department of Health and Human Services, Office for
              Civil Rights
            </p>
          </SectionCard>
          {/* Legal Compliance*/}
          <SectionCard icon={ShieldCheck} title="Legal Compliance">
            ...
            <p style={{ color: "#64748b", lineHeight: 1.9 }}>
              • Americans with Disabilities Act (ADA), including Title III
              <br />
              • Section 508 of the Rehabilitation Act
              <br />
              • California Unruh Civil Rights Act
              <br />• WCAG 2.1 Level AA
            </p>
          </SectionCard>
          {/* Ongoing Efforts */}
          <SectionCard icon={Stethoscope} title="Ongoing Accessibility Efforts">
            ...
            <p style={{ color: "#64748b", lineHeight: 1.9 }}>
              ...
              <br />
              • Integrating accessibility into our development lifecycle
              <br />
              • Training development and content teams on accessibility best
              practices
              <br />• Reviewing this statement annually
            </p>
          </SectionCard>
          {/* -- */}
          <SectionCard icon={FileSignature} title="Updates to This Statement">
            ...
            <p style={{ color: "#64748b", lineHeight: 1.8 }}>
              The "Last Updated" date displayed at the top of this page reflects
