  ...
  return (
    <div className="at-page">
      <header className="at-header">
        ...
        <p className="at-sub">
          Define what needs to be done, who's doing it, and when it's due.
          Subtasks and attachments are optional.
        </p>
      </header>
      ...
      <form className="at-form" onSubmit={handleSubmit}>
        ...
        <section className="at-section">
          <div className="at-section__head">
            ...
            <span className="at-section__hint">
              What the assignee needs to know
            </span>
          </div>

          <div className="at-grid">
            <div className="at-field at-field--full">
              <label className="at-label" htmlFor="at-desc">
                Description
              </label>
              <textarea
                id="at-desc"
            ...
            <div className="at-field at-field--full">
              <label className="at-label" htmlFor="at-comment">
                Comment
              </label>
              <textarea
                id="at-comment"
        ...
        <section className="at-section">
          ...
          <div className="at-field">
            <label className="at-label" htmlFor="at-tags">
              Tags
            </label>
        ...
        <section className="at-section">
          <div className="at-section__head">
            ...
            <span className="at-section__hint">
              {selectedEmployee
                ? `Going to ${selectedEmployee.name}`
                : "Pick one teammate"}
            </span>
          </div>
            ...
            <div className="at-people">
              {employees.map((employee) => {
                ...
                return (
                  ...
                  >
                    <span className="at-person__avatar">
                    ...
                    <span className="at-person__check" aria-hidden="true">
                      ✓
                    </span>
                  </button>
                );
...
function SubtaskFields({ index, subtask, onChange, onRemove }) {
  return (
    <div className="at-subtask">
      ...
      <div className="at-grid">
        <div className="at-field at-field--full">
          <label className="at-label" htmlFor={`subtask-title-${index}`}>
            Name
          </label>
          <input
        ...
        <div className="at-field at-field--full">
          <label className="at-label" htmlFor={`subtask-description-${index}`}>
            Description
          </label>
          <textarea
        ...
        <div className="at-field at-field--full">
          <label className="at-label" htmlFor={`subtask-comment-${index}`}>
            Comment
          </label>
          <textarea
