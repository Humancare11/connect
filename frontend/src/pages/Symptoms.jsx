...
import {
    Globe2, ArrowRight, Plane, Stethoscope, Brain, Activity, ClipboardPlus,
    Search, HeartPulse, Venus, Mars, Baby, ShieldCheck, Pill,Building2,AlertTriangle, CheckCircle2
} from "lucide-react";
import "./symptoms.css";
...
const conditionCategories =
    [
        { category: "Everyday Urgent Care", icon: ClipboardPlus, conditions: ["Cold & Flu", "COVID-19", "Fever", "Sore Throat", "Strep Throat", "Sinus Infection", "Ear Infection", "Pink Eye", "Cough", "Bronchitis", "Seasonal Allergies", "Headache", "Migraine", "Dizziness", "Vertigo", "Nausea and Vomiting", "Diarrhea", "Food Poisoning", "Constipation", "Acid Reflux / GERD", "Minor Burns", "Insect Bites"] },
        { category: "Skin Conditions", icon: HeartPulse, conditions: ["Acne", "Eczema", "Psoriasis", "Skin Rash", "Hives", "Fungal Skin Infection", "Ringworm", "Athlete's Foot", "Cellulitis", "Cold Sores", "Shingles", "Hair Loss", "Itchy Skin", "Contact Dermatitis", "Rosacea", "Warts"] },
        { category: "Respiratory Health", icon: Activity, conditions: ["Asthma", "Asthma Flare-Up", "Allergic Rhinitis", "COPD", "Persistent Cough", "Shortness of Breath", "Wheezing", "Upper Respiratory Infection", "Pneumonia Follow-Up"] },
        { category: "Digestive Health", icon: Stethoscope, conditions: ["Abdominal Pain", "Bloating", "Gastritis", "Irritable Bowel Syndrome", "Indigestion", "Hemorrhoids", "Traveler's Diarrhea", "Vomiting", "Dehydration"] },
        { category: "Urinary & Kidney Health", icon: ShieldCheck, conditions: ["Urinary Tract Infection", "Bladder Infection", "Burning Urination", "Frequent Urination", "Kidney Infection", "Kidney Stones", "Urinary Incontinence", "Blood in Urine"] },
        { category: "Chronic Care", icon: Activity, conditions: ["Type 2 Diabetes", "High Blood Pressure", "High Cholesterol", "Thyroid Disorders", "Obesity", "Arthritis", "Osteoarthritis", "Rheumatoid Arthritis", "Chronic Migraine", "Chronic Kidney Disease", "Heart Disease Follow-Up", "Sleep Apnea"] },
        { category: "Women's Health", icon: Venus, conditions: ["Birth Control Consultation", "Emergency Contraception Guidance", "Menstrual Cramps", "Irregular Periods", "Heavy Periods", "PCOS", "Menopause Symptoms", "Vaginal Yeast Infection", "Bacterial Vaginosis", "Pregnancy-Related Questions", "Prenatal Consultation", "Postpartum Concerns"] },
        { category: "Men's Health", icon: Mars, conditions: ["Erectile Dysfunction", "Premature Ejaculation", "Low Testosterone Symptoms", "Hair Loss", "Prostate Health", "Urinary Symptoms in Men", "Men's Wellness Consultation"] },
        { category: "Mental & Behavioral Health", icon: Brain, conditions: ["Anxiety", "Depression", "Stress", "Burnout", "Panic Attacks", "Insomnia", "ADHD Evaluation", "PTSD", "Grief and Loss", "Relationship Stress", "Substance Use Support"] },
        { category: "Sexual Health", icon: ShieldCheck, conditions: ["STI Consultation", "Chlamydia", "Gonorrhea", "Herpes", "Genital Rash", "Genital Itching", "HIV Prevention / PrEP Guidance", "Partner Exposure Concerns"] },
        { category: "Pediatric Care", icon: Baby, conditions: ["Pediatric Fever", "Pediatric Cold & Flu", "Ear Pain in Children", "Sore Throat in Children", "Pink Eye in Children", "Skin Rash in Children", "Childhood Allergies", "Mild Asthma Symptoms", "Stomach Pain in Children", "Vomiting and Diarrhea in Children"] },
        { category: "Travel Health", icon: Plane, conditions: ["Traveler's Diarrhea", "Food Poisoning While Traveling", "Motion Sickness", "Altitude Sickness", "Jet Lag", "Medication Refill While Traveling", "Travel-Related Fever", "Travel Medical Certificate", "Fitness-to-Travel Evaluation", "International Medical Assistance", "Emergency Teleconsultation Abroad"] },
        { category: "Prescription & Continuity Care", icon: Pill, conditions: ["Prescription Refill", "Medication Review", "Chronic Medication Management", "Lab Result Review", "Second Medical Opinion", "Specialist Referral", "Follow-Up Consultation", "Medical Certificate", "Doctor's Note", "Return-to-Work Clearance"] },
        { category: "Eye, Ear & Musculoskeletal", icon: Activity, conditions: ["Eye Redness", "Eye Irritation", "Ear Pain", "Ear Infection", "Back Pain", "Neck Pain", "Joint Pain", "Muscle Strain", "Numbness and Tingling", "Swollen Feet or Ankles"] },
    ];
...
export default function Symptoms() {
    ...
    const filtered = useMemo(() =>
        allConditions.filter(({ condition, category }) => {
            ...
            const matchSearch = condition.toLowerCase().includes(query.toLowerCase())
                            ...
                            <div className="sy-hero__card-dark">
                                <div className="sy-hero__card-top">
                                    <div>
                                        ...
                                        <p className="sy-hero__card-title">Traveler needs consult</p>
                                    </div>
            ...
            <section id="sy-conditions" className="symptoms">
                <div className="symptoms__container">
                    ...
                    <div className="symptoms__title-block">
                        ...
                        <h2 className="symptoms__heading">Searchable US medical condition directory</h2>
                        <p className="symptoms__copy">
                            Use patient-friendly US terminology. Avoid saying "all conditions"; say "Conditions
                            we can help with" or "Common concerns we support."
                        </p>
                    </div>
                    ...
                    <div className="symptoms__grid">
                        {filtered.slice(0, 96).map((item, i) => {
                            ...
                            return (
                                ...
                                >
                                    <div className="symptoms__item-icon"><Icon size={18} /></div>
                                    <div>
                    ...
                    {filtered.length > 96 && (
                        <div className="symptoms__overflow">
                            Showing the first 96 matching conditions. Narrow your search to see more.
                        </div>
                    )}
...
<section id="businesses" className="sy-b2b">
  <div className="sy-b2b__inner">
    ...
    <div className="sy-b2b__content">
      <span className="sy-b2b__eyebrow">
        B2B positioning
      </span>
    ...
    <div className="sy-b2b__grid">
      {audiences.map((name, i) => (
        ...
        >
          ...
          <div className="sy-b2b__card-name">
            {name}
          </div>

          <p className="sy-b2b__card-desc">
            Virtual care routing, physician access,
            reports, and continuity care coordination.
          </p>
        </div>
      ))}
    </div>
