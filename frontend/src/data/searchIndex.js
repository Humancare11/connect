...
export const categories = [
  ...
  { id: "chronic-care-and-expert-opinion", title: "Chronic Care & Expert Opinion", type: "category", route: "/chronic-care-and-expert-opinion",
    keywords: ["chronic care", "expert opinion", "second opinion", "ongoing condition"] },
...
export const specialties = [
  ...
  { id: "gastroenterology", title: "Gastroenterology", type: "specialty", category: "chronic-care-and-expert-opinion", route: "/gastroenterology",
    keywords: ["gastroenterology", "digestive", "stomach", "gi"] },
  { id: "neurology", title: "Neurology", type: "specialty", category: "chronic-care-and-expert-opinion", route: "/neurology",
    keywords: ["neurology", "brain", "nerve", "neurological"] },
  { id: "pulmonology", title: "Pulmonology", type: "specialty", category: "chronic-care-and-expert-opinion", route: "/pulmonology",
    keywords: ["pulmonology", "lungs", "breathing", "respiratory"] },
  { id: "endocrinology", title: "Endocrinology", type: "specialty", category: "chronic-care-and-expert-opinion", route: "/endocrinology",
    keywords: ["endocrinology", "hormones", "thyroid", "diabetes"] },

  // Eye, Ear & Bone
  { id: "ear-nose-throat", title: "ENT (Ear, Nose & Throat)", type: "specialty", category: "eye-ear-bone", route: "/ear-nose-throat",
    keywords: ["ent", "ear nose throat", "sinus", "throat"] },
  { id: "ophthalmology", title: "Ophthalmology", type: "specialty", category: "eye-ear-bone", route: "/ophthalmology",
    keywords: ["ophthalmology", "eye doctor", "vision"] },
  { id: "orthopedics", title: "Orthopedics", type: "specialty", category: "eye-ear-bone", route: "/orthopedics",
    keywords: ["orthopedics", "bone", "joint", "musculoskeletal"] },

  // General & Everyday Care
  { id: "family-medicine", title: "Family Medicine", type: "specialty", category: "general-and-everyday-care", route: "/family-medicine",
    keywords: ["family medicine", "family doctor"] },
  { id: "general-physician", title: "General Physician (GP)", type: "specialty", category: "general-and-everyday-care", route: "/general-physician",
    keywords: ["general physician", "gp", "family doctor"] },
  { id: "internal-medicine", title: "Internal Medicine", type: "specialty", category: "general-and-everyday-care", route: "/internal-medicine",
    keywords: ["internal medicine", "internist"] },

  // Men's Health
  { id: "mens-health-specialty", title: "Men's Health", type: "specialty", category: "men-health", route: "/mens-health",
    keywords: ["men's health", "male wellness"] },
  { id: "urology", title: "Urology", type: "specialty", category: "men-health", route: "/urology",
    keywords: ["urology", "urologist", "bladder", "kidney"] },

  // Mental Health
  { id: "behavioral-health", title: "Behavioral Medicine", type: "specialty", category: "mental-health", route: "/behavioral-health",
...
export const conditions = [
  // ── Chronic Care & Expert Opinion ──────────────────────────────────────
  { id: "arthritis", title: "Arthritis", type: "condition", category: "chronic-care-and-expert-opinion", route: "/arthritis",
    keywords: ["arthritis", "joint inflammation"] },
  { id: "cancer-second-opinion", title: "Cancer Second Opinion", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "export-medical-opinion", route: "/cancer-second-opinion",
    keywords: ["cancer", "oncology", "second opinion"] },
  { id: "chest-pain", title: "Chest Pain", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "cardiology", route: "/chest-pain",
    keywords: ["chest pain", "chest tightness"] },
  { id: "chronic-kidney-disease", title: "Chronic Kidney Disease", type: "condition", category: "chronic-care-and-expert-opinion", route: "/chronic-kidney-disease",
    keywords: ["chronic kidney disease", "ckd", "renal disease"] },
  { id: "chronic-migraine", title: "Chronic Migraine", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "neurology", route: "/chronic-migraine",
    keywords: ["chronic migraine", "migraine", "severe headache"] },
  { id: "complex-diagnosis", title: "Complex Diagnosis Review", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "export-medical-opinion", route: "/complex-diagnosis",
    keywords: ["complex diagnosis", "diagnosis review"] },
  { id: "fatty-liver", title: "Fatty Liver", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "gastroenterology", route: "/fatty-liver",
    keywords: ["fatty liver", "liver disease", "nafld"] },
  { id: "heart-disease", title: "Heart Disease", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "cardiology", route: "/heart-disease",
    keywords: ["heart disease", "cardiac disease"] },
  { id: "high-blood-pressure", title: "High Blood Pressure", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "cardiology", route: "/high-blood-pressure",
    keywords: ["high blood pressure", "hypertension", "bp"] },
  { id: "high-cholesterol", title: "High Cholesterol", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "cardiology", route: "/high-cholesterol",
    keywords: ["high cholesterol", "cholesterol", "lipids"] },
  { id: "hormone-imblance", title: "Hormone Imbalance", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "endocrinology", route: "/hormone-imblance",
    keywords: ["hormone imbalance", "hormonal"] },
  { id: "memory-concerns", title: "Memory Concerns", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "neurology", route: "/memory-concerns",
    keywords: ["memory concerns", "memory loss", "forgetfulness"] },
  { id: "obesity", title: "Obesity", type: "condition", category: "chronic-care-and-expert-opinion", route: "/obesity",
    keywords: ["obesity", "overweight"] },
  { id: "osteoarthritis", title: "Osteoarthritis", type: "condition", category: "chronic-care-and-expert-opinion", route: "/osteoarthritis",
    keywords: ["osteoarthritis", "joint wear"] },
  { id: "osteoporosis", title: "Osteoporosis", type: "condition", category: "chronic-care-and-expert-opinion", route: "/osteoporosis",
    keywords: ["osteoporosis", "bone density", "weak bones"] },
  { id: "palpitations", title: "Palpitations", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "cardiology", route: "/palpitations",
    keywords: ["palpitations", "heart racing", "irregular heartbeat"] },
  { id: "post-covid-concerns", title: "Post-COVID Concerns", type: "condition", category: "chronic-care-and-expert-opinion", route: "/post-covid-concerns",
    keywords: ["post-covid", "long covid"] },
  { id: "pre-op-cardiac-clearance", title: "Pre-Op Cardiac Clearance", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "cardiology", route: "/pre-op-cardiac-clearance",
    keywords: ["pre-op clearance", "cardiac clearance", "surgery clearance"] },
  { id: "rheumatoid-arthritis", title: "Rheumatoid Arthritis", type: "condition", category: "chronic-care-and-expert-opinion", route: "/rheumatoid-arthritis",
    keywords: ["rheumatoid arthritis", "ra"] },
  { id: "seizures-epilepsy-follow-up", title: "Seizures / Epilepsy Follow-Up", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "neurology", route: "/seizures-epilepsy-follow-up",
    keywords: ["seizures", "epilepsy"] },
  { id: "sleep-apnea", title: "Sleep Apnea", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "pulmonology", route: "/sleep-apnea",
    keywords: ["sleep apnea", "snoring", "breathing during sleep"] },
  { id: "surgery-second-opinion", title: "Surgery Second Opinion", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "export-medical-opinion", route: "/surgery-second-opinion",
    keywords: ["surgery second opinion", "surgical opinion"] },
  { id: "thyroid-disorders", title: "Thyroid Disorders", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "endocrinology", route: "/thyroid-disorders",
    keywords: ["thyroid", "hypothyroid", "hyperthyroid"] },
  { id: "treatment-plan-review", title: "Treatment Plan Review", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "export-medical-opinion", route: "/treatment-plan-review",
    keywords: ["treatment plan review"] },
  { id: "tremor", title: "Tremor", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "neurology", route: "/tremor",
    keywords: ["tremor", "shaking", "hand tremor"] },
  { id: "type-2-diabetes", title: "Type 2 Diabetes", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "endocrinology", route: "/type-2-diabetes",
    keywords: ["type 2 diabetes", "diabetes", "blood sugar"] },

  // ── Respiratory (grouped under Chronic Care / Pulmonology) ─────────────
  { id: "allergic-rhinitis", title: "Allergic Rhinitis", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "pulmonology", route: "/allergic-rhinitis",
    keywords: ["allergic rhinitis", "hay fever", "nasal allergy"] },
  { id: "asthma", title: "Asthma", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "pulmonology", route: "/asthma",
    keywords: ["asthma", "wheezing", "inhaler"] },
  { id: "asthma-flare-up", title: "Asthma Flare-Up", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "pulmonology", route: "/asthma-flare-up",
    keywords: ["asthma flare-up", "asthma attack"] },
  { id: "copd", title: "COPD", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "pulmonology", route: "/copd",
    keywords: ["copd", "chronic obstructive pulmonary disease"] },
  { id: "persistent-cough", title: "Persistent Cough", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "pulmonology", route: "/persistent-cough",
    keywords: ["persistent cough", "chronic cough"] },
  { id: "pneumonia-follow-up", title: "Pneumonia Follow-Up", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "pulmonology", route: "/pneumonia-follow-up",
    keywords: ["pneumonia", "pneumonia follow-up"] },
  { id: "shortness-of-breath", title: "Shortness of Breath", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "pulmonology", route: "/shortness-of-breath",
    keywords: ["shortness of breath", "breathlessness"] },
  { id: "upper-respiratory-infection", title: "Upper Respiratory Infection", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "pulmonology", route: "/upper-respiratory-infection",
    keywords: ["upper respiratory infection", "uri"] },
  { id: "wheezing", title: "Wheezing", type: "condition", category: "chronic-care-and-expert-opinion", specialty: "pulmonology", route: "/wheezing",
    keywords: ["wheezing"] },

  // ── Weight & Nutrition ──────────────────────────────────────────────────
  { id: "abdominal-pain", title: "Abdominal Pain", type: "condition", category: "weight-and-nurtrition", route: "/abdominal-pain",
  ...
  { id: "bloating", title: "Bloating", type: "condition", category: "weight-and-nurtrition", route: "/bloating",
  ...
  { id: "irritable-bowel-syndrome", title: "Irritable Bowel Syndrome", type: "condition", category: "weight-and-nurtrition", specialty: "gastroenterology", route: "/irritable-bowel-syndrome",
  ...
  // ── Eye, Ear & Bone ─────────────────────────────────────────────────────
  { id: "back-pain", title: "Back Pain", type: "condition", category: "eye-ear-bone", specialty: "orthopedics", route: "/back-pain",
    keywords: ["back pain", "spine", "lumbar"] },
  { id: "dry-eyes", title: "Dry Eyes", type: "condition", category: "eye-ear-bone", specialty: "ophthalmology", route: "/dry-eyes",
    keywords: ["dry eyes", "eye dryness"] },
  { id: "ear-infection", title: "Ear Infection", type: "condition", category: "eye-ear-bone", specialty: "ear-nose-throat", route: "/ear-infection",
    keywords: ["ear infection", "earache", "otitis"] },
  { id: "ear-pain", title: "Ear Pain", type: "condition", category: "eye-ear-bone", specialty: "ear-nose-throat", route: "/ear-pain",
    keywords: ["ear pain", "earache"] },
  { id: "eye-redness", title: "Eye Redness", type: "condition", category: "eye-ear-bone", specialty: "ophthalmology", route: "/eye-redness",
    keywords: ["eye redness", "red eye"] },
  { id: "eye-strain", title: "Eye Strain", type: "condition", category: "eye-ear-bone", specialty: "ophthalmology", route: "/eye-strain",
    keywords: ["eye strain", "tired eyes", "screen fatigue"] },
  { id: "hoarseness", title: "Hoarseness", type: "condition", category: "eye-ear-bone", specialty: "ear-nose-throat", route: "/hoarseness",
    keywords: ["hoarseness", "hoarse voice"] },
  { id: "knee-pain", title: "Knee Pain", type: "condition", category: "eye-ear-bone", specialty: "orthopedics", route: "/knee-pain",
    keywords: ["knee pain", "knee", "kneecap", "patella", "acl", "meniscus"] },
  { id: "muscle-strain", title: "Muscle Strain", type: "condition", category: "eye-ear-bone", specialty: "orthopedics", route: "/muscle-strain",
    keywords: ["muscle strain", "pulled muscle"] },
  { id: "nasal-congestion", title: "Nasal Congestion", type: "condition", category: "eye-ear-bone", specialty: "ear-nose-throat", route: "/nasal-congestion",
    keywords: ["nasal congestion", "stuffy nose"] },
  { id: "neck-pain", title: "Neck Pain", type: "condition", category: "eye-ear-bone", specialty: "orthopedics", route: "/neck-pain",
    keywords: ["neck pain", "stiff neck", "cervical"] },
  { id: "numbness-tingling", title: "Numbness & Tingling", type: "condition", category: "eye-ear-bone", route: "/numbness-tingling",
    keywords: ["numbness", "tingling", "pins and needles"] },
  { id: "stye", title: "Stye", type: "condition", category: "eye-ear-bone", specialty: "ophthalmology", route: "/stye",
  ...
  { id: "tonsillitis", title: "Tonsillitis", type: "condition", category: "eye-ear-bone", specialty: "ear-nose-throat", route: "/tonsillitis",
  ...
  { id: "vision-changes", title: "Vision Changes", type: "condition", category: "eye-ear-bone", specialty: "ophthalmology", route: "/vision-changes",
    keywords: ["vision changes", "blurry vision"] },
  { id: "vertigo", title: "Vertigo", type: "condition", category: "eye-ear-bone", specialty: "ear-nose-throat", route: "/vertigo",
  ...
  { id: "ear-pain-children", title: "Ear Pain in Children", type: "condition", category: "child-and-family-care", specialty: "pediatrics", route: "/ear-pain-children",
    keywords: ["child ear pain", "kids earache"] },
  { id: "feeding-concerns", title: "Feeding Concerns", type: "condition", category: "child-and-family-care", specialty: "pediatrics", route: "/feeding-concerns",
  ...
  { id: "mood-anxiety-teens", title: "Mood & Anxiety in Teens", type: "condition", category: "child-and-family-care", specialty: "adolescent-medicine", route: "/mood-anxiety-teens",
    keywords: ["teen anxiety", "teen mood", "adolescent mental health"] },
  { id: "pediatric-cold-flu", title: "Pediatric Cold & Flu", type: "condition", category: "child-and-family-care", specialty: "pediatrics", route: "/pediatric-cold-flu",
    keywords: ["child cold", "kids flu", "baby cold"] },
  { id: "pediatric-fever", title: "Pediatric Fever", type: "condition", category: "child-and-family-care", specialty: "pediatrics", route: "/pediatric-fever",
  ...
  { id: "puberty-concerns", title: "Puberty Concerns", type: "condition", category: "child-and-family-care", specialty: "adolescent-medicine", route: "/puberty-concerns",
  ...
  { id: "sports-injuries", title: "Sports Injuries", type: "condition", category: "child-and-family-care", specialty: "adolescent-medicine", route: "/sports-injuries",
  ...
  // ── Sexual Health ────────────────────────────────────────────────────────
  { id: "chlamydia", title: "Chlamydia", type: "condition", category: "categories-sexual-health", specialty: "speciality-sexual-health", route: "/chlamydia",
  ...
  { id: "gonorrhea", title: "Gonorrhea", type: "condition", category: "categories-sexual-health", specialty: "speciality-sexual-health", route: "/gonorrhea",
    keywords: ["gonorrhea", "sti"] },
  { id: "herpes", title: "Herpes", type: "condition", category: "categories-sexual-health", specialty: "speciality-sexual-health", route: "/herpes",
    keywords: ["herpes", "sti", "cold sores genital"] },
  { id: "hiv-prevention-guidance", title: "HIV Prevention Guidance", type: "condition", category: "categories-sexual-health", specialty: "speciality-sexual-health", route: "/hiv-prevention-guidance",
    keywords: ["hiv prevention", "prep", "truvada"] },
  { id: "partner-exposure-concerns", title: "Partner Exposure Concerns", type: "condition", category: "categories-sexual-health", specialty: "speciality-sexual-health", route: "/partner-exposure-concerns",
    keywords: ["partner exposure", "sti exposure"] },
  { id: "safe-sex-counseling", title: "Safe Sex Counseling", type: "condition", category: "categories-sexual-health", specialty: "speciality-sexual-health", route: "/safe-sex-counseling",
    keywords: ["safe sex", "sexual health counseling"] },
  { id: "sti-consultation", title: "STI Consultation", type: "condition", category: "categories-sexual-health", specialty: "speciality-sexual-health", route: "/sti-consultation",
  ...
  // ── General & Everyday Care ──────────────────────────────────────────────
  { id: "acid-reflux-gerd", title: "Acid Reflux / GERD", type: "condition", category: "general-and-everyday-care", specialty: "general-physician", route: "/acid-reflux-gerd",
    keywords: ["acid reflux", "gerd", "heartburn"] },
  { id: "body-aches", title: "Body Aches", type: "condition", category: "general-and-everyday-care", specialty: "general-physician", route: "/body-aches",
  ...
  { id: "bronchitis", title: "Bronchitis", type: "condition", category: "general-and-everyday-care", specialty: "general-physician", route: "/bronchitis",
    keywords: ["bronchitis"] },
  { id: "cold-and-flu", title: "Cold & Flu", type: "condition", category: "general-and-everyday-care", specialty: "general-physician", route: "/cold-and-flu",
    keywords: ["cold", "flu", "fever", "runny nose"] },
  { id: "constipation", title: "Constipation", type: "condition", category: "general-and-everyday-care", specialty: "general-physician", route: "/constipation",
    keywords: ["constipation"] },
  { id: "cough", title: "Cough", type: "condition", category: "general-and-everyday-care", specialty: "general-physician", route: "/cough",
    keywords: ["cough"] },
  ...
  { id: "diarrhea", title: "Diarrhea", type: "condition", category: "general-and-everyday-care", specialty: "general-physician", route: "/diarrhea",
    keywords: ["diarrhea"] },
  { id: "dizziness", title: "Dizziness", type: "condition", category: "general-and-everyday-care", specialty: "general-physician", route: "/dizziness",
    keywords: ["dizziness", "lightheaded"] },
  { id: "fatigue", title: "Fatigue", type: "condition", category: "general-and-everyday-care", specialty: "general-physician", route: "/fatigue",
    keywords: ["fatigue", "tiredness", "low energy"] },
  { id: "fever", title: "Fever", type: "condition", category: "general-and-everyday-care", specialty: "general-physician", route: "/fever",
  ...
  { id: "headache", title: "Headache", type: "condition", category: "general-and-everyday-care", specialty: "general-physician", route: "/headache",
  ...
  { id: "migraines", title: "Migraine", type: "condition", category: "general-and-everyday-care", specialty: "general-physician", route: "/migraines",
  ...
  { id: "minor-infections", title: "Minor Infections", type: "condition", category: "general-and-everyday-care", specialty: "general-physician", route: "/minor-infections",
    keywords: ["minor infections"] },
  { id: "multi-system-complaints", title: "Multi-System Complaints", type: "condition", category: "general-and-everyday-care", specialty: "general-physician", route: "/multi-system-complaints",
    keywords: ["multi-system complaints", "undiagnosed general symptoms"] },
  { id: "nausea-and-vomiting", title: "Nausea & Vomiting", type: "condition", category: "general-and-everyday-care", specialty: "general-physician", route: "/nausea-and-vomiting",
    keywords: ["nausea", "vomiting"] },
  { id: "pink-eye", title: "Pink Eye", type: "condition", category: "general-and-everyday-care", specialty: "general-physician", route: "/pink-eye",
    keywords: ["pink eye", "conjunctivitis"] },
  { id: "preventive-screening", title: "Preventive Screening", type: "condition", category: "general-and-everyday-care", specialty: "general-physician", route: "/preventive-screening",
    keywords: ["preventive screening", "health screening"] },
  { id: "routine-check-ups", title: "Routine Check-Ups", type: "condition", category: "general-and-everyday-care", specialty: "general-physician", route: "/routine-check-ups",
  ...
  { id: "sinus-infection", title: "Sinus Infection", type: "condition", category: "general-and-everyday-care", specialty: "general-physician", route: "/sinus-infection",
    keywords: ["sinus infection", "sinusitis"] },
  { id: "sore-throat", title: "Sore Throat", type: "condition", category: "general-and-everyday-care", specialty: "general-physician", route: "/sore-throat",
  ...
  { id: "undiagnosed-symptoms", title: "Undiagnosed Symptoms", type: "condition", category: "general-and-everyday-care", specialty: "general-physician", route: "/undiagnosed-symptoms",
    keywords: ["undiagnosed symptoms"] },
  { id: "vaccination-advice", title: "Vaccination Advice", type: "condition", category: "general-and-everyday-care", specialty: "general-physician", route: "/vaccination-advice",
    keywords: ["vaccination advice", "immunization"] },
  { id: "whole-family-illnesses", title: "Whole-Family Illnesses", type: "condition", category: "general-and-everyday-care", specialty: "general-physician", route: "/whole-family-illnesses",
  ...
  { id: "blood-in-urine", title: "Blood in Urine", type: "condition", category: "men-health", specialty: "urology", route: "/blood-in-urine",
  ...
  { id: "kidney-stones", title: "Kidney Stones", type: "condition", category: "men-health", specialty: "urology", route: "/kidney-stones",
    keywords: ["kidney stones", "renal stones"] },
  { id: "urinary-incontinence", title: "Urinary Incontinence", type: "condition", category: "men-health", specialty: "urology", route: "/urinary-incontinence",
  ...
  // ── Men's Health ─────────────────────────────────────────────────────────
  { id: "bladder-problems", title: "Bladder Problems", type: "condition", category: "men-health", specialty: "urology", route: "/bladder-problems",
    keywords: ["bladder problems"] },
  { id: "erectile-dysfunction", title: "Erectile Dysfunction", type: "condition", category: "men-health", specialty: "mens-health-specialty", route: "/erectile-dysfunction",
    keywords: ["erectile dysfunction", "ed", "impotence"] },
  { id: "hair-loss-mens-health", title: "Hair Loss (Men's Health)", type: "condition", category: "men-health", specialty: "mens-health-specialty", route: "/hair-loss-mens-health",
    keywords: ["hair loss", "balding", "male pattern baldness"] },
  { id: "low-libido", title: "Low Libido", type: "condition", category: "men-health", specialty: "mens-health-specialty", route: "/low-libido",
    keywords: ["low libido", "low sex drive"] },
  { id: "low-testosterone-symptoms", title: "Low Testosterone Symptoms", type: "condition", category: "men-health", specialty: "mens-health-specialty", route: "/low-testosterone-symptoms",
  ...
  { id: "prostate-health", title: "Prostate Health", type: "condition", category: "men-health", specialty: "urology", route: "/prostate-health",
...
/*
NOTES — fix these in App.jsx before relying on search in production:

1. MENTAL HEALTH HAS NO CONDITION PAGES.
   The Mental Health category page (per your screenshot) lists Depression,
   Anxiety, OCD, Bipolar Disorder Follow-Up, Panic Attacks, Insomnia,
   Grief & Loss, Trauma Support, Anger Management, Relationship Issues,
   Substance-Use Concerns, and Adjustment Difficulties — but NONE of these
   have a <Route> in App.jsx. Only the category page (/mental-health) and
   the three specialty pages (/psychiatry, /psychology-counseling,
   /behavioral-health) exist. Searching "anxiety" or "depression" will
   currently return nothing (correctly) rather than a broken link, but you
   probably want these condition pages built.

2. DUPLICATE ROUTES in App.jsx — only the FIRST one is ever reachable, the
   second import is dead code:
   - "/ear-infection" is defined twice (EarInfection and EarInfection1)
   - "/travelers-diarrhea" is defined twice (TravelersDiarrhea and
     TravelersDiarrhea1)
   Pick which component should win for each and delete the route+import for
   the other.

3. BROKEN ROUTE PATH: <Route path="constipation" ...> is missing its
   leading slash. This makes it a relative route, not "/constipation" —
   it won't render at the URL you expect. Change to path="/constipation".

4. Categories with no dedicated pages of their own — Urinary & Kidney
   Health isn't one of your 11 top-level categories, so I filed its
   conditions under Men's Health / Urology to match your Specialty folder
   structure. Adjust the `category` field on those 7 entries if you'd
   rather group them elsewhere.

5. Specialty/category assignments for some entries (e.g. items in the
   "Weight & Nutrition" and "Prescription & Continuity Care" groups) were
   inferred from route naming and the physical order conditions appear in
   App.jsx, not from an explicit specialty field in your source — spot
   check these against your own mental model of the taxonomy.
*/